package com.anvsoft.components.container.publish
{
	import com.anvsoft.components.AppAlertCom;
	import com.anvsoft.components.container.publish.popup.FileCreateProgressPopupCom;
	import com.anvsoft.components.container.publish.popup.FileOverwritePopupCom;
	import com.anvsoft.data.SlidesDataParser;
	...
	import com.anvsoft.events.components.container.theme.basic.properties.PropertiesPanelComEvent;
	import com.anvsoft.utils.file.FileCompress;
	import com.anvsoft.utils.file.FileManager;
	import com.anvsoft.utils.file.FileUpload;
	...
	public class PublishPanelAS extends Group
	{
		...
		private var fsmFooterHtmlString:String = '<div class="text_createdby"><p><a href="http://www.html5-slideshow-maker.com" target="_blank">Created by AnvSoft HTML5 Slideshow Maker</a></p></div>';

...
this.titleTransformOriginX=Number(a.getAttribute("titleTransformOriginX"));this.titleTransformOriginY=Number(a.getAttribute("titleTransformOriginY"));this.musicPath=b.musicPath;this.musicStream=b.musicStream;this.musicLoop=b.musicLoop;this.musicAutoPlay=b.musicAutoPlay;this.topPadding=b.topPadding;this.bottomPadding=b.bottomPadding;this.leftPadding=b.leftPadding;this.rightPadding=b.rightPadding;a=b.globalDescriptionXml;this.enableDes=a.getAttribute("enable");this.desTextFont=a.getAttribute("defaultTextFont");
this.desTextSize=a.getAttribute("defaultTextSize");this.desTextColor=a.getAttribute("defaultTextColor").replace(/0x/g,"#");this.desLineHeight=Number(a.getAttribute("lineHeight"));this.desTextAlign=a.getAttribute("desTextAlign");this.desTextShadowColor=a.getAttribute("desTextShadowColor").replace(/0x/g,"#");this.desTextShadowOffset=Number(a.getAttribute("desTextShadowOffset"));this.desTextShadowBlur=Number(a.getAttribute("desTextShadowBlur"));this.desTransform=Number(a.getAttribute("desTransform"));
this.desTransformOriginX=Number(a.getAttribute("desTransformOriginX"));this.desTransformOriginY=Number(a.getAttribute("desTransformOriginY"));this.videoAutoPlay=b.videoAutoPlay;this.bufferTime=b.bufferTime;this.videoControls=b.videoControls;a=b.thumbnailBasicXml;this.thumWidth=Number(a.getAttribute("thumWidth"));this.thumHeight=Number(a.getAttribute("thumHeight"));this.thumborder=Number(a.getAttribute("thumborder"));this.thumbnailBorderColor=a.getAttribute("borderColor").replace(/0x/g,"#");this.bullet=
a.getAttribute("bullet");this.arrows=a.getAttribute("arrows");this.thumbnailArray=b.thumbnailArray;this.photoArray=b.photoArray;this.photoUrlArray=b.photoUrlArray;this.URLTarget=b.URLTarget;this.videoArray=b.videoArray;this.transitionArray=b.transitionArray;this.photoTimeArray=b.photoTimeArray;this.transitionTimeArray=b.transitionTimeArray;this.defineTransitionArray=b.defineTransitionArray;this.photoTitleArray=b.photoTitleArray;this.descriptionText=b.descriptionText;this.photoCount=this.photoArray.length;
this.Play=function(){b.Play()};this.Pause=function(){b.Pause()};this.Previous=function(){b.Previous()};this.Next=function(){b.Next()};this.Show=function(a,d){b.Show(a,d)};this.MusicPlay=function(){b.MusicPlay()};this.MusicPause=function(){b.MusicPause()}}})();(function(){aJSsTemplate.ColorConverter={hexToRGB:function(b){var a,c,d;if(/rgb/.test(b))b=b.match(/\d+/g),a=parseInt(b[0]),c=parseInt(b[1]),d=parseInt(b[2]);else if(/#/.test(b)){var f=b.length;7===f?(a=parseInt(b.slice(1,3),16),c=parseInt(b.slice(3,5),16),d=parseInt(b.slice(5),16)):4===f&&(a=parseInt(b.charAt(1)+b.charAt(1),16),c=parseInt(b.charAt(2)+b.charAt(2),16),d=parseInt(b.charAt(3)+b.charAt(3),16))}else return b;return{r:a,g:c,b:d}}}})();(function(){aJSsTemplate.JsBackground=function(b,a){var c=b.globalPath,d=b.movieWidth,f=b.movieHeight,e=b.bottomPadding,h=b.leftPadding,j=b.rightPadding,i=new Image;a.appendChild(i);i.style.position="absolute";i.style.left="0";i.style.top=f-e+"px";i.style.width=d-h-j+"px";i.src=c+"res/shadow.png";i.style.height="72px"}})();(function(){aJSsTemplate.JsText=function(b,a){function c(a){a=a.index;""!=l[a]?(C.style.display="true"!==g?"block":"none",C.textContent=l[a]):C.style.display="none"}function d(){"true"==g?(C.style.display="none",A.style.cursor="pointer",a.onmouseover=function(){C.style.display="block";A.style.top=e-h-55-A.offsetHeight+"px"},a.onmouseout=function(){C.style.display="none";A.style.top=e-h-55-A.offsetHeight+"px"}):A.style.top=e-h-55-A.offsetHeight+"px"}function f(a){a=a.index;""!=H[a]?(D.style.display=
"block",D.innerHTML=H[a]):D.style.display="none"}var e=b.movieHeight,h=b.bottomPadding,j=b.leftPadding,i=b.showTitle,g=b.photoTitleAutoHide,l=b.photoTitleArray,k=b.photoTitleAlpha,q=b.photoTitleColor,n=b.titleTextAlign,p=b.titleTextFont,m=b.titleTextSize,r=b.titleTextShadowColor,t=b.titleTextShadowOffset,v=b.titleTextShadowBlur,y=b.textResize,u=b.textTransform,E=b.textTransformOriginX,x=b.textTransformOriginY,w=b.titleTransform,s=b.titleTransformOriginX,F=b.titleTransformOriginY,K=aJSsTemplate.ColorConverter.hexToRGB(b.photoTitleBackgroundColor),
N=b.enableDes,J=b.desLineHeight,H=b.descriptionText,G=b.desTextFont,B=b.desTextSize,W=b.desTextColor,S=b.desTextAlign,z=b.desTextShadowColor,I=b.desTextShadowOffset,O=b.desTextShadowBlur,L=b.desTransform,M=b.desTransformOriginX,P=b.desTransformOriginY,A=document.createElement("div");a.appendChild(A);A.style.position="absolute";A.style.display="block";A.style.backgroundColor="rgba("+K.r+","+K.g+","+K.b+","+k+")";A.style.backgroundRepeat="repeat";A.style.marginLeft=j+30+"px";A.style.marginRight="30px";
A.style.borderRadius="10px 10px 10px 10px";A.style.webkitTransform="rotate("+u+"deg)";A.style.msTransform="rotate("+u+"deg)";A.style.MozTransform="rotate("+u+"deg)";A.style.OTransform="rotate("+u+"deg)";A.style.transform="rotate("+u+"deg)";A.style.transformOrigin=""+x+"px "+E+"px";A.style.webkitTransformOrigin=""+x+"px "+E+"px";A.style.MozTransformOrigin=""+x+"px "+E+"px";A.style.OTransformOrigin=""+x+"px "+E+"px";A.style.resize=""+y+"";A.style.overflow="auto";if("true"==i){var C=document.createElement("div");
A.appendChild(C);C.textContent=l[0];C.style.webkitTransform="rotate("+w+"deg)";C.style.msTransform="rotate("+w+"deg)";C.style.MozTransform="rotate("+w+"deg)";C.style.OTransform="rotate("+w+"deg)";C.style.transform="rotate("+w+"deg)";C.style.transformOrigin=""+F+"px "+s+"px";C.style.webkitTransformOrigin=""+F+"px "+s+"px";C.style.MozTransformOrigin=""+F+"px "+s+"px";C.style.OTransformOrigin=""+F+"px "+s+"px";C.style.color=q;C.style.textAlign=n;C.style.fontFamily=p;C.style.fontSize=m+"px";C.style.textTransform=
"uppercase";C.style.padding="12px 12px 12px 12px";C.style.fontWeight="bold";C.style.textShadow=t+"px "+t+"px "+v+"px "+r;b.commandDispatcher.addEventListener("photoLoadComplete",c);b.commandDispatcher.addEventListener("photoLoadComplete",d)}if("true"==N){var D=document.createElement("div");A.appendChild(D);D.innerHTML=H[0];D.style.webkitTransform="rotate("+L+"deg)";D.style.msTransform="rotate("+L+"deg)";D.style.MozTransform="rotate("+L+"deg)";D.style.OTransform="rotate("+L+"deg)";D.style.transform=
"rotate("+L+"deg)";D.style.transformOrigin=""+P+"px "+M+"px";D.style.webkitTransformOrigin=""+P+"px "+M+"px";D.style.MozTransformOrigin=""+P+"px "+M+"px";D.style.OTransformOrigin=""+P+"px "+M+"px";D.style.textAlign=S;D.style.fontSize=B+"px";D.style.color=W;D.style.padding="12px 12px 12px 12px";D.style.fontFamily=G;D.style.lineHeight=J+"px";D.style.textTransform="none";D.style.textShadow=I+"px "+I+"px "+O+"px "+z;b.commandDispatcher.addEventListener("photoLoadComplete",f)}A.style.top=e-h-55-A.offsetHeight+
"px";""==l[0]&&""==H[0]&&(A.style.display="none");b.commandDispatcher.addEventListener("photoLoadComplete",function(){A.style.top=e-h-55-A.offsetHeight+"px"})}})();(function(){aJSsTemplate.JsThumbnail=function(b,a){globalPath=b.globalPath;var c=b.movieWidth,d=b.movieHeight,f=b.topPadding,e=b.bottomPadding,h=b.leftPadding,j=b.startAutoPlay,i=b.continuum,g=b.clickToAutoPlay,l=b.musicPath,k=b.musicAutoPlay,q=b.bullet,n=b.arrows,p=b.thumbnailArray,m=b.thumWidth,r=b.thumHeight,t=b.thumbnailBorderColor,v=b.thumborder,y=p.length,u=0,E=0,x=new Image;x.src=globalPath+q;x.onload=function(){var e=document.createElement("div");a.appendChild(e);e.id="thumbBox";e.style.position=
"absolute";e.style.top=f+5+"px";e.style.marginRight="10px";e.style.cssFloat="left";for(var d=this.width,j=this.height,k=0;k<y;k++){var l=document.createElement("a");e.appendChild(l);l.style.cursor="pointer";l.style.backgroundImage="url("+globalPath+""+q+")";l.style.width=d+"px";l.style.height=j/3+"px";l.style.cssFloat="left";l.style.margin="0px 2px 0px 2px";l.index=k}e.style.marginLeft=c-h-e.offsetWidth-10+"px";var n=e.getElementsByTagName("a");n[0].style.backgroundPosition="0 100%";var s=document.createElement("div");
s.id="thumbnail";e.appendChild(s);s.style.position="absolute";s.style.marginTop=j/3+6+"px";s.style.borderStyle="solid";s.style.borderColor=t;s.style.borderWidth=v+"px";s.style.cursor="pointer";s.style.display="none";s.style.overflow="visible";s.style.boxShadow="0 0 5px #999999";s.style.marginLeft=-((m+2*v)/2-(d+4)/2)+"px";e=document.createElement("span");s.appendChild(e);e.style.position="absolute";e.style.backgroundRepeat="no-repeat";e.style.width="15px";e.style.height="6px";e.style.left=m/2-7.5+
"px";e.style.top=-(6+v)+"px";j=document.createElement("div");s.appendChild(j);j.style.height=r+"px";j.style.overflow="visible";for(k=0;k<y;k++)l=new Image,j.appendChild(l),l.src=globalPath+p[k],l.style.display="none",l.style.width=m+"px",l.style.height=r+"px";for(var x=j.getElementsByTagName("img"),k=0;k<b.photoCount;k++)n[k].onmouseover=function(){E=this.index;for(var a=0;a<b.photoCount;a++)x[a].style.display="none";s.style.display="block";x[E].style.display="block";s.style.marginLeft=(d+4)*this.index-
((m+2*v)/2-(d+4)/2)+"px";u!==this.index&&(this.style.backgroundPosition="0 50%")},n[k].onclick=function(){for(var a=0;a<b.photoCount;a++)n[a].style.backgroundPosition="0 0";this.style.backgroundPosition="0 100%";u=this.index;"true"==g?(b.Show(u,1),w.style.display="none"):(b.Show(u,0),w.style.display="block")},n[k].onmouseout=function(){u!==this.index&&(this.style.backgroundPosition="0 0");s.style.display="none";x[E].style.display="none"},x[k].onclick=function(){for(var a=0;a<b.photoCount;a++)n[a].style.backgroundPosition=
"0 0";n[E].style.backgroundPosition="0 100%";"true"==g?(b.Show(E,1),w.style.display="none"):(b.Show(E,0),w.style.display="block")},e.onmouseover=function(){s.style.display="block";x[E].style.display="block"},x[k].onmouseout=function(){s.style.display="none";x[E].style.display="none"};b.commandDispatcher.addEventListener("photoLoadComplete",function(a){for(var c=0;c<b.photoCount;c++)n[c].style.backgroundPosition="0 0";n[a.index].style.backgroundPosition="0 100%";u=a.index;u>=b.photoCount-1&&("false"==
i&&"false"==b.randomPlayingPhotos)&&(w.style.display="block")})};x=new Image;x.src=globalPath+n;x.onload=function(){var f=this.width,j=this.height,i=document.createElement("div");a.appendChild(i);i.style.backgroundImage="url("+globalPath+""+n+")";i.style.backgroundPosition="0 0";i.style.cursor="pointer";i.style.width=f/2+"px";i.style.height=j+"px";i.style.marginLeft=h+"px";i.style.marginTop=(d-e)/2-j/2+"px";i.style.display="none";i.style.top="0";i.style.display="none";i.style.position="absolute";
var k=document.createElement("div");a.appendChild(k);k.style.backgroundImage="url("+globalPath+""+n+")";k.style.backgroundPosition="100% 0";k.style.cursor="pointer";k.style.width=f/2+"px";k.style.height=j+"px";k.style.marginLeft=c-f/2-h+"px";k.style.marginTop=(d-e)/2-j/2+"px";k.style.display="none";k.style.top="0";k.style.position="absolute";i.onmouseover=function(){this.style.boxShadow="0 0 10px #000000"};i.onmouseout=function(){this.style.boxShadow="0 0 0 #000000"};i.onclick=function(){"true"==
g?(0<u?b.Show(u-1,1):(b.Show(b.photoCount-1,1),u=0),w.style.display="none"):(b.Previous(),w.style.display="block")};k.onmouseover=function(){this.style.boxShadow="0 0 10px #000000"};k.onmouseout=function(){this.style.boxShadow="0 0 0 #000000"};k.onclick=function(){"true"==g?(u<b.photoCount-1?b.Show(u+1,1):(b.Show(0,1),u=0),w.style.display="none"):(b.Next(),w.style.display="block")};a.onmouseover=function(){k.style.display="block";i.style.display="block"};a.onmouseout=function(){k.style.display="none";
i.style.display="none"};b.commandDispatcher.addEventListener("photoLoadComplete",function(){a.onmouseover=function(){k.style.display="block";i.style.display="block"};a.onmouseout=function(){k.style.display="none";i.style.display="none"}})};x=document.createElement("div");a.appendChild(x);x.id="playMusicBox";x.style.position="absolute";x.style.left=h+"px";x.style.top=d-f-e-50+"px";x.style.width="100px";var w=document.createElement("div");x.appendChild(w);w.style.backgroundImage="url("+globalPath+"res/play2.png)";
w.style.width="50px";w.style.height="50px";w.style.cssFloat="left";w.style.display="block";var s=document.createElement("div");x.appendChild(s);s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)";s.style.width="50px";s.style.height="50px";s.style.cssFloat="left";s.style.display="block";s.style.cursor="pointer";w.style.display="true"==j?"none":"block";w.style.cursor="pointer";w.onmouseover=function(){w.style.backgroundImage="url("+globalPath+"res/play2.png)"};w.onmouseout=function(){w.style.backgroundImage=
"url("+globalPath+"res/play1.png)"};w.onclick=function(){b.Play();w.style.display="none"};var F=0;""==l?s.style.display="none":"true"==k?(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",s.onclick=function(){0==F?(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),F=1):(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),F=0)}):(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",s.onclick=function(){0==F?(s.style.backgroundImage=
"url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),F=1):(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),F=0)});b.commandDispatcher.addEventListener("soundPlayComplete",function(){s.style.backgroundImage="url("+globalPath+"res/musicStop.png)";F=1});b.commandDispatcher.addEventListener("videoPlayEnded",function(){w.style.display="none"})}})();(function(){aJSsTemplate.JsMenu=function(b,a){var c=b.movieWidth,d=b.movieHeight,f=b.bottomPadding,e=b.rightPadding,h=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=h&&"anvsoftUSSTheme"!=h&&"anvsoftHSMTheme"!=h){var j;switch(h){case "anvsoftPFMTheme":j="Photo Slideshow Maker";break;case "anvsoftUSSTheme":j="Ultra Slideshow";break;case "anvsoftHSMTheme":j="HTML5 Slideshow Maker";break;case "anvsoftSWWTheme":j="SlideWow";break;default:j="Anvsoft Photo Slideshow"}var i=document.createElement("div");
...
case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/","_self");break;case "anvsoftHSMTheme":window.open("http://www.html5-slideshow-maker.com/","_self");break;case "anvsoftSWWTheme":window.open("http://www.slidewow.com/","_self");break;default:window.open("http://www.anvsoft.com/","_self")}}}}})();(function(){aJSsTemplate.Main=function(b){var b=new aJSsTemplate.ExternalInterface(b),a=b.container;new aJSsTemplate.JsBackground(b,a);new aJSsTemplate.JsText(b,a);new aJSsTemplate.JsThumbnail(b,a);new aJSsTemplate.JsMenu(b,a)}})();(function(b){function a(a,c,b){for(var d=a.length,i=c.length,g,l,k,q,n,p,m=0,r=0;r<d;r++){g=a[r];l=a[r<d-1?r+1:0];m=g.y-l.y;g=l.x-g.x;l=Math.sqrt(m*m+g*g);m/=l;g/=l;l=k=a[0].x*m+a[0].y*g;for(var t=1;t<d;t++)p=a[t].x*m+a[t].y*g,p>k?k=p:p<l&&(l=p);q=n=c[0].x*m+c[0].y*g;for(t=1;t<i;t++)p=c[t].x*m+c[t].y*g,p>n?n=p:p<q&&(q=p);l<q?(l=q-k,m=-m,g=-g):l-=n;if(0<=l)return!1;l>b.overlap&&(b.overlap=l,b.normal.x=m,b.normal.y=g)}return b}var c=b.Quark=b.Quark||{version:"1.0.0",global:b},d=function(){};c.inherit=
...
(this._evtHandlers[i]=[]),l=0,k=!1;l<g.length;l++){var q=g[l];if(q.target==a&&q.callback.func==b.func){trace("duplicate callback");k=!0;break}}k||(g.push({target:a,callback:b,handler:f}),a.addEventListener(i,f,!1))}};b.prototype.unregister=function(a,c,b){for(var f=0;f<c.length;f++)for(var e=c[f],h=this._evtHandlers[e],j=0;j<h.length;j++){var i=h[j];if(i.target==a&&(i.callback.func==b||null==b)){a.removeEventListener(e,i.handler);h.splice(j,1);break}}};b.prototype._onEvent=function(a,c,d){var f=a,
...
(function(){aJSs.MaskEffect=function(b){this.transTotal=68;this.maskerFull=0;var a=this,c,d;this.transition=function(a,b,d,c,i){this.maskerFull=0;if(a<=this.transTotal)this["mask"+a](b,d,c,i);else this.transition(68,b,d,c,i)};this.mask1=function(f,e,h,j){function i(){q=e*m*d;n=h*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.setRect([0,0,e,h]),clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=0,q=0,n=
0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask2=function(f,e,h,j){function i(){q=e*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask3=function(f,e,h,j){function i(){n=h*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=0,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask4=function(f,e,h,j){function i(){l=e*(1-m*d);q=e*m*d;g.x=e*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask5=function(f,e,h,j){function i(){k=
h*(1-m*d);n=h*m*d;g.y=h*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=h,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask6=function(f,e,h,j){function i(){n=e*u*d;g.setRect([k,q,n,p]);m=e*(1-u*d);t=e*u*d;l.x=e*(1-u*d);l.setRect([m,r,t,v]);u++;if(u>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),f.removeChild(l),clearInterval(y),y=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var k=0,q=0,n=0,p=h,m=e,r=0,t=0,v=h;c=j*b;d=1/(2*c);var y=setInterval(i,1E3/b),u=1;i()};this.mask7=function(f,e,h,j){function i(){p=h*u*d;g.setRect([k,q,n,p]);r=h*(1-u*d);v=h*u*d;l.y=h*(1-u*d);l.setRect([m,r,t,v]);u++;if(u>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,
e,h]),f.removeChild(l),clearInterval(y),y=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var k=0,q=0,n=e,p=0,m=0,r=h,t=e,v=0;c=j*b;d=1/(2*c);var y=setInterval(i,1E3/b),u=1;i()};this.mask8=function(f,e,h,j){function i(){l=e/2*(1-m*d);q=e*m*d;g.x=e/2*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=
f.getChildAt(0),l=e/2,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask9=function(f,e,h,j){function i(){k=h/2*(1-m*d);n=h*m*d;g.y=h/2*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=h/2,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask10=function(f,e,h,j){function i(){for(var b=0;b<k;b++){var j=b*q,i=
q*r*d,l=h;f.getChildById("maskBitmap"+b).setRect([j,0,i,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(m);m=null}}for(var g=f.getChildAt(0),l=g.image,k=16,q=e/k,n=0;n<k;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.x=n*q;f.addChild(p)}c=j*b;d=1/c;var m=setInterval(i,1E3/b),r=1;i()};this.mask11=function(f,e,h,j){function i(){for(var b=
0;b<k;b++){var j=b*q,i=e,l=q*r*d;f.getChildById("maskBitmap"+b).setRect([0,j,i,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(m);m=null}}for(var g=f.getChildAt(0),l=g.image,k=16,q=h/k,n=0;n<k;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.y=n*q;f.addChild(p)}c=j*b;d=1/c;var m=setInterval(i,1E3/b),r=1;i()};this.mask12=
function(f,e,h,j){function i(){for(n=0;n<s;n++)x=m.length,0<x?(w=Math.floor(Math.random()*x),m[w].visible=!0,m.splice(w,1)):n=s;E++;if(E>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(u);u=null}}for(var g=f.getChildAt(0),l=g.image,k=Math.ceil(e/20),q=Math.ceil(h/20),n=0,p=0,m=[],n=0;20>n;n++)for(p=0;20>p;p++){var r=k*n,t=q*p,v=k,y=q;r<e&&t<
h&&(r>e-k&&(v=e-r),t>h-q&&(y=h-t),v=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[r,t,v,y]}),v.x=r,v.y=t,v.visible=!1,f.addChild(v),m.push(v))}c=j*b;d=1/c;var u=setInterval(i,1E3/b),E=1,x=m.length,w,s=Math.round(x/c);1>s&&(s=1);i()};this.mask13=function(f,e,h,j){function i(){l=e/2*(1-m*d);k=h/2*(1-m*d);q=e*m*d;n=h*m*d;g.x=e/2*(1-m*d);g.y=h/2*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),
g.x=0,g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e/2,k=h/2,q=0,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask14=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask15=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask16=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask17=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask18=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask19=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask20=function(a,
b,d,c){this.transition(68,a,b,d,c)};this.mask21=function(f,e,h,j){function i(){l=e*(1-m*d);k=h*(1-m*d);q=e*m*d;n=h*m*d;g.x=e*(1-m*d);g.y=h*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,k=h,q=0,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask22=function(f,e,h,j){function i(){l=e*(1-m*d);k=0;q=e*m*d;n=h*m*d;g.x=e*(1-m*
d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,k=0,q=0,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask23=function(f,e,h,j){function i(){l=0;k=h*(1-m*d);q=e*m*d;n=h*m*d;g.y=h*(1-m*d);g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=
0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=h,q=0,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask24=function(f,e,h,j){function i(){r=e/2*B*d;t=h/2*B*d;g.setRect([p,m,r,t]);v=e/2+e/2*(1-B*d);y=0;u=e/2*B*d;E=h/2*B*d;k.x=e/2+e/2*(1-B*d);k.setRect([v,y,u,E]);x=0;w=h/2+h/2*(1-B*d);s=e/2*B*d;F=h/2*B*d;q.y=h/2+h/2*(1-B*d);q.setRect([x,w,s,F]);K=e/2+e/2*(1-B*d);N=h/2+h/2*(1-B*d);J=e/2*B*d;H=h/2*B*d;n.x=e/2+e/2*(1-B*d);n.y=h/2+h/2*(1-B*d);n.setRect([K,N,J,H]);B++;if(B>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(G);G=null}}var g=f.getChildAt(0),l=g.image,k=new Quark.Bitmap({id:"targetBitmap2",image:l,rect:[0,0,0,0]});f.addChild(k);var q=new Quark.Bitmap({id:"targetBitmap3",image:l,rect:[0,0,0,0]});f.addChild(q);var n=new Quark.Bitmap({id:"targetBitmap4",image:l,rect:[0,0,0,0]});f.addChild(n);var p=0,m=0,r=0,t=0,v=e,y=0,u=0,E=0,x=0,w=h,s=0,F=0,K=e,N=h,J=0,H=0;c=j*b;d=1/c;var G=setInterval(i,1E3/b),B=1;i()};this.mask25=
function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask26=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask27=function(f,e,h,j){function i(){for(var b=0;b<k;b++){var i=q*b,j=q;n[b].x>e-q&&(j=e-n[b].x);var l=p[b]+(h-p[b])*u*d*h/(h-p[b]);l<h&&n[b].setRect([i,0,j,l])}u++;if(u>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(y);y=null}}for(var g=
f.getChildAt(0),l=g.image,k=20,q=Math.ceil(e/k),n=[],p=[],m=0;m<k;m++){p[m]=h/2*Math.random();var r=q*m,t=q,v=p[m];r>e-q&&(t=e-r);t=new Quark.Bitmap({id:"maskBitmap"+m,image:l,rect:[r,0,t,v]});t.x=r;f.addChild(t);n.push(t)}c=j*b;d=1/c;var y=setInterval(i,1E3/b),u=1;i()};this.mask28=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask29=function(f,e,h,j){function i(){g.alpha=k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.alpha=
1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.alpha=0;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask30=function(f,e,h,j){function i(){l=e*(1-m*d);q=e*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask31=function(f,e,h,j){function i(){g.alpha=
m*d;l=e*(1-m*d);q=e*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0);g.alpha=0;var l=e,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask32=function(f,e,h,j){function i(){q=e*m*d;g.setRect([l,k,q,n]);g.x=e*(1-m*d);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,
0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0);g.x=e;var l=0,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask33=function(f,e,h,j){function i(){g.alpha=m*d;q=e*m*d;g.setRect([l,k,q,n]);g.x=e*(1-m*d);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0);g.x=e;var l=g.alpha=0,k=0,q=0,n=h;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};
this.mask34=function(f,e,h,j){function i(){k=h*(1-m*d);n=h*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,k=h,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask35=function(f,e,h,j){function i(){g.alpha=m*d;k=h*(1-m*d);n=h*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),g.y=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0),l=g.alpha=0,k=h,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask36=function(f,e,h,j){function i(){g.y=h*(1-m*d);n=h*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0);g.y=h;var l=0,k=0,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask37=
function(f,e,h,j){function i(){g.alpha=m*d;g.y=h*(1-m*d);n=h*m*d;g.setRect([l,k,q,n]);m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0);g.alpha=0;g.y=h;var l=0,k=0,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),m=1;i()};this.mask38=function(f,e,h,j){function i(){g.width=e*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.width=e,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask39=function(f,e,h,j){function i(){g.alpha=k*d;g.width=e*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.alpha=0;g.width=0;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask40=function(f,e,h,
j){function i(){g.x=e/2*(1-k*d);g.width=e*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.x=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.x=e/2;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask41=function(f,e,h,j){function i(){g.alpha=k*d;g.x=e/2*(1-k*d);g.width=e*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.width=e,g.x=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.alpha=0;g.x=e/2;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask42=function(f,e,h,j){function i(){g.x=e*(1-k*d);g.width=e*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.x=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.x=e;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};
this.mask43=function(f,e,h,j){function i(){g.alpha=k*d;g.x=e*(1-k*d);g.width=e*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.x=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.alpha=0;g.x=e;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask44=function(f,e,h,j){function i(){g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.height=h,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask45=function(f,e,h,j){function i(){g.alpha=k*d;g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.alpha=0;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask46=function(f,
e,h,j){function i(){g.y=h/2*(1-k*d);g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.y=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.y=h/2;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask47=function(f,e,h,j){function i(){g.alpha=k*d;g.y=h/2*(1-k*d);g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.height=h,g.y=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.alpha=0;g.y=h/2;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask48=function(f,e,h,j){function i(){g.y=h*(1-k*d);g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.y=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.y=h;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;
i()};this.mask49=function(f,e,h,j){function i(){g.alpha=k*d;g.y=h*(1-k*d);g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.y=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.alpha=0;g.y=h;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask50=function(f,e,h,j){function i(){g.x=e/2*(1-k*d);g.y=h/2*(1-k*d);g.width=e*k*d;g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.width=e,g.height=h,g.x=0,g.y=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.height=0;g.x=e/2;g.y=h/2;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask51=function(f,e,h,j){function i(){g.alpha=k*d;g.x=e/2*(1-k*d);g.y=h/2*(1-k*d);g.width=e*k*d;g.height=h*k*d;k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.height=h,g.x=0,g.y=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);
g.setRect([0,0,e,h]);g.width=0;g.height=0;g.alpha=0;g.x=e/2;g.y=h/2;c=j*b;d=1/c;var l=setInterval(i,1E3/b),k=1;i()};this.mask52=function(a,b,d){a.getChildAt(0).setRect([0,0,b,d]);aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER})};this.mask53=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask54=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask55=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask56=function(a,b,d,c){this.transition(68,a,b,d,c)};
...
a,b,d,c)};this.mask66=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask67=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask68=function(f,e,h,j){function i(){for(n=0;n<B;n++)m[n].width=u[n]*G*d,m[n].height=E[n]*G*d,m[n].x=v[n]+(r[n]-v[n])*G*d,m[n].y=y[n]+(t[n]-y[n])*G*d;G++;if(G>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(H);
H=null}}for(var g=f.getChildAt(0),l=g.image,k=Math.ceil(e/12),q=Math.ceil(h/12),n=0,p=0,m=[],r=[],t=[],v=[],y=[],u=[],E=[],n=0;12>n;n++)for(p=0;12>p;p++){var x=k*n,w=q*p,s=k,F=q,K=Math.random()*(e-k),N=Math.random()*(h-q);if(x<e&&w<h){x>e-k&&(s=e-x);w>h-q&&(F=h-w);var J=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[x,w,s,F]});J.x=K;J.y=N;J.width=0;J.height=0;f.addChild(J);m.push(J);r.push(x);t.push(w);u.push(s);E.push(F);v.push(K);y.push(N)}}c=j*b;d=1/c;var H=setInterval(i,1E3/b),G=1,B=m.length;
i()}}})();
...
(function(){aJSs.JsCompatibleTheme=function(b,a,c){function d(){p--;0>=p&&(clearInterval(r),m++,m>n-1&&(m=0),v.src=c+e[m])}var f=b.movieBackgroundColor,e=b.photoArray,h=b.photoUrlArray,j=b.photoTimeArray,i=b.transitionTimeArray,g=b.URLTarget,l=b.topPadding,k=b.bottomPadding,q=b.leftPadding,b=b.rightPadding,n=e.length,p=0,m=0,r=null,t=document.getElementById(a);t.style.backgroundColor=f;var a=t.offsetWidth,f=t.offsetHeight,q=a-q-b,l=f-l-k,k=Math.round((a-q)/2),b=Math.round((f-l)/2),v=new Image;t.appendChild(v);
v.style.position="absolute";v.style.width=q+"px";v.style.height=l+"px";v.style.left=k+"px";v.style.top=b+"px";v.src=c+e[m];v.onload=function(){p=parseInt(i[m])+parseInt(j[m]);r=setInterval(d,1E3)};v.onclick=function(){var a;switch(g[m]){case "0":a="_blank";break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(h[m],a)};var y=document.createElement("div");t.appendChild(y);y.style.position="absolute";y.style.width="250px";y.style.padding="8px";
y.style.backgroundColor="#333";y.style.color="#FFF";y.style.textAlign="left";y.style.font="normal normal 12px/16px verdana,tahoma,arial,sans-serif";y.innerHTML="The browser you are using does not support HTML5. Now you are using the simple compatible mode. To get better user experience, please use HTML5 supported browser.";y.style.left=Math.round((a-y.offsetWidth)/2)+"px";y.style.top=Math.round((f-y.offsetHeight)/2)+"px";var u=setTimeout(function(){clearTimeout(u);u=null;t.removeChild(y)},1E4)}})();
...
(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});if(""!=u){e();var a=new Image;a.src=c+u;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=t+(F-a.width)/2;a.y=m+(K-a.height)/2;M.addChild(a)}G=H=0;X&&X.removeAllChildren();R.swapChildren(T,U);R.getChildIndex(T)>R.getChildIndex(U)?
(Y=T,X=U):(Y=U,X=T);var b=new Image;b.onload=function(){e();H=1;b.width=P;b.height=A;var a=new Quark.Bitmap({id:"targetBitmap",image:b,rect:[0,0,0.0010,0.0010]});a.useHandCursor="true"==g&&""!=i[z]?!0:!1;Y.addChild(a);W=0==q[z]?null==n?Math.floor(Math.random()*L.transTotal)+1:n[Math.floor(Math.random()*n.length)]:q[z];L.transition(W,Y,P,A,p[z]);a.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==g&&""!=i[z]){switch(l[z]){case "0":a="_blank";break;case "1":a="_parent";break;
case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(i[z],a)}}else"mousemove"==a.type||"touchmove"==a.type?aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OVER}):("mouseout"==a.type||"touchout"==a.type)&&aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OUT})};aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_LOAD_COMPLETE,index:z})};b.src=c+j[z];aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_CURRENT,
index:z});z>=O-1&&"false"==x&&"false"==y&&N.Pause()}function f(){S--;try{Quark.getDOM("debugInfo").value=S}catch(a){}if(0>=S||1==B)clearInterval(I),I=null,0==B?"true"==y?z=Math.floor(Math.random()*O):z<O-1?z++:z=0:B=0,d()}function e(){if(""!=u){var a=M.getChildById("preloader");null!=a&&M.removeChild(a)}}var h=b.frameRate,j=b.photoArray,i=b.photoUrlArray,g=b.enableURL,l=b.URLTarget,k=b.photoTimeArray,q=b.transitionArray,n=b.defineTransitionArray,p=b.transitionTimeArray,m=b.topPadding,r=b.bottomPadding,
t=b.leftPadding,v=b.rightPadding,y=b.randomPlayingPhotos,u=b.loadStyle,E=b.startAutoPlay,x=b.continuum,w=b.videoAutoPlay,s=b.videoArray,F=a.width-t-v,K=a.height-m-r,N=this,J=0,H=1,G=1,B=0,W=0,S=0,z=0,I=null,O=j.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){G=1;if(1==J||1==B)S=k[z]*h,I=setInterval(f,1E3/h);""!=s[z]&&void 0!=s[z]&&0==B&&("true"==w&&(clearInterval(I),I=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,
index:z,width:F,height:K}))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){N.Play()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){N.Pause()});var L=new aJSs.MaskEffect(h),M=new Quark.DisplayObjectContainer({id:"container"});M.autoSize=!0;a.addChild(M);var P=a.width-t-v,A=a.height-m-r,b=t,a=m,r=Quark.Bitmap,v=P,C=A,D="#DDD",V=document.createElement("canvas");V.width=v;V.height=C;var Z=V.getContext("2d");Z.fillStyle=
D;Z.rect(0,0,v,C);Z.fill();D=new Image;D.src=V.toDataURL("image/png");D.width=v;D.height=C;r=new r({id:"photoBoxBg",image:D});r.autoSize=!0;r.x=b;r.y=a;M.addChild(r);var R=new Quark.DisplayObjectContainer({id:"photoBox",x:b,y:a,width:P,height:A});R.autoSize=!0;M.addChild(R);var X,Y,T=new Quark.DisplayObjectContainer({id:"aPhoto"}),U=new Quark.DisplayObjectContainer({id:"bPhoto"});R.addChild(T);R.addChild(U);this.Play=function(){J=1;1==H&&1==G?(clearInterval(I),I=null,z<O-1?z++:z=0,d()):1==H&&0==G?
(B=1,z<O-1?z++:z=0,L.maskerFull=1):(z<O-1?z++:z=0,B=1)};this.Pause=function(){J=0;null!=I&&(clearInterval(I),I=null)};this.Previous=function(a){J=a;0<z?z--:z=O-1;1==H&&1==G?(clearInterval(I),I=null,d()):1==H&&0==G?(B=1,L.maskerFull=1):B=1};this.Next=function(a){J=a;z<O-1?z++:z=0;1==H&&1==G?(clearInterval(I),I=null,d()):1==H&&0==G?(B=1,L.maskerFull=1):B=1};this.Show=function(a,b){J=b;1==H&&1==G?(clearInterval(I),I=null,z=a,d()):1==H&&0==G?(B=1,z=a,L.maskerFull=1):(z=a,B=1)};"true"==E?this.Show(0,1):
this.Show(0,0)}})();
(function(){aJSs.JsMediaConsole=function(b,a,c,d){function f(){void 0!=r&&(b.removeChild(r),void 0!=m&&"videoCallPause"==t&&(m.Play(),t=""),r=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var h=a.topPadding,j=a.leftPadding,c=a.musicPath,i=a.musicAutoPlay,g=a.musicLoop,l=a.musicStream,k=a.videoAutoPlay,q=a.bufferTime,n=a.videoArray,p=a.videoControls;if(""!=c)var m=new aJSs.Music(d+c,l,i,g);var r,t="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,function(a){var c=
a.index,e=a.width,a=a.height;void 0!=m&&m.Playing()&&(m.Pause(),t="videoCallPause");r=new aJSs.Video(d+n[c],k,q,p,e,a);r.style.backgroundColor="#000";r.style.position="absolute";r.style.top=h+"px";r.style.left=j+"px";b.appendChild(r);c=document.getElementById("videoLoadText");null==c&&(c=document.createElement("div"),c.id="videoLoadText",c.style.position="absolute",c.style.top=h+5+"px",c.style.left=j+5+"px",c.style.font="normal normal 11px/13px verdana,tahoma,arial,sans-serif",c.style.color="#FFF",
c.textContent="Waiting...",b.appendChild(c))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_PLAY_ENDED,function(){f();aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_NEXT})});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_CLEAR,function(){f()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){e()});this.MusicPlay=function(){m.Play()};this.MusicPause=function(){m.Pause()}}})();
...
1);var l=a.clientWidth||a.offsetWidth,k=a.clientHeight||a.offsetHeight;1==g.mode?(c=Quark.createDOM("canvas",{width:l,height:k}),a.appendChild(c),j=new Quark.CanvasContext({canvas:c})):j=new Quark.DOMContext({canvas:a});c=new Quark.Stage({width:l,height:k,context:j});(new Q.EventManager).registerStage(c,i);j=new aJSs.JsXmlLoad(d);i=new aJSs.JsPhoto(j,c,f);g=new aJSs.JsMediaConsole(a,j,c,f);new aJSs.JsMenu(j,c);l=new Q.Timer(1E3/j.frameRate);l.addListener(c);l.start();j=new aJSs.JsInterface(a,j,i,

...
b.transitionTimeArray;this.defineTransitionArray=b.defineTransitionArray;this.photoTitleArray=b.photoTitleArray;this.descriptionText=b.descriptionText;this.photoCount=this.photoArray.length;this.Play=function(){b.Play()};this.Pause=function(){b.Pause()};this.Previous=function(){b.Previous()};this.Next=function(){b.Next()};this.Show=function(a,c){b.Show(a,c)};this.MusicPlay=function(){b.MusicPlay()};this.MusicPause=function(){b.MusicPause()}}})();(function(){aJSsTemplate.ColorConverter={hexToRGB:function(b){var a,c,d;if(/rgb/.test(b))b=b.match(/\d+/g),a=parseInt(b[0]),c=parseInt(b[1]),d=parseInt(b[2]);else if(/#/.test(b)){var g=b.length;7===g?(a=parseInt(b.slice(1,3),16),c=parseInt(b.slice(3,5),16),d=parseInt(b.slice(5),16)):4===g&&(a=parseInt(b.charAt(1)+b.charAt(1),16),c=parseInt(b.charAt(2)+b.charAt(2),16),d=parseInt(b.charAt(3)+b.charAt(3),16))}else return b;return{r:a,g:c,b:d}}}})();(function(){aJSsTemplate.JsBackground=function(b,a){var c=b.globalPath,d=b.movieWidth,g=b.movieHeight,e=b.topPadding,h=b.bottomPadding,i=b.leftPadding,j=b.rightPadding,f=new Image;a.appendChild(f);f.style.position="absolute";f.style.top="0px";f.style.left="0px";f.style.width=d+"px";f.style.height=g+"px";f.src=c+"res/bg2.jpg";f.style.zIndex="-1";c=document.createElement("div");a.appendChild(c);c.style.position="absolute";c.style.top=e-10+"px";c.style.left=i-10+"px";c.style.width=d-i-j+"px";c.style.height=
g-e-h+"px";c.style.borderWidth="10px";c.style.borderStyle="solid";c.style.borderColor="#ff6600";c.style.borderRadius="5px 5px 5px 5px";c.style.zIndex="-1"}})();(function(){aJSsTemplate.JsDecorate=function(b,a){var c=b.globalPath,d=Number(b.movieWidth),g=Number(b.movieHeight),e=Number(b.topPadding),h=Number(b.bottomPadding),i=Number(b.leftPadding),j=Number(b.rightPadding),f=new Image;a.appendChild(f);f.style.position="absolute";f.style.top=e-10-162+"px";f.style.left=i-10+170+(d-i-j+20-170-100)/2-200+"px";f.style.width="400px";f.style.height="217px";f.src=c+"res/topTree.gif";f=new Image;a.appendChild(f);f.style.position="absolute";f.style.top=e-10-169+"px";
f.style.left=i-10-59+"px";f.style.width="224px";f.style.height="297px";f.src=c+"res/balloonLeft.png";f=new Image;a.appendChild(f);f.style.position="absolute";f.style.top=e-10-130+"px";f.style.left=i+(d-i-j)+10-95+"px";f.style.width="168px";f.style.height="247px";f.src=c+"res/balloonRight.gif";f=new Image;a.appendChild(f);f.style.position="absolute";f.style.top=e+(g-e-h)+10+"px";f.style.left=i-10+(d-i-j)/2-103.5+"px";f.style.width="207px";f.style.height="161px";f.src=c+"res/balloonBottom.gif";f=new Image;
f.style.position="absolute";f.style.top=e+(g-e-h)-30+"px";f.style.left=i-10+"px";f.style.width="200px";f.style.height="204px";f.src=c+"res/thumbnail.png";a.appendChild(f);400<=(d+20-i-j)/2&&(f=new Image,f.style.position="absolute",f.style.top=e+(g-e-h)-30+"px",f.style.left=i-10+200-56+"px",f.style.width="200px",f.style.height="204px",f.src=c+"res/thumbnail.png",a.appendChild(f),i=new Image,i.style.position="absolute",i.style.top=e+(g-e-h)-30+"px",i.style.left=d-j+10-200-200+56+"px",i.style.width=
"200px",i.style.height="204px",i.src=c+"res/thumnailb.png",a.appendChild(i));i=new Image;i.style.position="absolute";i.style.top=e+(g-e-h)-30+"px";i.style.left=d-j+10-200+"px";i.style.width="200px";i.style.height="204px";i.src=c+"res/thumnailb.png";a.appendChild(i)}})();(function(){aJSsTemplate.JsText=function(b,a){function c(a){a=a.index;""!=n[a]?(F.style.display="true"!==q?"block":"none",F.textContent=n[a]):F.style.display="none"}function d(){"true"==q&&(F.style.display="none",G.style.cursor="pointer",a.addEventListener("mouseover",e),a.addEventListener("mouseout",h))}function g(a){a=a.index;""!=L[a]?(E.style.display="block",E.innerHTML=L[a]):E.style.display="none"}function e(){F.style.display="block"}function h(){F.style.display="none"}var i=b.movieWidth,j=b.topPadding,
f=b.leftPadding,l=b.rightPadding,m=b.showTitle,q=b.photoTitleAutoHide,n=b.photoTitleArray,p=b.photoTitleAlpha,k=b.photoTitleColor,r=b.titleTextAlign,s=b.titleTextFont,u=b.titleTextSize,w=b.titleTextShadowColor,x=b.titleTextShadowOffset,H=b.titleTextShadowBlur,C=b.textResize,K=b.textTransform,I=b.textTransformOriginX,M=b.textTransformOriginY,O=b.titleTransform,J=b.titleTransformOriginX,B=b.titleTransformOriginY,A=aJSsTemplate.ColorConverter.hexToRGB(b.photoTitleBackgroundColor),y=b.enableDes,v=b.desLineHeight,
L=b.descriptionText,D=b.desTextFont,t=b.desTextSize,z=b.desTextColor,R=b.desTextAlign,P=b.desTextShadowColor,N=b.desTextShadowOffset,V=b.desTextShadowBlur,T=b.desTransform,U=b.desTransformOriginX,S=b.desTransformOriginY,G=document.createElement("div");a.appendChild(G);G.style.position="absolute";G.style.top=j+"px";G.style.display="block";G.style.width=i-f-l-60+"px";G.style.backgroundColor="rgba("+A.r+","+A.g+","+A.b+","+p+")";G.style.backgroundRepeat="repeat";G.style.marginLeft=f+30+"px";G.style.marginRight=
l+30+"px";G.style.borderRadius="0px 0px 10px 10px";G.style.webkitTransform="rotate("+K+"deg)";G.style.msTransform="rotate("+K+"deg)";G.style.MozTransform="rotate("+K+"deg)";G.style.OTransform="rotate("+K+"deg)";G.style.transform="rotate("+K+"deg)";G.style.transformOrigin=""+M+"px "+I+"px";G.style.webkitTransformOrigin=""+M+"px "+I+"px";G.style.MozTransformOrigin=""+M+"px "+I+"px";G.style.OTransformOrigin=""+M+"px "+I+"px";G.style.resize=""+C+"";G.style.overflow="auto";if("true"==m){var F=document.createElement("div");
G.appendChild(F);F.textContent=n[0];F.style.webkitTransform="rotate("+O+"deg)";F.style.msTransform="rotate("+O+"deg)";F.style.MozTransform="rotate("+O+"deg)";F.style.OTransform="rotate("+O+"deg)";F.style.transform="rotate("+O+"deg)";F.style.transformOrigin=""+B+"px "+J+"px";F.style.webkitTransformOrigin=""+B+"px "+J+"px";F.style.MozTransformOrigin=""+B+"px "+J+"px";F.style.OTransformOrigin=""+B+"px "+J+"px";F.style.color=k;F.style.textAlign=r;F.style.fontFamily=s;F.style.fontSize=u+"px";F.style.textTransform=
"uppercase";F.style.padding="12px 12px 12px 12px";F.style.fontWeight="bold";F.style.textShadow=x+"px "+x+"px "+H+"px "+w;b.commandDispatcher.addEventListener("photoLoadComplete",c);b.commandDispatcher.addEventListener("photoLoadComplete",d)}if("true"==y){var E=document.createElement("div");G.appendChild(E);E.innerHTML=L[0];E.style.webkitTransform="rotate("+T+"deg)";E.style.msTransform="rotate("+T+"deg)";E.style.MozTransform="rotate("+T+"deg)";E.style.OTransform="rotate("+T+"deg)";E.style.transform=
"rotate("+T+"deg)";E.style.transformOrigin=""+S+"px "+U+"px";E.style.webkitTransformOrigin=""+S+"px "+U+"px";E.style.MozTransformOrigin=""+S+"px "+U+"px";E.style.OTransformOrigin=""+S+"px "+U+"px";E.style.textAlign=R;E.style.fontSize=t+"px";E.style.color=z;E.style.padding="12px 12px 12px 12px";E.style.fontFamily=D;E.style.lineHeight=v+"px";E.style.textTransform="none";E.style.textShadow=N+"px "+N+"px "+V+"px "+P;b.commandDispatcher.addEventListener("photoLoadComplete",g)}}})();(function(){aJSsTemplate.JsThumbnail=function(b,a){function c(){z.scrollLeft-=J}function d(){z.scrollLeft+=J}globalPath=b.globalPath;var g=Number(b.movieWidth),e=Number(b.movieHeight),h=Number(b.topPadding),i=Number(b.bottomPadding),j=Number(b.leftPadding),f=Number(b.rightPadding),l=b.startAutoPlay,m=b.continuum,q=b.clickToAutoPlay,n=b.musicPath,p=b.musicAutoPlay,k=b.photoArray,r=b.thumbnailArray,s=b.thumWidth,u=b.thumHeight,w=b.thumbnailBorderColor,x=b.currentBorderColor,H=b.thumborder,C=0;aJSsTemplate.ColorConverter.hexToRGB(b.thumBoxColor);
var K=u+2*H,I=0,M=0,O=0;if(400<=(g+20-j-f)/2)var M=g+20-j-f-688+104+(109-2*((s+2*H)/2)),J=4*(s+2*H)+2*(35+(109-s-2*H))+2*M;else M=g+20-j-f-400+104+(109-2*((s+2*H)/2)),J=2*(s+2*H)+2*M;var B=document.createElement("div");a.appendChild(B);B.id="thumBody";B.style.position="absolute";B.style.top=e-i+83.5-(u+2*H)/2+"px";B.style.left=j+29+54.5-(s+2*H)/2+"px";B.style.width=J+"px";B.style.height=K+"px";B.style.margin="0px auto";B.style.borderRadius="5px 5px 5px 5px";B.style.display="block";var A=document.createElement("div");
a.appendChild(A);A.style.position="absolute";A.style.background="url("+globalPath+"res/thumleft1.png)";A.style.top=e-i+40+"px";A.style.left=j-10-22+"px";A.style.width="50px";A.style.height="60px";var y=document.createElement("div");a.appendChild(y);y.style.position="absolute";y.style.background="url("+globalPath+"res/thumright1.png)";y.style.top=e-i+40+"px";y.style.left=g-f+10-50+22+"px";y.style.width="50px";y.style.height="60px";var v=document.createElement("div");a.appendChild(v);v.style.position=
"absolute";v.style.cursor="pointer";v.style.display="none";v.style.background="url("+globalPath+"res/prev1.png)";v.style.top=h+(e-h-i)/2-8+"px";v.style.left=j-35+"px";v.style.width="70px";v.style.height="16px";var L=document.createElement("div");a.appendChild(L);L.style.position="absolute";L.style.cursor="pointer";L.style.display="none";L.style.top=h+(e-h-i)/2-8+"px";L.style.left=j+(g-j-f)-35+"px";L.style.background="url("+globalPath+"res/next1.png)";L.style.width="70px";L.style.height="16px";var D=
document.createElement("div");a.appendChild(D);D.style.position="absolute";D.style.backgroundImage="url("+globalPath+"res/play2.png)";D.style.top=e-i-(e-h-i)/2-(u+2*H+10)/2+"px";D.style.left=j+(g-j-f)/2-25+"px";D.style.width="50px";D.style.height="50px";D.style.display="block";D.style.cursor="pointer";var t=document.createElement("div");a.appendChild(t);t.style.position="absolute";t.style.backgroundImage="url("+globalPath+"res/musicPlay.png)";t.style.top=h+90+"px";t.style.left=j+(g-j-f)+10-25+"px";
t.style.width="50px";t.style.height="64px";t.style.display="block";t.style.cursor="pointer";var z=document.createElement("div");B.appendChild(z);z.id="showThumbnails";z.style.position="absolute";z.style.top=(u+2*H)/2-(u+2*H)/2+"px";z.style.width=J+"px";z.style.height=u+2*H+"px";z.style.overflow="hidden";e=document.createElement("div");z.appendChild(e);e.id="showArea";if(400<=(g+20-j-f)/2)for(h=0;h<b.photoCount;h++)i=new Image,i.style.width=s+"px",i.style.height=u+"px",i.style.cursor="pointer",i.style.borderWidth=
H+"px",i.style.borderStyle="solid",i.style.borderColor=w,i.style.cssFloat="left",i.style.marginRight=1==h%2?M+"px":35+(109-s-2*H)+"px",i.src=globalPath+r[h],i.alt=k[h],i.index=h,I=J*Math.ceil(b.photoCount/4),e.appendChild(i);else for(h=0;h<b.photoCount;h++)i=new Image,i.style.width=s+"px",i.style.height=u+"px",i.style.cursor="pointer",i.style.borderWidth=H+"px",i.style.borderStyle="solid",i.style.borderColor=w,i.style.cssFloat="left",i.style.marginRight=M+"px",i.src=globalPath+r[h],i.alt=k[h],i.index=
h,I=J*Math.ceil(b.photoCount/2),e.appendChild(i);e.style.width=I+"px";e.style.height=u+2*H+"px";var R=I;A.style.cursor="pointer";y.style.cursor="pointer";A.onmouseover=function(){A.style.background="url("+globalPath+"res/thumleft2.png)"};A.onmouseout=function(){A.style.background="url("+globalPath+"res/thumleft1.png)"};A.onclick=function(){0==z.scrollLeft?z.scrollLeft=R:setTimeout(c,0)};y.onmouseover=function(){y.style.background="url("+globalPath+"res/thumright2.png)"};y.onmouseout=function(){y.style.background=
"url("+globalPath+"res/thumright1.png)"};y.onclick=function(){z.scrollLeft==R-J?z.scrollLeft=0:setTimeout(d,0)};v.onmouseover=function(){this.style.background="url("+globalPath+"res/prev2.png)"};v.onmouseout=function(){this.style.background="url("+globalPath+"res/prev1.png)"};v.onclick=function(){"true"==q?(0<C?b.Show(C-1,1):(b.Show(b.photoCount-1,1),C=0),D.style.display="none"):(b.Previous(),D.style.display="block")};L.onmouseover=function(){this.style.background="url("+globalPath+"res/next2.png)"};
L.onmouseout=function(){this.style.background="url("+globalPath+"res/next1.png)"};L.onclick=function(){"true"==q?(C<b.photoCount-1?b.Show(C+1,1):(b.Show(0,1),C=0),D.style.display="none"):(b.Next(),D.style.display="block")};a.addEventListener("mouseover",function(){L.style.display="block";v.style.display="block"});a.addEventListener("mouseout",function(){L.style.display="none";v.style.display="none"});var P=e.getElementsByTagName("img");P[0].style.borderColor=x;for(h=0;h<b.photoCount;h++)P[h].onmouseover=
function(){this.style.borderColor=x},P[h].onclick=function(){for(var a=0;a<b.photoCount;a++)P[a].style.borderColor=w;P[this.index].style.borderColor=x;C=this.index;"true"==q?(b.Show(C,1),D.style.display="none"):(b.Show(C,0),D.style.display="block")},P[h].onmouseout=function(){C!==this.index&&(this.style.borderColor=w)};b.commandDispatcher.addEventListener("photoLoadComplete",function(a){for(var c=0;c<b.photoCount;c++)P[c].style.borderColor=w;P[a.index].style.borderColor=x;C=a.index;C>=b.photoCount-
1&&("false"==m&&"false"==b.randomPlayingPhotos)&&(D.style.display="block");O=400<=(g+20-j-f)/2?parseInt(C/4):parseInt(C/2);z.scrollLeft=J*O});D.style.display="true"==l?"none":"block";D.style.cursor="pointer";D.onmouseover=function(){D.style.backgroundImage="url("+globalPath+"res/play1.png)"};D.onmouseout=function(){D.style.backgroundImage="url("+globalPath+"res/play2.png)"};D.onclick=function(){b.Play();D.style.display="none"};var N=0;""==n?t.style.display="none":"true"==p?(t.style.backgroundImage=
"url("+globalPath+"res/musicPlay.png)",t.onclick=function(){0==N?(t.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),N=1):(t.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),N=0)}):(t.style.backgroundImage="url("+globalPath+"res/musicStop.png)",t.onclick=function(){0==N?(t.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),N=1):(t.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),N=0)});b.commandDispatcher.addEventListener("soundPlayComplete",
function(){t.style.backgroundImage="url("+globalPath+"res/musicStop.png)";N=1});b.commandDispatcher.addEventListener("videoPlayEnded",function(){D.style.display="none"})}})();(function(){aJSsTemplate.JsMenu=function(b,a){var c=b.movieWidth,d=b.movieHeight,g=b.bottomPadding,e=b.rightPadding,h=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=h&&"anvsoftUSSTheme"!=h&&"anvsoftHSMTheme"!=h){var i;switch(h){case "anvsoftPFMTheme":i="Photo Slideshow Maker";break;case "anvsoftUSSTheme":i="Ultra Slideshow";break;case "anvsoftHSMTheme":i="HTML5 Slideshow Maker";break;case "anvsoftSWWTheme":i="SlideWow";break;default:i="Anvsoft Photo Slideshow"}var j=document.createElement("div");
j.style.position="absolute";j.style.cursor="pointer";j.style.padding="5px";j.style.backgroundColor="rgba(0, 0, 0, 0.3)";j.style.textShadow="1px 1px 1px #000";j.style.borderRadius="5px";j.style.color="#FFF";j.style.font="normal normal 10px/12px verdana,tahoma,arial,sans-serif";j.textContent=i;a.appendChild(j);j.style.left=c-e-j.scrollWidth-5+"px";j.style.top=d-g-j.scrollHeight-5+"px";j.onclick=function(){switch(h){case "anvsoftPFMTheme":window.open("http://www.photo-flash-maker.com/","_self");break;
case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/","_self");break;case "anvsoftHSMTheme":window.open("http://www.html5-slideshow-maker.com/","_self");break;case "anvsoftSWWTheme":window.open("http://www.slidewow.com/","_self");break;default:window.open("http://www.anvsoft.com/","_self")}}}}})();(function(){aJSsTemplate.Main=function(b){var b=new aJSsTemplate.ExternalInterface(b),a=b.container;new aJSsTemplate.JsBackground(b,a);new aJSsTemplate.JsDecorate(b,a);new aJSsTemplate.JsText(b,a);new aJSsTemplate.JsThumbnail(b,a);new aJSsTemplate.JsMenu(b,a)}})();(function(b){function a(a,c,b){for(var d=a.length,j=c.length,f,l,m,q,n,p,k=0,r=0;r<d;r++){f=a[r];l=a[r<d-1?r+1:0];k=f.y-l.y;f=l.x-f.x;l=Math.sqrt(k*k+f*f);k/=l;f/=l;l=m=a[0].x*k+a[0].y*f;for(var s=1;s<d;s++)p=a[s].x*k+a[s].y*f,p>m?m=p:p<l&&(l=p);q=n=c[0].x*k+c[0].y*f;for(s=1;s<j;s++)p=c[s].x*k+c[s].y*f,p>n?n=p:p<q&&(q=p);l<q?(l=q-m,k=-k,f=-f):l-=n;if(0<=l)return!1;l>b.overlap&&(b.overlap=l,b.normal.x=k,b.normal.y=f)}return b}var c=b.Quark=b.Quark||{version:"1.0.0",global:b},d=function(){};c.inherit=
...
c.createDOM=function(a,c){var b=document.createElement(a),d;for(d in c){var j=c[d];if("style"==d)for(var f in j)b.style[f]=j[f];else b[d]=j}return b};c.use=function(a){for(var a=a.split("."),c=b,d=0;d<a.length;d++)var i=a[d],c=c[i]||(c[i]={});return c};(function(a){var c=a.ua=navigator.userAgent;a.isWebKit=/webkit/i.test(c);a.isMozilla=/mozilla/i.test(c);a.isIE=/msie/i.test(c);a.isFirefox=/firefox/i.test(c);a.isChrome=/chrome/i.test(c);a.isSafari=/safari/i.test(c)&&!this.isChrome;a.isMobile=/mobile/i.test(c);
...
a.offsetLeft,b=a.offsetTop;(a=a.offsetParent)&&a!=document.body&&a!=document;)c+=a.offsetLeft,b+=a.offsetTop;return{left:c,top:b}};c.createDOMDrawable=function(a,b){var d=a.tagName||"div",i=b.image,j=a.width||i&&i.width,f=a.height||i&&i.height,l=c.createDOM(d);a.id&&(l.id=a.id);l.style.position="absolute";l.style.left=(a.left||0)+"px";l.style.top=(a.top||0)+"px";l.style.width=j+"px";l.style.height=f+"px";if("canvas"==d)l.width=j,l.height=f,i&&(d=l.getContext("2d"),j=b.rect||[0,0,j,f],d.drawImage(i,
j[0],j[1],j[2],j[3],a.x||0,a.y||0,a.width||j[2],a.height||j[3]));else if(l.style.opacity=void 0!=a.alpha?a.alpha:1,l.style.overflow="hidden",i&&i.src)l.style.backgroundImage="url("+i.src+")",l.style.backgroundPosition=-(a.rectX||0)+"px "+-(a.rectY||0)+"px";return l};c.DEG_TO_RAD=Math.PI/180;c.RAD_TO_DEG=180/Math.PI;c.hitTestPoint=function(a,c,b,d){var a=a.getBounds(),j=a.length,f=c>=a.x&&c<=a.x+a.width&&b>=a.y&&b<=a.y+a.height;if(f&&d){for(var d=0,f=!1,l,m,q,n,p=0;p<j;p++){var k=a[p],r=a[(p+1)%j];
k.y==r.y&&b==k.y&&(k.x>r.x?(l=r.x,m=k.x):(l=k.x,m=r.x),c>=l&&c<=m)?f=!0:(k.y>r.y?(q=r.y,n=k.y):(q=k.y,n=r.y),b<q||b>n||(k=(b-k.y)*(r.x-k.x)/(r.y-k.y)+k.x,k>c?d++:k==c&&(f=!0)))}return f?0:1==d%2?1:-1}return f?1:-1};c.hitTestObject=function(a,b,d){a=a.getBounds();b=b.getBounds();return(a=a.x<=b.x+b.width&&b.x<=a.x+a.width&&a.y<=b.y+b.height&&b.y<=a.y+a.height)&&d?(a=c.polygonCollision(b,b),!1!==a):a};c.polygonCollision=function(c,b){var d=a(c,b,{overlap:-Infinity,normal:{x:0,y:0}});return d?a(b,c,
...
(function(){var b=Quark.EventManager=function(){this.keyState={};this._evtHandlers={}};b.prototype.registerStage=function(a,c,b,g){this.register(a.context.canvas,c,{host:a,func:a._onEvent},b,g)};b.prototype.unregisterStage=function(a,c){this.unregister(a.context.canvas,c,a.onEvent)};b.prototype.register=function(a,c,b,g,e){if(null==b||"function"==typeof b)b={host:null,func:b};for(var h={prevent:g,stop:e},i=this,g=function(a){i._onEvent(a,h,b)},e=0;e<c.length;e++){for(var j=c[e],f=this._evtHandlers[j]||
(this._evtHandlers[j]=[]),l=0,m=!1;l<f.length;l++){var q=f[l];if(q.target==a&&q.callback.func==b.func){trace("duplicate callback");m=!0;break}}m||(f.push({target:a,callback:b,handler:g}),a.addEventListener(j,g,!1))}};b.prototype.unregister=function(a,c,b){for(var g=0;g<c.length;g++)for(var e=c[g],h=this._evtHandlers[e],i=0;i<h.length;i++){var j=h[i];if(j.target==a&&(j.callback.func==b||null==b)){a.removeEventListener(e,j.handler);h.splice(i,1);break}}};b.prototype._onEvent=function(a,c,d){var g=a,
...
(function(){function b(a,c){for(var d=0;d<a.children.length;d++){var i=a.children[d];if(i.children)b(i,c);else if(null!=c){i=i.getBounds();c.globalAlpha=0.2;c.beginPath();var j=i[0];c.moveTo(j.x-0.5,j.y-0.5);for(var f=1;f<i.length;f++){var l=i[f];c.lineTo(l.x-0.5,l.y-0.5)}c.lineTo(j.x-0.5,j.y-0.5);c.stroke();c.closePath();c.globalAlpha=0.5;c.beginPath();c.rect((i.x>>0)-0.5,(i.y>>0)-0.5,i.width>>0,i.height>>0);c.stroke();c.closePath()}else i.drawable.domDrawable&&(i.drawable.domDrawable.style.border=
...
0};b.prototype.pause=function(){this.paused=!0};b.prototype.resume=function(){this.paused=!1};b.prototype._run=function(){if(!this.paused){var a=this.info,c=a.currentTime=Date.now();a.deltaTime=a.realDeltaTime=c-a.lastTime;for(var b=0,g=this._listeners.length,e,h;b<g;b++)e=this._listeners[b],h=e.__runTime||0,0==h?e.step(this.info):c>h&&(e.step(this.info),this._listeners.splice(b,1),b--,g--);a.lastTime=c}};b.prototype.delay=function(a,c){this.addListener({step:a,__runTime:Date.now()+c})};b.prototype.addListener=
...
function(){var a=this.width,b=this.height,d=this.getConcatenatedMatrix(),a=this.polyArea||[{x:0,y:0},{x:a,y:0},{x:a,y:b},{x:0,y:b}],b=[],g=a.length,e,h,i,j,f;e=d.transformPoint(a[0],!0,!0);h=i=e.x;j=f=e.y;b[0]=e;for(var l=1;l<g;l++)e=d.transformPoint(a[l],!0,!0),h>e.x?h=e.x:i<e.x&&(i=e.x),j>e.y?j=e.y:f<e.y&&(f=e.y),b[l]=e;b.x=h;b.y=j;b.width=i-h;b.height=f-j;return b};b.prototype.getCurrentWidth=function(){return Math.abs(this.width*this.scaleX)};b.prototype.getCurrentHeight=function(){return Math.abs(this.height*
...
0,d=this._actions.length;b<d;b++){var g=this._actions[b],e=g[0],h=1<g.length?g.slice(1):null;"function"==typeof a[e]?a[e].apply(a,h):a[e]=g[1]}};b.prototype.getDrawable=function(a){null==this.drawable&&this.setDrawable(this.toImage());return this.drawable.get(this,a)};b.prototype.cache=function(a){var b=Quark.createDOM("canvas",{width:this.width,height:this.height});this._draw(b.getContext("2d"));this._cache=b;a&&(this._cache=this.toImage());return this._cache};b.prototype.uncache=function(){this._cache=
...
(function(){aJSs.Video=function(b,a,c,d,g,e){var a="true"==a?!0:!1,d="true"==d?!0:!1,b=b.substr(0,b.lastIndexOf(".")),h=document.createElement("video");h.width=g;h.height=e;try{h.buffered=c}catch(i){}h.autoplay=a;h.controls=d;h.loop=!1;h.preload="none";c=document.createElement("source");h.appendChild(c);h.canPlayType&&(""!=h.canPlayType("video/mp4")?(c.type="video/mp4",c.src=b+".mp4"):""!=h.canPlayType("video/ogg")?(c.type="video/ogg",c.src=b+".ogg"):""!=h.canPlayType("video/webm")?(c.type="video/webm",
...
(function(){aJSs.MaskEffect=function(b){this.transTotal=68;this.maskerFull=0;var a=this,c,d;this.transition=function(a,b,d,c,j){this.maskerFull=0;if(a<=this.transTotal)this["mask"+a](b,d,c,j);else this.transition(68,b,d,c,j)};this.mask1=function(g,e,h,i){function j(){q=e*k*d;n=h*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.setRect([0,0,e,h]),clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=0,q=0,n=
0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask2=function(g,e,h,i){function j(){q=e*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask3=function(g,e,h,i){function j(){n=h*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
f.setRect([0,0,e,h]),clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=0,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask4=function(g,e,h,i){function j(){l=e*(1-k*d);q=e*k*d;f.x=e*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=e,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask5=function(g,e,h,i){function j(){m=
h*(1-k*d);n=h*k*d;f.y=h*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.y=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask6=function(g,e,h,i){function j(){n=e*x*d;f.setRect([m,q,n,p]);k=e*(1-x*d);s=e*x*d;l.x=e*(1-x*d);l.setRect([k,r,s,u]);x++;if(x>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
f.setRect([0,0,e,h]),g.removeChild(l),clearInterval(w),w=null}var f=g.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:f.image,rect:[0,0,0,0]});g.addChild(l);var m=0,q=0,n=0,p=h,k=e,r=0,s=0,u=h;c=i*b;d=1/(2*c);var w=setInterval(j,1E3/b),x=1;j()};this.mask7=function(g,e,h,i){function j(){p=h*x*d;f.setRect([m,q,n,p]);r=h*(1-x*d);u=h*x*d;l.y=h*(1-x*d);l.setRect([k,r,s,u]);x++;if(x>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,
e,h]),g.removeChild(l),clearInterval(w),w=null}var f=g.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:f.image,rect:[0,0,0,0]});g.addChild(l);var m=0,q=0,n=e,p=0,k=0,r=h,s=e,u=0;c=i*b;d=1/(2*c);var w=setInterval(j,1E3/b),x=1;j()};this.mask8=function(g,e,h,i){function j(){l=e/2*(1-k*d);q=e*k*d;f.x=e/2*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,clearInterval(p),p=null}var f=
g.getChildAt(0),l=e/2,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask9=function(g,e,h,i){function j(){m=h/2*(1-k*d);n=h*k*d;f.y=h/2*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.y=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=h/2,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask10=function(g,e,h,i){function j(){for(var b=0;b<m;b++){var i=b*q,j=
q*r*d,l=h;g.getChildById("maskBitmap"+b).setRect([i,0,j,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(f.setRect([0,0,e,h]);1<g.getNumChildren();)g.removeChildAt(g.getNumChildren()-1);clearInterval(k);k=null}}for(var f=g.getChildAt(0),l=f.image,m=16,q=e/m,n=0;n<m;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.x=n*q;g.addChild(p)}c=i*b;d=1/c;var k=setInterval(j,1E3/b),r=1;j()};this.mask11=function(g,e,h,i){function j(){for(var b=
0;b<m;b++){var i=b*q,j=e,l=q*r*d;g.getChildById("maskBitmap"+b).setRect([0,i,j,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(f.setRect([0,0,e,h]);1<g.getNumChildren();)g.removeChildAt(g.getNumChildren()-1);clearInterval(k);k=null}}for(var f=g.getChildAt(0),l=f.image,m=16,q=h/m,n=0;n<m;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.y=n*q;g.addChild(p)}c=i*b;d=1/c;var k=setInterval(j,1E3/b),r=1;j()};this.mask12=
function(g,e,h,i){function j(){for(n=0;n<I;n++)C=k.length,0<C?(K=Math.floor(Math.random()*C),k[K].visible=!0,k.splice(K,1)):n=I;H++;if(H>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,h]);1<g.getNumChildren();)g.removeChildAt(g.getNumChildren()-1);clearInterval(x);x=null}}for(var f=g.getChildAt(0),l=f.image,m=Math.ceil(e/20),q=Math.ceil(h/20),n=0,p=0,k=[],n=0;20>n;n++)for(p=0;20>p;p++){var r=m*n,s=q*p,u=m,w=q;r<e&&s<
h&&(r>e-m&&(u=e-r),s>h-q&&(w=h-s),u=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[r,s,u,w]}),u.x=r,u.y=s,u.visible=!1,g.addChild(u),k.push(u))}c=i*b;d=1/c;var x=setInterval(j,1E3/b),H=1,C=k.length,K,I=Math.round(C/c);1>I&&(I=1);j()};this.mask13=function(g,e,h,i){function j(){l=e/2*(1-k*d);m=h/2*(1-k*d);q=e*k*d;n=h*k*d;f.x=e/2*(1-k*d);f.y=h/2*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),
f.x=0,f.y=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=e/2,m=h/2,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask14=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask15=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask16=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask17=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask18=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask19=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask20=function(a,
b,d,c){this.transition(68,a,b,d,c)};this.mask21=function(g,e,h,i){function j(){l=e*(1-k*d);m=h*(1-k*d);q=e*k*d;n=h*k*d;f.x=e*(1-k*d);f.y=h*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,f.y=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=e,m=h,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask22=function(g,e,h,i){function j(){l=e*(1-k*d);m=0;q=e*k*d;n=h*k*d;f.x=e*(1-k*
d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=e,m=0,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask23=function(g,e,h,i){function j(){l=0;m=h*(1-k*d);q=e*k*d;n=h*k*d;f.y=h*(1-k*d);f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.y=
0,clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=h,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask24=function(g,e,h,i){function j(){r=e/2*v*d;s=h/2*v*d;f.setRect([p,k,r,s]);u=e/2+e/2*(1-v*d);w=0;x=e/2*v*d;H=h/2*v*d;m.x=e/2+e/2*(1-v*d);m.setRect([u,w,x,H]);C=0;K=h/2+h/2*(1-v*d);I=e/2*v*d;M=h/2*v*d;q.y=h/2+h/2*(1-v*d);q.setRect([C,K,I,M]);O=e/2+e/2*(1-v*d);J=h/2+h/2*(1-v*d);B=e/2*v*d;A=h/2*v*d;n.x=e/2+e/2*(1-v*d);n.y=h/2+h/2*(1-v*d);n.setRect([O,J,B,A]);v++;if(v>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(f.setRect([0,0,e,h]);1<g.getNumChildren();)g.removeChildAt(g.getNumChildren()-1);clearInterval(y);y=null}}var f=g.getChildAt(0),l=f.image,m=new Quark.Bitmap({id:"targetBitmap2",image:l,rect:[0,0,0,0]});g.addChild(m);var q=new Quark.Bitmap({id:"targetBitmap3",image:l,rect:[0,0,0,0]});g.addChild(q);var n=new Quark.Bitmap({id:"targetBitmap4",image:l,rect:[0,0,0,0]});g.addChild(n);var p=0,k=0,r=0,s=0,u=e,w=0,x=0,H=0,C=0,K=h,I=0,M=0,O=e,J=h,B=0,A=0;c=i*b;d=1/c;var y=setInterval(j,1E3/b),v=1;j()};this.mask25=
function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask26=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask27=function(g,e,h,i){function j(){for(var b=0;b<m;b++){var i=q*b,j=q;n[b].x>e-q&&(j=e-n[b].x);var l=p[b]+(h-p[b])*x*d*h/(h-p[b]);l<h&&n[b].setRect([i,0,j,l])}x++;if(x>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,h]);1<g.getNumChildren();)g.removeChildAt(g.getNumChildren()-1);clearInterval(w);w=null}}for(var f=
g.getChildAt(0),l=f.image,m=20,q=Math.ceil(e/m),n=[],p=[],k=0;k<m;k++){p[k]=h/2*Math.random();var r=q*k,s=q,u=p[k];r>e-q&&(s=e-r);s=new Quark.Bitmap({id:"maskBitmap"+k,image:l,rect:[r,0,s,u]});s.x=r;g.addChild(s);n.push(s)}c=i*b;d=1/c;var w=setInterval(j,1E3/b),x=1;j()};this.mask28=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask29=function(g,e,h,i){function j(){f.alpha=m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.alpha=
1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.alpha=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask30=function(g,e,h,i){function j(){l=e*(1-k*d);q=e*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=e,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask31=function(g,e,h,i){function j(){f.alpha=
k*d;l=e*(1-k*d);q=e*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,f.alpha=1,clearInterval(p),p=null}var f=g.getChildAt(0);f.alpha=0;var l=e,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask32=function(g,e,h,i){function j(){q=e*k*d;f.setRect([l,m,q,n]);f.x=e*(1-k*d);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,
0,e,h]),f.x=0,clearInterval(p),p=null}var f=g.getChildAt(0);f.x=e;var l=0,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask33=function(g,e,h,i){function j(){f.alpha=k*d;q=e*k*d;f.setRect([l,m,q,n]);f.x=e*(1-k*d);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.x=0,f.alpha=1,clearInterval(p),p=null}var f=g.getChildAt(0);f.x=e;var l=f.alpha=0,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};
this.mask34=function(g,e,h,i){function j(){m=h*(1-k*d);n=h*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.y=0,clearInterval(p),p=null}var f=g.getChildAt(0),l=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask35=function(g,e,h,i){function j(){f.alpha=k*d;m=h*(1-k*d);n=h*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
f.setRect([0,0,e,h]),f.y=0,f.alpha=1,clearInterval(p),p=null}var f=g.getChildAt(0),l=f.alpha=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask36=function(g,e,h,i){function j(){f.y=h*(1-k*d);n=h*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.y=0,clearInterval(p),p=null}var f=g.getChildAt(0);f.y=h;var l=0,m=0,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask37=
function(g,e,h,i){function j(){f.alpha=k*d;f.y=h*(1-k*d);n=h*k*d;f.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),f.setRect([0,0,e,h]),f.y=0,f.alpha=1,clearInterval(p),p=null}var f=g.getChildAt(0);f.alpha=0;f.y=h;var l=0,m=0,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask38=function(g,e,h,i){function j(){f.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.width=e,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.width=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask39=function(g,e,h,i){function j(){f.alpha=m*d;f.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.alpha=0;f.width=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask40=function(g,e,h,
i){function j(){f.x=e/2*(1-m*d);f.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.x=0,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.width=0;f.x=e/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask41=function(g,e,h,i){function j(){f.alpha=m*d;f.x=e/2*(1-m*d);f.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.width=e,f.x=0,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.width=0;f.alpha=0;f.x=e/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask42=function(g,e,h,i){function j(){f.x=e*(1-m*d);f.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.x=0,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.width=0;f.x=e;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};
this.mask43=function(g,e,h,i){function j(){f.alpha=m*d;f.x=e*(1-m*d);f.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.x=0,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.width=0;f.alpha=0;f.x=e;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask44=function(g,e,h,i){function j(){f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.height=h,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.height=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask45=function(g,e,h,i){function j(){f.alpha=m*d;f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=h,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.height=0;f.alpha=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask46=function(g,
e,h,i){function j(){f.y=h/2*(1-m*d);f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=h,f.y=0,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.height=0;f.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask47=function(g,e,h,i){function j(){f.alpha=m*d;f.y=h/2*(1-m*d);f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.height=h,f.y=0,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.height=0;f.alpha=0;f.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask48=function(g,e,h,i){function j(){f.y=h*(1-m*d);f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=h,f.y=0,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.height=0;f.y=h;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;
j()};this.mask49=function(g,e,h,i){function j(){f.alpha=m*d;f.y=h*(1-m*d);f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.height=h,f.y=0,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.height=0;f.alpha=0;f.y=h;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask50=function(g,e,h,i){function j(){f.x=e/2*(1-m*d);f.y=h/2*(1-m*d);f.width=e*m*d;f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
f.width=e,f.height=h,f.x=0,f.y=0,clearInterval(l),l=null}var f=g.getChildAt(0);f.setRect([0,0,e,h]);f.width=0;f.height=0;f.x=e/2;f.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask51=function(g,e,h,i){function j(){f.alpha=m*d;f.x=e/2*(1-m*d);f.y=h/2*(1-m*d);f.width=e*m*d;f.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),f.width=e,f.height=h,f.x=0,f.y=0,f.alpha=1,clearInterval(l),l=null}var f=g.getChildAt(0);
f.setRect([0,0,e,h]);f.width=0;f.height=0;f.alpha=0;f.x=e/2;f.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask52=function(a,b,d){a.getChildAt(0).setRect([0,0,b,d]);aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER})};this.mask53=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask54=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask55=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask56=function(a,b,d,c){this.transition(68,a,b,d,c)};
...
a,b,d,c)};this.mask66=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask67=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask68=function(g,e,h,i){function j(){for(n=0;n<v;n++)k[n].width=x[n]*y*d,k[n].height=H[n]*y*d,k[n].x=u[n]+(r[n]-u[n])*y*d,k[n].y=w[n]+(s[n]-w[n])*y*d;y++;if(y>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(f.setRect([0,0,e,h]);1<g.getNumChildren();)g.removeChildAt(g.getNumChildren()-1);clearInterval(A);
A=null}}for(var f=g.getChildAt(0),l=f.image,m=Math.ceil(e/12),q=Math.ceil(h/12),n=0,p=0,k=[],r=[],s=[],u=[],w=[],x=[],H=[],n=0;12>n;n++)for(p=0;12>p;p++){var C=m*n,K=q*p,I=m,M=q,O=Math.random()*(e-m),J=Math.random()*(h-q);if(C<e&&K<h){C>e-m&&(I=e-C);K>h-q&&(M=h-K);var B=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[C,K,I,M]});B.x=O;B.y=J;B.width=0;B.height=0;g.addChild(B);k.push(B);r.push(C);s.push(K);x.push(I);H.push(M);u.push(O);w.push(J)}}c=i*b;d=1/c;var A=setInterval(j,1E3/b),y=1,v=k.length;
j()}}})();
...
document.implementation.createDocument("","",null)}catch(e){alert(e.message)}}try{d.async=!1,d.load(b),c(d)}catch(h){try{var i=new window.XMLHttpRequest;i.open("GET",b,!1);i.send(null);d=i.responseXML;c(d)}catch(j){d=(new DOMParser).parseFromString(window.anvsoftJavaScriptSlideshowData,"text/xml"),c(d)}}}})();
(function(){aJSs.JsCompatibleTheme=function(b,a,c){function d(){p--;0>=p&&(clearInterval(r),k++,k>n-1&&(k=0),u.src=c+e[k])}var g=b.movieBackgroundColor,e=b.photoArray,h=b.photoUrlArray,i=b.photoTimeArray,j=b.transitionTimeArray,f=b.URLTarget,l=b.topPadding,m=b.bottomPadding,q=b.leftPadding,b=b.rightPadding,n=e.length,p=0,k=0,r=null,s=document.getElementById(a);s.style.backgroundColor=g;var a=s.offsetWidth,g=s.offsetHeight,q=a-q-b,l=g-l-m,m=Math.round((a-q)/2),b=Math.round((g-l)/2),u=new Image;s.appendChild(u);
u.style.position="absolute";u.style.width=q+"px";u.style.height=l+"px";u.style.left=m+"px";u.style.top=b+"px";u.src=c+e[k];u.onload=function(){p=parseInt(j[k])+parseInt(i[k]);r=setInterval(d,1E3)};u.onclick=function(){var a;switch(f[k]){case "0":a="_blank";break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(h[k],a)};var w=document.createElement("div");s.appendChild(w);w.style.position="absolute";w.style.width="250px";w.style.padding="8px";
w.style.backgroundColor="#333";w.style.color="#FFF";w.style.textAlign="left";w.style.font="normal normal 12px/16px verdana,tahoma,arial,sans-serif";w.innerHTML="The browser you are using does not support HTML5. Now you are using the simple compatible mode. To get better user experience, please use HTML5 supported browser.";w.style.left=Math.round((a-w.offsetWidth)/2)+"px";w.style.top=Math.round((g-w.offsetHeight)/2)+"px";var x=setTimeout(function(){clearTimeout(x);x=null;s.removeChild(w)},1E4)}})();
(function(){aJSs.JsBackground=function(b,a){var c=b.movieBackgroundColor,d=new Quark.DisplayObjectContainer({id:"backgroundBox"});d.autoSize=!0;a.addChild(d);if(""!=c){var g=Quark.Bitmap,e=a.width,h=a.height,i=document.createElement("canvas");i.width=e;i.height=h;var j=i.getContext("2d");j.fillStyle=c;j.rect(0,0,e,h);j.fill();c=new Image;c.src=i.toDataURL("image/png");c.width=e;c.height=h;g=new g({id:"background",image:c});g.autoSize=!0;d.addChild(g)}}})();
(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});if(""!=x){e();var a=new Image;a.src=c+x;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=s+(M-a.width)/2;a.y=k+(O-a.height)/2;N.addChild(a)}y=A=0;Y&&Y.removeAllChildren();E.swapChildren(W,X);E.getChildIndex(W)>E.getChildIndex(X)?
(Z=W,Y=X):(Z=X,Y=W);var b=new Image;b.onload=function(){e();A=1;b.width=V;b.height=T;var a=new Quark.Bitmap({id:"targetBitmap",image:b,rect:[0,0,0.0010,0.0010]});a.useHandCursor="true"==f&&""!=j[t]?!0:!1;Z.addChild(a);L=0==q[t]?null==n?Math.floor(Math.random()*P.transTotal)+1:n[Math.floor(Math.random()*n.length)]:q[t];P.transition(L,Z,V,T,p[t]);a.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==f&&""!=j[t]){switch(l[t]){case "0":a="_blank";break;case "1":a="_parent";break;
case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(j[t],a)}}else"mousemove"==a.type||"touchmove"==a.type?aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OVER}):("mouseout"==a.type||"touchout"==a.type)&&aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OUT})};aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_LOAD_COMPLETE,index:t})};b.src=c+i[t];aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_CURRENT,
index:t});t>=R-1&&"false"==C&&"false"==w&&J.Pause()}function g(){D--;try{Quark.getDOM("debugInfo").value=D}catch(a){}if(0>=D||1==v)clearInterval(z),z=null,0==v?"true"==w?t=Math.floor(Math.random()*R):t<R-1?t++:t=0:v=0,d()}function e(){if(""!=x){var a=N.getChildById("preloader");null!=a&&N.removeChild(a)}}var h=b.frameRate,i=b.photoArray,j=b.photoUrlArray,f=b.enableURL,l=b.URLTarget,m=b.photoTimeArray,q=b.transitionArray,n=b.defineTransitionArray,p=b.transitionTimeArray,k=b.topPadding,r=b.bottomPadding,
s=b.leftPadding,u=b.rightPadding,w=b.randomPlayingPhotos,x=b.loadStyle,H=b.startAutoPlay,C=b.continuum,K=b.videoAutoPlay,I=b.videoArray,M=a.width-s-u,O=a.height-k-r,J=this,B=0,A=1,y=1,v=0,L=0,D=0,t=0,z=null,R=i.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){y=1;if(1==B||1==v)D=m[t]*h,z=setInterval(g,1E3/h);""!=I[t]&&void 0!=I[t]&&0==v&&("true"==K&&(clearInterval(z),z=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,
index:t,width:M,height:O}))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){J.Play()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){J.Pause()});var P=new aJSs.MaskEffect(h),N=new Quark.DisplayObjectContainer({id:"container"});N.autoSize=!0;a.addChild(N);var V=a.width-s-u,T=a.height-k-r,b=s,a=k,r=Quark.Bitmap,u=V,U=T,S="#DDD",G=document.createElement("canvas");G.width=u;G.height=U;var F=G.getContext("2d");F.fillStyle=
S;F.rect(0,0,u,U);F.fill();S=new Image;S.src=G.toDataURL("image/png");S.width=u;S.height=U;r=new r({id:"photoBoxBg",image:S});r.autoSize=!0;r.x=b;r.y=a;N.addChild(r);var E=new Quark.DisplayObjectContainer({id:"photoBox",x:b,y:a,width:V,height:T});E.autoSize=!0;N.addChild(E);var Y,Z,W=new Quark.DisplayObjectContainer({id:"aPhoto"}),X=new Quark.DisplayObjectContainer({id:"bPhoto"});E.addChild(W);E.addChild(X);this.Play=function(){B=1;1==A&&1==y?(clearInterval(z),z=null,t<R-1?t++:t=0,d()):1==A&&0==y?
(v=1,t<R-1?t++:t=0,P.maskerFull=1):(t<R-1?t++:t=0,v=1)};this.Pause=function(){B=0;null!=z&&(clearInterval(z),z=null)};this.Previous=function(a){B=a;0<t?t--:t=R-1;1==A&&1==y?(clearInterval(z),z=null,d()):1==A&&0==y?(v=1,P.maskerFull=1):v=1};this.Next=function(a){B=a;t<R-1?t++:t=0;1==A&&1==y?(clearInterval(z),z=null,d()):1==A&&0==y?(v=1,P.maskerFull=1):v=1};this.Show=function(a,b){B=b;1==A&&1==y?(clearInterval(z),z=null,t=a,d()):1==A&&0==y?(v=1,t=a,P.maskerFull=1):(t=a,v=1)};"true"==H?this.Show(0,1):
this.Show(0,0)}})();
(function(){aJSs.JsMediaConsole=function(b,a,c,d){function g(){void 0!=r&&(b.removeChild(r),void 0!=k&&"videoCallPause"==s&&(k.Play(),s=""),r=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var h=a.topPadding,i=a.leftPadding,c=a.musicPath,j=a.musicAutoPlay,f=a.musicLoop,l=a.musicStream,m=a.videoAutoPlay,q=a.bufferTime,n=a.videoArray,p=a.videoControls;if(""!=c)var k=new aJSs.Music(d+c,l,j,f);var r,s="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,function(a){var c=
a.index,e=a.width,a=a.height;void 0!=k&&k.Playing()&&(k.Pause(),s="videoCallPause");r=new aJSs.Video(d+n[c],m,q,p,e,a);r.style.backgroundColor="#000";r.style.position="absolute";r.style.top=h+"px";r.style.left=i+"px";b.appendChild(r);c=document.getElementById("videoLoadText");null==c&&(c=document.createElement("div"),c.id="videoLoadText",c.style.position="absolute",c.style.top=h+5+"px",c.style.left=i+5+"px",c.style.font="normal normal 11px/13px verdana,tahoma,arial,sans-serif",c.style.color="#FFF",
...
(function(){aJSs.JsMenu=function(b,a){var c=b.topPadding,d=b.leftPadding,g=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=g&&"anvsoftUSSTheme"!=g&&"anvsoftHSMTheme"!=g){var e,h;switch(g){case "anvsoftPFMTheme":h="Powered by photo-flash-maker.com";e=186;break;case "anvsoftUSSTheme":h="Powered by ultraslideshow.com";e=168;break;case "anvsoftHSMTheme":h="Powered by html5-slideshow-maker.com";e=210;break;case "anvsoftSWWTheme":h="Powered by slidewow.com";e=142;break;default:h="Powered by anvsoft.com",
e=136}var i=new Quark.DisplayObjectContainer({id:"menudBox"});i.autoSize=!0;i.x=d;i.y=c;a.addChild(i);var c=Quark.Bitmap,d=e,j="#000",f=document.createElement("canvas");f.width=d;f.height=20;var l=f.getContext("2d");l.fillStyle=j;l.rect(0,0,d,20);l.fill();j=new Image;j.src=f.toDataURL("image/png");j.width=d;j.height=20;c=new c({id:"copyrightBg",image:j});c.autoSize=!0;c.alpha=0.3;i.addChild(c);c=Quark.Bitmap;d=e;j="#FFF";f=h;h=document.createElement("canvas");h.width=d;h.height=20;d=h.getContext("2d");
d.font="11px arial, sans-serif";d.textAlign="start";d.textBaseline="middle";d.fillStyle=j;d.fillText(f,0,10);d=f=d.measureText(f).width;j=new Image;j.src=h.toDataURL("image/png");j.width=d;j.height=20;h=new c({id:"copyrightText",image:j});h.useHandCursor=!0;h.autoSize=!0;h.x=Math.round((e-f)/2);i.addChild(h);h.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type)switch(g){case "anvsoftPFMTheme":window.open("http://www.photo-flash-maker.com/","_self");break;case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/",
...
(function(b){var a=aJSs.getParameters.parameters().xml_path,c=aJSs.getParameters.parameters().fs_path,d,g;void 0==a?void 0==c?(d="slides.xml",g=""):(d=c+"/slides.xml",g=c+"/"):(d=a,g=a.substr(0,a.lastIndexOf("/")+1));anvsoftJavaScriptSlideshow.init=function(a){var c,i;if(b.document.createElement("canvas").getContext){var a=Quark.getDOM(a),j=Quark.supportTouch?["touchstart","touchmove","touchend","touchout"]:["mousedown","mousemove","mouseup","mouseout"],f=Quark.getUrlParams();void 0==f.mode&&(f.mode=
1);var l=a.clientWidth||a.offsetWidth,m=a.clientHeight||a.offsetHeight;1==f.mode?(c=Quark.createDOM("canvas",{width:l,height:m}),a.appendChild(c),i=new Quark.CanvasContext({canvas:c})):i=new Quark.DOMContext({canvas:a});c=new Quark.Stage({width:l,height:m,context:i});(new Q.EventManager).registerStage(c,j);i=new aJSs.JsXmlLoad(d);j=new aJSs.JsPhoto(i,c,g);f=new aJSs.JsMediaConsole(a,i,c,g);new aJSs.JsMenu(i,c);l=new Q.Timer(1E3/i.frameRate);l.addListener(c);l.start();i=new aJSs.JsInterface(a,i,j,
f,g);new aJSsTemplate.Main(i)}else c=new aJSs.JsXmlLoad(d),new aJSs.JsCompatibleTheme(c,a,g)}})(window);

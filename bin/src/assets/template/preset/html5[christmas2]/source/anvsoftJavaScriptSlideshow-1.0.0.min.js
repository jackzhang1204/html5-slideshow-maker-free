...
b.transitionTimeArray;this.defineTransitionArray=b.defineTransitionArray;this.photoTitleArray=b.photoTitleArray;this.descriptionText=b.descriptionText;this.photoCount=this.photoArray.length;this.Play=function(){b.Play()};this.Pause=function(){b.Pause()};this.Previous=function(){b.Previous()};this.Next=function(){b.Next()};this.Show=function(a,c){b.Show(a,c)};this.MusicPlay=function(){b.MusicPlay()};this.MusicPause=function(){b.MusicPause()}}})();(function(){aJSsTemplate.ColorConverter={hexToRGB:function(b){var a,c,d;if(/rgb/.test(b))b=b.match(/\d+/g),a=parseInt(b[0]),c=parseInt(b[1]),d=parseInt(b[2]);else if(/#/.test(b)){var f=b.length;7===f?(a=parseInt(b.slice(1,3),16),c=parseInt(b.slice(3,5),16),d=parseInt(b.slice(5),16)):4===f&&(a=parseInt(b.charAt(1)+b.charAt(1),16),c=parseInt(b.charAt(2)+b.charAt(2),16),d=parseInt(b.charAt(3)+b.charAt(3),16))}else return b;return{r:a,g:c,b:d}}}})();(function(){aJSsTemplate.JsBackground=function(b,a){var c=b.globalPath,d=b.movieWidth,f=b.movieHeight,e=b.topPadding,h=b.bottomPadding,j=b.leftPadding,i=b.rightPadding,g=new Image;a.appendChild(g);g.style.position="absolute";g.style.top="0px";g.style.left="0px";g.style.width=d+"px";g.style.height=f+"px";g.style.backgroundColor="#000000";g.style.zIndex="-1";g=new Image;a.appendChild(g);g.style.position="absolute";g.style.top=e-20+"px";g.style.left=j-20+"px";g.style.width=d-j-i+40+"px";g.style.height=
f-e-h+40+"px";g.src=c+"res/paper.jpg";g.style.zIndex="-1"}})();(function(){aJSsTemplate.JsDecorate=function(b,a){var c=b.globalPath,d=b.movieWidth,f=b.movieHeight,e=b.topPadding,h=b.bottomPadding,j=b.leftPadding,i=b.rightPadding,g=new Image;a.appendChild(g);g.style.position="absolute";g.style.top=e-20-57+"px";g.style.left=j-20-42+"px";g.style.width="218px";g.style.height="130px";g.src=c+"res/father.gif";e=new Image;a.appendChild(e);e.style.position="absolute";e.style.top="80px";e.style.left=d-235+"px";e.style.width="234px";e.style.height="483px";e.src=c+"res/tree.gif";
e=new Image;a.appendChild(e);e.style.position="absolute";e.style.top=f-209+"px";e.style.left=d-168+"px";e.style.width="168px";e.style.height="209px";e.src=c+"res/ball.gif";for(e=0;5>e;e++)g=new Image,g.style.position="absolute",g.style.top=f-h+"px",g.style.left=j+((d-j-i-500)/4+100)*e+"px",g.style.width="100px",g.style.height="165px",g.src=c+"res/thumbnail.png",a.appendChild(g)}})();(function(){aJSsTemplate.JsText=function(b,a){function c(a){a=a.index;""!=n[a]?(F.style.display="true"!==q?"block":"none",F.textContent=n[a]):F.style.display="none"}function d(){"true"==q&&(F.style.display="none",G.style.cursor="pointer",a.addEventListener("mouseover",e),a.addEventListener("mouseout",h))}function f(a){a=a.index;""!=N[a]?(E.style.display="block",E.innerHTML=N[a]):E.style.display="none"}function e(){F.style.display="block"}function h(){F.style.display="none"}var j=b.movieWidth,i=b.topPadding,
g=b.leftPadding,l=b.rightPadding,m=b.showTitle,q=b.photoTitleAutoHide,n=b.photoTitleArray,p=b.photoTitleAlpha,k=b.photoTitleColor,r=b.titleTextAlign,t=b.titleTextFont,v=b.titleTextSize,w=b.titleTextShadowColor,x=b.titleTextShadowOffset,K=b.titleTextShadowBlur,C=b.textResize,A=b.textTransform,L=b.textTransformOriginX,M=b.textTransformOriginY,P=b.titleTransform,I=b.titleTransformOriginX,J=b.titleTransformOriginY,B=aJSsTemplate.ColorConverter.hexToRGB(b.photoTitleBackgroundColor),y=b.enableDes,u=b.desLineHeight,
N=b.descriptionText,D=b.desTextFont,s=b.desTextSize,z=b.desTextColor,H=b.desTextAlign,S=b.desTextShadowColor,O=b.desTextShadowOffset,R=b.desTextShadowBlur,U=b.desTransform,V=b.desTransformOriginX,T=b.desTransformOriginY,G=document.createElement("div");a.appendChild(G);G.style.position="absolute";G.style.top=i+"px";G.style.display="block";G.style.width=j-g-l-60+"px";G.style.backgroundColor="rgba("+B.r+","+B.g+","+B.b+","+p+")";G.style.backgroundRepeat="repeat";G.style.marginLeft=g+30+"px";G.style.marginRight=
l+30+"px";G.style.borderRadius="0px 0px 10px 10px";G.style.webkitTransform="rotate("+A+"deg)";G.style.msTransform="rotate("+A+"deg)";G.style.MozTransform="rotate("+A+"deg)";G.style.OTransform="rotate("+A+"deg)";G.style.transform="rotate("+A+"deg)";G.style.transformOrigin=""+M+"px "+L+"px";G.style.webkitTransformOrigin=""+M+"px "+L+"px";G.style.MozTransformOrigin=""+M+"px "+L+"px";G.style.OTransformOrigin=""+M+"px "+L+"px";G.style.resize=""+C+"";G.style.overflow="auto";if("true"==m){var F=document.createElement("div");
G.appendChild(F);F.textContent=n[0];F.style.webkitTransform="rotate("+P+"deg)";F.style.msTransform="rotate("+P+"deg)";F.style.MozTransform="rotate("+P+"deg)";F.style.OTransform="rotate("+P+"deg)";F.style.transform="rotate("+P+"deg)";F.style.transformOrigin=""+J+"px "+I+"px";F.style.webkitTransformOrigin=""+J+"px "+I+"px";F.style.MozTransformOrigin=""+J+"px "+I+"px";F.style.OTransformOrigin=""+J+"px "+I+"px";F.style.color=k;F.style.textAlign=r;F.style.fontFamily=t;F.style.fontSize=v+"px";F.style.textTransform=
"uppercase";F.style.padding="12px 12px 12px 12px";F.style.fontWeight="bold";F.style.textShadow=x+"px "+x+"px "+K+"px "+w;b.commandDispatcher.addEventListener("photoLoadComplete",c);b.commandDispatcher.addEventListener("photoLoadComplete",d)}if("true"==y){var E=document.createElement("div");G.appendChild(E);E.innerHTML=N[0];E.style.webkitTransform="rotate("+U+"deg)";E.style.msTransform="rotate("+U+"deg)";E.style.MozTransform="rotate("+U+"deg)";E.style.OTransform="rotate("+U+"deg)";E.style.transform=
"rotate("+U+"deg)";E.style.transformOrigin=""+T+"px "+V+"px";E.style.webkitTransformOrigin=""+T+"px "+V+"px";E.style.MozTransformOrigin=""+T+"px "+V+"px";E.style.OTransformOrigin=""+T+"px "+V+"px";E.style.textAlign=H;E.style.fontSize=s+"px";E.style.color=z;E.style.padding="12px 12px 12px 12px";E.style.fontFamily=D;E.style.lineHeight=u+"px";E.style.textTransform="none";E.style.textShadow=O+"px "+O+"px "+R+"px "+S;b.commandDispatcher.addEventListener("photoLoadComplete",f)}}})();(function(){aJSsTemplate.JsThumbnail=function(b,a){function c(){z.scrollLeft-=M+I}function d(){z.scrollLeft+=M+I}globalPath=b.globalPath;var f=Number(b.movieWidth),e=Number(b.movieHeight),h=Number(b.topPadding),j=Number(b.bottomPadding),i=Number(b.leftPadding),g=Number(b.rightPadding),l=b.startAutoPlay,m=b.continuum,q=b.clickToAutoPlay,n=b.musicPath,p=b.musicAutoPlay,k=b.photoArray,r=b.thumbnailArray,t=b.thumWidth,v=b.thumHeight,w=b.thumbnailBorderColor,x=b.currentBorderColor,K=b.thumborder,C=b.thumSpacing,
A=0;aJSsTemplate.ColorConverter.hexToRGB(b.thumBoxColor);var L=v+2*K,M=f-i-g,P=0,I=0;parseInt((M+C)/(t+2*K+C));var J=I=0,C=document.createElement("div");a.appendChild(C);C.id="thumBody";C.style.position="absolute";C.style.top=e-j+127-L/2+"px";C.style.left=i+50-(t+2*K)/2+"px";C.style.width=f-i-g+"px";C.style.height=L+"px";C.style.margin="0px auto";C.style.borderRadius="5px 5px 5px 5px";C.style.display="block";var B=document.createElement("div");a.appendChild(B);B.style.position="absolute";B.style.background=
"url("+globalPath+"res/thumleft1.png)";B.style.top=e-j+20+"px";B.style.left=i-20-15.5+"px";B.style.width="31px";B.style.height="80px";var y=document.createElement("div");a.appendChild(y);y.style.position="absolute";y.style.background="url("+globalPath+"res/thumright1.png)";y.style.top=e-j+20+"px";y.style.left=f-g+20-15.5+"px";y.style.width="31px";y.style.height="80px";var u=document.createElement("div");a.appendChild(u);u.style.position="absolute";u.style.cursor="pointer";u.style.display="none";u.style.background=
"url("+globalPath+"res/prev1.png)";u.style.top=h+(e-h-j)/2-8+"px";u.style.left=i-35+"px";u.style.width="70px";u.style.height="16px";var N=document.createElement("div");a.appendChild(N);N.style.position="absolute";N.style.cursor="pointer";N.style.display="none";N.style.top=h+(e-h-j)/2-8+"px";N.style.left=i+(f-i-g)-35+"px";N.style.background="url("+globalPath+"res/next1.png)";N.style.width="70px";N.style.height="16px";var D=document.createElement("div");a.appendChild(D);D.style.position="absolute";
D.style.backgroundImage="url("+globalPath+"res/play2.png)";D.style.top=e-j-(e-h-j)/2-(v+2*K+10)/2+"px";D.style.left=i+(f-i-g)/2-25+"px";D.style.width="50px";D.style.height="50px";D.style.display="block";D.style.cursor="pointer";var s=document.createElement("div");a.appendChild(s);s.style.position="absolute";s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)";s.style.top="0px";s.style.left=f-75-95+"px";s.style.width="150px";s.style.height="95px";s.style.display="block";s.style.cursor="pointer";
var z=document.createElement("div");C.appendChild(z);z.id="showThumbnails";z.style.position="absolute";z.style.top=(v+2*K)/2-(v+2*K)/2+"px";z.style.width=M+"px";z.style.height=v+2*K+"px";z.style.overflow="hidden";e=document.createElement("div");z.appendChild(e);e.id="showArea";I=(f-i-g-500)/4;for(f=0;f<b.photoCount;f++){var H=new Image;H.style.position="absolute";H.style.left=(I+100)*f+"px";H.style.width=t+"px";H.style.height=v+"px";H.style.cursor="pointer";H.style.borderWidth=K+"px";H.style.borderStyle=
"solid";H.style.borderColor=w;H.style.marginRight=I+"px";H.src=globalPath+r[f];H.alt=k[f];H.index=f;P=(M+I)*Math.ceil(b.photoCount/5)-I;e.appendChild(H)}H.style.marginRight="0px";e.style.width=P+"px";e.style.height=v+2*K+"px";var S=P;B.style.cursor="pointer";y.style.cursor="pointer";B.onmouseover=function(){B.style.background="url("+globalPath+"res/thumleft2.png)"};B.onmouseout=function(){B.style.background="url("+globalPath+"res/thumleft1.png)"};B.onclick=function(){0==z.scrollLeft?z.scrollLeft=
S:setTimeout(c,0)};y.onmouseover=function(){y.style.background="url("+globalPath+"res/thumright2.png)"};y.onmouseout=function(){y.style.background="url("+globalPath+"res/thumright1.png)"};y.onclick=function(){z.scrollLeft==S-M?z.scrollLeft=0:setTimeout(d,0)};u.onmouseover=function(){this.style.background="url("+globalPath+"res/prev2.png)"};u.onmouseout=function(){this.style.background="url("+globalPath+"res/prev1.png)"};u.onclick=function(){"true"==q?(0<A?b.Show(A-1,1):(b.Show(b.photoCount-1,1),A=
0),D.style.display="none"):(b.Previous(),D.style.display="block")};N.onmouseover=function(){this.style.background="url("+globalPath+"res/next2.png)"};N.onmouseout=function(){this.style.background="url("+globalPath+"res/next1.png)"};N.onclick=function(){"true"==q?(A<b.photoCount-1?b.Show(A+1,1):(b.Show(0,1),A=0),D.style.display="none"):(b.Next(),D.style.display="block")};a.addEventListener("mouseover",function(){N.style.display="block";u.style.display="block"});a.addEventListener("mouseout",function(){N.style.display=
"none";u.style.display="none"});var O=e.getElementsByTagName("img");O[0].style.borderColor=x;for(f=0;f<b.photoCount;f++)O[f].onmouseover=function(){this.style.borderColor=x},O[f].onclick=function(){for(var a=0;a<b.photoCount;a++)O[a].style.borderColor=w;O[this.index].style.borderColor=x;A=this.index;"true"==q?(b.Show(A,1),D.style.display="none"):(b.Show(A,0),D.style.display="block")},O[f].onmouseout=function(){A!==this.index&&(this.style.borderColor=w)};b.commandDispatcher.addEventListener("photoLoadComplete",
function(a){for(var c=0;c<b.photoCount;c++)O[c].style.borderColor=w;O[a.index].style.borderColor=x;A=a.index;A>=b.photoCount-1&&("false"==m&&"false"==b.randomPlayingPhotos)&&(D.style.display="block");J=parseInt(A/5);z.scrollLeft=(M+I)*J});D.style.display="true"==l?"none":"block";D.style.cursor="pointer";D.onmouseover=function(){D.style.backgroundImage="url("+globalPath+"res/play1.png)"};D.onmouseout=function(){D.style.backgroundImage="url("+globalPath+"res/play2.png)"};D.onclick=function(){b.Play();
D.style.display="none"};var R=0;""==n?s.style.display="none":"true"==p?(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",s.onclick=function(){0==R?(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),R=1):(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),R=0)}):(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",s.onclick=function(){0==R?(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),R=1):
(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),R=0)});b.commandDispatcher.addEventListener("soundPlayComplete",function(){s.style.backgroundImage="url("+globalPath+"res/musicStop.png)";R=1});b.commandDispatcher.addEventListener("videoPlayEnded",function(){D.style.display="none"})}})();(function(){aJSsTemplate.JsMenu=function(b,a){var c=b.movieWidth,d=b.movieHeight,f=b.bottomPadding,e=b.rightPadding,h=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=h&&"anvsoftUSSTheme"!=h&&"anvsoftHSMTheme"!=h){var j;switch(h){case "anvsoftPFMTheme":j="Photo Slideshow Maker";break;case "anvsoftUSSTheme":j="Ultra Slideshow";break;case "anvsoftHSMTheme":j="HTML5 Slideshow Maker";break;case "anvsoftSWWTheme":j="SlideWow";break;default:j="Anvsoft Photo Slideshow"}var i=document.createElement("div");
...
h*(1-k*d);n=h*k*d;g.y=h*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=e,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),k=1;i()};this.mask6=function(f,e,h,j){function i(){n=e*x*d;g.setRect([m,q,n,p]);k=e*(1-x*d);t=e*x*d;l.x=e*(1-x*d);l.setRect([k,r,t,v]);x++;if(x>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),f.removeChild(l),clearInterval(w),w=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,q=0,n=0,p=h,k=e,r=0,t=0,v=h;c=j*b;d=1/(2*c);var w=setInterval(i,1E3/b),x=1;i()};this.mask7=function(f,e,h,j){function i(){p=h*x*d;g.setRect([m,q,n,p]);r=h*(1-x*d);v=h*x*d;l.y=h*(1-x*d);l.setRect([k,r,t,v]);x++;if(x>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,
e,h]),f.removeChild(l),clearInterval(w),w=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,q=0,n=e,p=0,k=0,r=h,t=e,v=0;c=j*b;d=1/(2*c);var w=setInterval(i,1E3/b),x=1;i()};this.mask8=function(f,e,h,j){function i(){l=e/2*(1-k*d);q=e*k*d;g.x=e/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=
...
q*r*d,l=h;f.getChildById("maskBitmap"+b).setRect([j,0,i,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(k);k=null}}for(var g=f.getChildAt(0),l=g.image,m=16,q=e/m,n=0;n<m;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.x=n*q;f.addChild(p)}c=j*b;d=1/c;var k=setInterval(i,1E3/b),r=1;i()};this.mask11=function(f,e,h,j){function i(){for(var b=
0;b<m;b++){var j=b*q,i=e,l=q*r*d;f.getChildById("maskBitmap"+b).setRect([0,j,i,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(k);k=null}}for(var g=f.getChildAt(0),l=g.image,m=16,q=h/m,n=0;n<m;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.y=n*q;f.addChild(p)}c=j*b;d=1/c;var k=setInterval(i,1E3/b),r=1;i()};this.mask12=
function(f,e,h,j){function i(){for(n=0;n<L;n++)C=k.length,0<C?(A=Math.floor(Math.random()*C),k[A].visible=!0,k.splice(A,1)):n=L;K++;if(K>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(x);x=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/20),q=Math.ceil(h/20),n=0,p=0,k=[],n=0;20>n;n++)for(p=0;20>p;p++){var r=m*n,t=q*p,v=m,w=q;r<e&&t<
h&&(r>e-m&&(v=e-r),t>h-q&&(w=h-t),v=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[r,t,v,w]}),v.x=r,v.y=t,v.visible=!1,f.addChild(v),k.push(v))}c=j*b;d=1/c;var x=setInterval(i,1E3/b),K=1,C=k.length,A,L=Math.round(C/c);1>L&&(L=1);i()};this.mask13=function(f,e,h,j){function i(){l=e/2*(1-k*d);m=h/2*(1-k*d);q=e*k*d;n=h*k*d;g.x=e/2*(1-k*d);g.y=h/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),
...
0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=0,n=0;c=j*b;d=1/c;var p=setInterval(i,1E3/b),k=1;i()};this.mask24=function(f,e,h,j){function i(){r=e/2*u*d;t=h/2*u*d;g.setRect([p,k,r,t]);v=e/2+e/2*(1-u*d);w=0;x=e/2*u*d;K=h/2*u*d;m.x=e/2+e/2*(1-u*d);m.setRect([v,w,x,K]);C=0;A=h/2+h/2*(1-u*d);L=e/2*u*d;M=h/2*u*d;q.y=h/2+h/2*(1-u*d);q.setRect([C,A,L,M]);P=e/2+e/2*(1-u*d);I=h/2+h/2*(1-u*d);J=e/2*u*d;B=h/2*u*d;n.x=e/2+e/2*(1-u*d);n.y=h/2+h/2*(1-u*d);n.setRect([P,I,J,B]);u++;if(u>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(y);y=null}}var g=f.getChildAt(0),l=g.image,m=new Quark.Bitmap({id:"targetBitmap2",image:l,rect:[0,0,0,0]});f.addChild(m);var q=new Quark.Bitmap({id:"targetBitmap3",image:l,rect:[0,0,0,0]});f.addChild(q);var n=new Quark.Bitmap({id:"targetBitmap4",image:l,rect:[0,0,0,0]});f.addChild(n);var p=0,k=0,r=0,t=0,v=e,w=0,x=0,K=0,C=0,A=h,L=0,M=0,P=e,I=h,J=0,B=0;c=j*b;d=1/c;var y=setInterval(i,1E3/b),u=1;i()};this.mask25=
function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask26=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask27=function(f,e,h,j){function i(){for(var b=0;b<m;b++){var j=q*b,i=q;n[b].x>e-q&&(i=e-n[b].x);var l=p[b]+(h-p[b])*x*d*h/(h-p[b]);l<h&&n[b].setRect([j,0,i,l])}x++;if(x>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(w);w=null}}for(var g=
f.getChildAt(0),l=g.image,m=20,q=Math.ceil(e/m),n=[],p=[],k=0;k<m;k++){p[k]=h/2*Math.random();var r=q*k,t=q,v=p[k];r>e-q&&(t=e-r);t=new Quark.Bitmap({id:"maskBitmap"+k,image:l,rect:[r,0,t,v]});t.x=r;f.addChild(t);n.push(t)}c=j*b;d=1/c;var w=setInterval(i,1E3/b),x=1;i()};this.mask28=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask29=function(f,e,h,j){function i(){g.alpha=m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.alpha=
...
a,b,d,c)};this.mask66=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask67=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask68=function(f,e,h,j){function i(){for(n=0;n<u;n++)k[n].width=x[n]*y*d,k[n].height=K[n]*y*d,k[n].x=v[n]+(r[n]-v[n])*y*d,k[n].y=w[n]+(t[n]-w[n])*y*d;y++;if(y>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(B);
B=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/12),q=Math.ceil(h/12),n=0,p=0,k=[],r=[],t=[],v=[],w=[],x=[],K=[],n=0;12>n;n++)for(p=0;12>p;p++){var C=m*n,A=q*p,L=m,M=q,P=Math.random()*(e-m),I=Math.random()*(h-q);if(C<e&&A<h){C>e-m&&(L=e-C);A>h-q&&(M=h-A);var J=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[C,A,L,M]});J.x=P;J.y=I;J.width=0;J.height=0;f.addChild(J);k.push(J);r.push(C);t.push(A);x.push(L);K.push(M);v.push(P);w.push(I)}}c=j*b;d=1/c;var B=setInterval(i,1E3/b),y=1,u=k.length;
i()}}})();
...
(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});if(""!=x){e();var a=new Image;a.src=c+x;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=t+(M-a.width)/2;a.y=k+(P-a.height)/2;O.addChild(a)}y=B=0;Y&&Y.removeAllChildren();E.swapChildren(W,X);E.getChildIndex(W)>E.getChildIndex(X)?
(Z=W,Y=X):(Z=X,Y=W);var b=new Image;b.onload=function(){e();B=1;b.width=R;b.height=U;var a=new Quark.Bitmap({id:"targetBitmap",image:b,rect:[0,0,0.0010,0.0010]});a.useHandCursor="true"==g&&""!=i[s]?!0:!1;Z.addChild(a);N=0==q[s]?null==n?Math.floor(Math.random()*S.transTotal)+1:n[Math.floor(Math.random()*n.length)]:q[s];S.transition(N,Z,R,U,p[s]);a.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==g&&""!=i[s]){switch(l[s]){case "0":a="_blank";break;case "1":a="_parent";break;
case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(i[s],a)}}else"mousemove"==a.type||"touchmove"==a.type?aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OVER}):("mouseout"==a.type||"touchout"==a.type)&&aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OUT})};aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_LOAD_COMPLETE,index:s})};b.src=c+j[s];aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_CURRENT,
index:s});s>=H-1&&"false"==C&&"false"==w&&I.Pause()}function f(){D--;try{Quark.getDOM("debugInfo").value=D}catch(a){}if(0>=D||1==u)clearInterval(z),z=null,0==u?"true"==w?s=Math.floor(Math.random()*H):s<H-1?s++:s=0:u=0,d()}function e(){if(""!=x){var a=O.getChildById("preloader");null!=a&&O.removeChild(a)}}var h=b.frameRate,j=b.photoArray,i=b.photoUrlArray,g=b.enableURL,l=b.URLTarget,m=b.photoTimeArray,q=b.transitionArray,n=b.defineTransitionArray,p=b.transitionTimeArray,k=b.topPadding,r=b.bottomPadding,
t=b.leftPadding,v=b.rightPadding,w=b.randomPlayingPhotos,x=b.loadStyle,K=b.startAutoPlay,C=b.continuum,A=b.videoAutoPlay,L=b.videoArray,M=a.width-t-v,P=a.height-k-r,I=this,J=0,B=1,y=1,u=0,N=0,D=0,s=0,z=null,H=j.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){y=1;if(1==J||1==u)D=m[s]*h,z=setInterval(f,1E3/h);""!=L[s]&&void 0!=L[s]&&0==u&&("true"==A&&(clearInterval(z),z=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,
index:s,width:M,height:P}))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){I.Play()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){I.Pause()});var S=new aJSs.MaskEffect(h),O=new Quark.DisplayObjectContainer({id:"container"});O.autoSize=!0;a.addChild(O);var R=a.width-t-v,U=a.height-k-r,b=t,a=k,r=Quark.Bitmap,v=R,V=U,T="#DDD",G=document.createElement("canvas");G.width=v;G.height=V;var F=G.getContext("2d");F.fillStyle=
T;F.rect(0,0,v,V);F.fill();T=new Image;T.src=G.toDataURL("image/png");T.width=v;T.height=V;r=new r({id:"photoBoxBg",image:T});r.autoSize=!0;r.x=b;r.y=a;O.addChild(r);var E=new Quark.DisplayObjectContainer({id:"photoBox",x:b,y:a,width:R,height:U});E.autoSize=!0;O.addChild(E);var Y,Z,W=new Quark.DisplayObjectContainer({id:"aPhoto"}),X=new Quark.DisplayObjectContainer({id:"bPhoto"});E.addChild(W);E.addChild(X);this.Play=function(){J=1;1==B&&1==y?(clearInterval(z),z=null,s<H-1?s++:s=0,d()):1==B&&0==y?
(u=1,s<H-1?s++:s=0,S.maskerFull=1):(s<H-1?s++:s=0,u=1)};this.Pause=function(){J=0;null!=z&&(clearInterval(z),z=null)};this.Previous=function(a){J=a;0<s?s--:s=H-1;1==B&&1==y?(clearInterval(z),z=null,d()):1==B&&0==y?(u=1,S.maskerFull=1):u=1};this.Next=function(a){J=a;s<H-1?s++:s=0;1==B&&1==y?(clearInterval(z),z=null,d()):1==B&&0==y?(u=1,S.maskerFull=1):u=1};this.Show=function(a,b){J=b;1==B&&1==y?(clearInterval(z),z=null,s=a,d()):1==B&&0==y?(u=1,s=a,S.maskerFull=1):(s=a,u=1)};"true"==K?this.Show(0,1):
this.Show(0,0)}})();
(function(){aJSs.JsMediaConsole=function(b,a,c,d){function f(){void 0!=r&&(b.removeChild(r),void 0!=k&&"videoCallPause"==t&&(k.Play(),t=""),r=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var h=a.topPadding,j=a.leftPadding,c=a.musicPath,i=a.musicAutoPlay,g=a.musicLoop,l=a.musicStream,m=a.videoAutoPlay,q=a.bufferTime,n=a.videoArray,p=a.videoControls;if(""!=c)var k=new aJSs.Music(d+c,l,i,g);var r,t="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,function(a){var c=

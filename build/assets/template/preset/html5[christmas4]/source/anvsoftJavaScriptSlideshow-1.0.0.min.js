...
b.transitionTimeArray;this.defineTransitionArray=b.defineTransitionArray;this.photoTitleArray=b.photoTitleArray;this.descriptionText=b.descriptionText;this.photoCount=this.photoArray.length;this.Play=function(){b.Play()};this.Pause=function(){b.Pause()};this.Previous=function(){b.Previous()};this.Next=function(){b.Next()};this.Show=function(a,c){b.Show(a,c)};this.MusicPlay=function(){b.MusicPlay()};this.MusicPause=function(){b.MusicPause()}}})();(function(){aJSsTemplate.ColorConverter={hexToRGB:function(b){var a,c,d;if(/rgb/.test(b))b=b.match(/\d+/g),a=parseInt(b[0]),c=parseInt(b[1]),d=parseInt(b[2]);else if(/#/.test(b)){var f=b.length;7===f?(a=parseInt(b.slice(1,3),16),c=parseInt(b.slice(3,5),16),d=parseInt(b.slice(5),16)):4===f&&(a=parseInt(b.charAt(1)+b.charAt(1),16),c=parseInt(b.charAt(2)+b.charAt(2),16),d=parseInt(b.charAt(3)+b.charAt(3),16))}else return b;return{r:a,g:c,b:d}}}})();(function(){aJSsTemplate.JsBackground=function(b,a){var c=b.globalPath,d=b.movieWidth,f=b.movieHeight,e=b.topPadding,h=b.bottomPadding,i=b.leftPadding,j=b.rightPadding,g=new Image;a.appendChild(g);g.style.position="absolute";g.style.top="0px";g.style.left="0px";g.style.width=d+"px";g.style.height=f+"px";g.src=c+"res/bg.jpg";g.style.zIndex="-1";g=new Image;a.appendChild(g);g.style.position="absolute";g.src=c+"res/paper.png";g.style.top=e-18+"px";g.style.left=i-18+"px";g.style.width=d-i-j+40+"px";g.style.height=
f-e-h+40+"px";g.style.zIndex="-1"}})();(function(){aJSsTemplate.JsDecorate=function(b,a){var c=b.globalPath,d=Number(b.movieWidth),f=Number(b.movieHeight),e=Number(b.leftPadding),h=Number(b.rightPadding),i=new Image;a.appendChild(i);i.style.position="absolute";i.style.top="0px";i.style.left=d-67+"px";i.style.width="67px";i.style.height="334px";i.src=c+"res/pendant2.png";i=new Image;a.appendChild(i);i.style.position="absolute";i.style.top="0px";i.style.left=d-67-10+"px";i.style.width="55px";i.style.height="197px";i.src=c+"res/pendant3.png";
i=new Image;a.appendChild(i);i.style.position="absolute";i.style.top="0px";i.style.left=d-67-55-10+"px";i.style.width="81px";i.style.height="291px";i.src=c+"res/pendant1.png";i=new Image;i.style.position="absolute";i.style.top=f-220+"px";i.style.left=e-20+"px";i.style.width="171px";i.style.height="220px";i.src=c+"res/thumbnail.png";a.appendChild(i);i=new Image;i.style.position="absolute";i.style.top=f-220+"px";i.style.left=e-20+171+(d-(e-20)-h-30-513)/2+"px";i.style.width="171px";i.style.height="220px";
i.src=c+"res/thumbnail.png";a.appendChild(i);i=new Image;i.style.position="absolute";i.style.top=f-220+"px";i.style.left=e-20+342+(d-(e-20)-h-30-513)+"px";i.style.width="171px";i.style.height="220px";i.src=c+"res/thumbnail.png";a.appendChild(i);i=new Image;a.appendChild(i);i.style.position="absolute";i.style.top=f-140+"px";i.style.left="0px";i.style.width="50px";i.style.height="50px";i.src=c+"res/snowmana.gif";i=new Image;a.appendChild(i);i.style.position="absolute";i.style.top=f-100+"px";i.style.left=
e-20+342+(d-(e-20)-h-30-513)/2+"px";i.style.width="50px";i.style.height="50px";i.src=c+"res/snowmanb.gif";e=new Image;a.appendChild(e);e.style.position="absolute";e.style.top=f-146+"px";e.style.left="0px";e.style.width=d+"px";e.style.height="146px";e.src=c+"res/snow.png";e=new Image;a.appendChild(e);e.style.position="absolute";e.style.top=f-146-120+"px";e.style.left=d-200+20+"px";e.style.width="200px";e.style.height="160px";e.src=c+"res/snowmanc.gif";e=new Image;a.appendChild(e);e.style.position=
"absolute";e.style.top=f-100+"px";e.style.left=d-h-71+"px";e.style.width="71px";e.style.height="61px";e.src=c+"res/gift.png";h=new Image;a.appendChild(h);h.style.position="absolute";h.style.top=f-146-50+"px";h.style.left=d-553-30+"px";h.style.width="553px";h.style.height="146px";h.src=c+"res/star.png"}})();(function(){aJSsTemplate.JsText=function(b,a){function c(a){a=a.index;""!=n[a]?(F.style.display="true"!==q?"block":"none",F.textContent=n[a]):F.style.display="none"}function d(){"true"==q&&(F.style.display="none",G.style.cursor="pointer",a.addEventListener("mouseover",e),a.addEventListener("mouseout",h))}function f(a){a=a.index;""!=L[a]?(E.style.display="block",E.innerHTML=L[a]):E.style.display="none"}function e(){F.style.display="block"}function h(){F.style.display="none"}var i=b.movieWidth,j=b.topPadding,
g=b.leftPadding,l=b.rightPadding,m=b.showTitle,q=b.photoTitleAutoHide,n=b.photoTitleArray,p=b.photoTitleAlpha,k=b.photoTitleColor,r=b.titleTextAlign,t=b.titleTextFont,v=b.titleTextSize,w=b.titleTextShadowColor,x=b.titleTextShadowOffset,H=b.titleTextShadowBlur,D=b.textResize,I=b.textTransform,J=b.textTransformOriginX,M=b.textTransformOriginY,O=b.titleTransform,K=b.titleTransformOriginX,B=b.titleTransformOriginY,A=aJSsTemplate.ColorConverter.hexToRGB(b.photoTitleBackgroundColor),y=b.enableDes,u=b.desLineHeight,
L=b.descriptionText,C=b.desTextFont,s=b.desTextSize,z=b.desTextColor,R=b.desTextAlign,P=b.desTextShadowColor,N=b.desTextShadowOffset,V=b.desTextShadowBlur,T=b.desTransform,U=b.desTransformOriginX,S=b.desTransformOriginY,G=document.createElement("div");a.appendChild(G);G.style.position="absolute";G.style.top=j+"px";G.style.display="block";G.style.width=i-g-l-60+"px";G.style.backgroundColor="rgba("+A.r+","+A.g+","+A.b+","+p+")";G.style.backgroundRepeat="repeat";G.style.marginLeft=g+30+"px";G.style.marginRight=
l+30+"px";G.style.borderRadius="0px 0px 10px 10px";G.style.webkitTransform="rotate("+I+"deg)";G.style.msTransform="rotate("+I+"deg)";G.style.MozTransform="rotate("+I+"deg)";G.style.OTransform="rotate("+I+"deg)";G.style.transform="rotate("+I+"deg)";G.style.transformOrigin=""+M+"px "+J+"px";G.style.webkitTransformOrigin=""+M+"px "+J+"px";G.style.MozTransformOrigin=""+M+"px "+J+"px";G.style.OTransformOrigin=""+M+"px "+J+"px";G.style.resize=""+D+"";G.style.overflow="auto";if("true"==m){var F=document.createElement("div");
G.appendChild(F);F.textContent=n[0];F.style.webkitTransform="rotate("+O+"deg)";F.style.msTransform="rotate("+O+"deg)";F.style.MozTransform="rotate("+O+"deg)";F.style.OTransform="rotate("+O+"deg)";F.style.transform="rotate("+O+"deg)";F.style.transformOrigin=""+B+"px "+K+"px";F.style.webkitTransformOrigin=""+B+"px "+K+"px";F.style.MozTransformOrigin=""+B+"px "+K+"px";F.style.OTransformOrigin=""+B+"px "+K+"px";F.style.color=k;F.style.textAlign=r;F.style.fontFamily=t;F.style.fontSize=v+"px";F.style.textTransform=
...
"rotate("+T+"deg)";E.style.transformOrigin=""+S+"px "+U+"px";E.style.webkitTransformOrigin=""+S+"px "+U+"px";E.style.MozTransformOrigin=""+S+"px "+U+"px";E.style.OTransformOrigin=""+S+"px "+U+"px";E.style.textAlign=R;E.style.fontSize=s+"px";E.style.color=z;E.style.padding="12px 12px 12px 12px";E.style.fontFamily=C;E.style.lineHeight=u+"px";E.style.textTransform="none";E.style.textShadow=N+"px "+N+"px "+V+"px "+P;b.commandDispatcher.addEventListener("photoLoadComplete",f)}}})();(function(){aJSsTemplate.JsThumbnail=function(b,a){function c(){z.scrollLeft-=K}function d(){z.scrollLeft+=K}globalPath=b.globalPath;var f=Number(b.movieWidth),e=Number(b.movieHeight),h=Number(b.topPadding),i=Number(b.bottomPadding),j=Number(b.leftPadding),g=Number(b.rightPadding),l=b.startAutoPlay,m=b.continuum,q=b.clickToAutoPlay,n=b.musicPath,p=b.musicAutoPlay,k=b.photoArray,r=b.thumbnailArray,t=b.thumWidth,v=b.thumHeight,w=b.thumbnailBorderColor,x=b.currentBorderColor,H=b.thumborder,D=0;aJSsTemplate.ColorConverter.hexToRGB(b.thumBoxColor);
var I=v+2*H,J=0,M=0,O=0,M=Math.ceil(129-(t+2*H)+40+(f-(j-20)-g-30-513)/2),K=Math.ceil(3*(t+2*H)+3*M),B=document.createElement("div");a.appendChild(B);B.id="thumBody";B.style.position="absolute";B.style.top=e-i+71.5-I/2+"px";B.style.left=j-20+78.5-(t+2*H)/2+5+"px";B.style.width=K+"px";B.style.height=I+"px";B.style.margin="0px auto";B.style.borderRadius="5px 5px 5px 5px";B.style.display="block";var A=document.createElement("div");a.appendChild(A);A.style.position="absolute";A.style.background="url("+
globalPath+"res/thumleft1.png)";A.style.top=e-i+65+"px";A.style.left=j-20+"px";A.style.width="13px";A.style.height="15px";var y=document.createElement("div");a.appendChild(y);y.style.position="absolute";y.style.background="url("+globalPath+"res/thumright1.png)";y.style.top=e-i+65+"px";y.style.left=j-20+513+(f-(j-20)-g-30-513)-20+"px";y.style.width="13px";y.style.height="15px";var u=document.createElement("div");a.appendChild(u);u.style.position="absolute";u.style.cursor="pointer";u.style.display=
"none";u.style.background="url("+globalPath+"res/prev1.png)";u.style.top=h+(e-h-i)/2-8+"px";u.style.left=j-35+"px";u.style.width="70px";u.style.height="16px";var L=document.createElement("div");a.appendChild(L);L.style.position="absolute";L.style.cursor="pointer";L.style.display="none";L.style.top=h+(e-h-i)/2-8+"px";L.style.left=j+(f-j-g)-35+"px";L.style.background="url("+globalPath+"res/next1.png)";L.style.width="70px";L.style.height="16px";var C=document.createElement("div");a.appendChild(C);C.style.position=
"absolute";C.style.backgroundImage="url("+globalPath+"res/play2.png)";C.style.top=e-i-(e-h-i)/2-(v+2*H+10)/2+"px";C.style.left=j+(f-j-g)/2-25+"px";C.style.width="50px";C.style.height="50px";C.style.display="block";C.style.cursor="pointer";var s=document.createElement("div");a.appendChild(s);s.style.position="absolute";s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)";s.style.top=h-20-32+"px";s.style.left=j+(f-j-g)+10-25+"px";s.style.width="50px";s.style.height="64px";s.style.display=
"block";s.style.cursor="pointer";var z=document.createElement("div");B.appendChild(z);z.id="showThumbnails";z.style.position="absolute";z.style.top=(v+2*H)/2-(v+2*H)/2+"px";z.style.width=K+"px";z.style.height=v+2*H+"px";z.style.overflow="hidden";f=document.createElement("div");z.appendChild(f);f.id="showArea";for(e=0;e<b.photoCount;e++)h=new Image,h.style.width=t+"px",h.style.height=v+"px",h.style.cursor="pointer",h.style.borderWidth=H+"px",h.style.borderStyle="solid",h.style.borderColor=w,h.style.cssFloat=
"left",h.style.marginRight=M+"px",h.src=globalPath+r[e],h.alt=k[e],h.index=e,J=K*Math.ceil(b.photoCount/3),f.appendChild(h);f.style.width=J+"px";f.style.height=v+2*H+"px";var R=J;A.style.cursor="pointer";y.style.cursor="pointer";A.onmouseover=function(){A.style.background="url("+globalPath+"res/thumleft2.png)"};A.onmouseout=function(){A.style.background="url("+globalPath+"res/thumleft1.png)"};A.onclick=function(){0==z.scrollLeft?z.scrollLeft=R:setTimeout(c,0)};y.onmouseover=function(){y.style.background=
"url("+globalPath+"res/thumright2.png)"};y.onmouseout=function(){y.style.background="url("+globalPath+"res/thumright1.png)"};y.onclick=function(){z.scrollLeft==R-K?z.scrollLeft=0:setTimeout(d,0)};u.onmouseover=function(){this.style.background="url("+globalPath+"res/prev2.png)"};u.onmouseout=function(){this.style.background="url("+globalPath+"res/prev1.png)"};u.onclick=function(){"true"==q?(0<D?b.Show(D-1,1):(b.Show(b.photoCount-1,1),D=0),C.style.display="none"):(b.Previous(),C.style.display="block")};
L.onmouseover=function(){this.style.background="url("+globalPath+"res/next2.png)"};L.onmouseout=function(){this.style.background="url("+globalPath+"res/next1.png)"};L.onclick=function(){"true"==q?(D<b.photoCount-1?b.Show(D+1,1):(b.Show(0,1),D=0),C.style.display="none"):(b.Next(),C.style.display="block")};a.addEventListener("mouseover",function(){L.style.display="block";u.style.display="block"});a.addEventListener("mouseout",function(){L.style.display="none";u.style.display="none"});var P=f.getElementsByTagName("img");
P[0].style.borderColor=x;for(e=0;e<b.photoCount;e++)P[e].onmouseover=function(){this.style.borderColor=x},P[e].onclick=function(){for(var a=0;a<b.photoCount;a++)P[a].style.borderColor=w;P[this.index].style.borderColor=x;D=this.index;"true"==q?(b.Show(D,1),C.style.display="none"):(b.Show(D,0),C.style.display="block")},P[e].onmouseout=function(){D!==this.index&&(this.style.borderColor=w)};b.commandDispatcher.addEventListener("photoLoadComplete",function(a){for(var c=0;c<b.photoCount;c++)P[c].style.borderColor=
w;P[a.index].style.borderColor=x;D=a.index;D>=b.photoCount-1&&("false"==m&&"false"==b.randomPlayingPhotos)&&(C.style.display="block");O=parseInt(D/3);z.scrollLeft=K*O});C.style.display="true"==l?"none":"block";C.style.cursor="pointer";C.onmouseover=function(){C.style.backgroundImage="url("+globalPath+"res/play1.png)"};C.onmouseout=function(){C.style.backgroundImage="url("+globalPath+"res/play2.png)"};C.onclick=function(){b.Play();C.style.display="none"};var N=0;""==n?s.style.display="none":"true"==
p?(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",s.onclick=function(){0==N?(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),N=1):(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),N=0)}):(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",s.onclick=function(){0==N?(s.style.backgroundImage="url("+globalPath+"res/musicPlay.png)",b.MusicPlay(),N=1):(s.style.backgroundImage="url("+globalPath+"res/musicStop.png)",b.MusicPause(),
N=0)});b.commandDispatcher.addEventListener("soundPlayComplete",function(){s.style.backgroundImage="url("+globalPath+"res/musicStop.png)";N=1});b.commandDispatcher.addEventListener("videoPlayEnded",function(){C.style.display="none"})}})();(function(){aJSsTemplate.JsMenu=function(b,a){var c=b.movieWidth,d=b.movieHeight,f=b.bottomPadding,e=b.rightPadding,h=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=h&&"anvsoftUSSTheme"!=h&&"anvsoftHSMTheme"!=h){var i;switch(h){case "anvsoftPFMTheme":i="Photo Slideshow Maker";break;case "anvsoftUSSTheme":i="Ultra Slideshow";break;case "anvsoftHSMTheme":i="HTML5 Slideshow Maker";break;case "anvsoftSWWTheme":i="SlideWow";break;default:i="Anvsoft Photo Slideshow"}var j=document.createElement("div");
j.style.position="absolute";j.style.cursor="pointer";j.style.padding="5px";j.style.backgroundColor="rgba(0, 0, 0, 0.3)";j.style.textShadow="1px 1px 1px #000";j.style.borderRadius="5px";j.style.color="#FFF";j.style.font="normal normal 10px/12px verdana,tahoma,arial,sans-serif";j.textContent=i;a.appendChild(j);j.style.left=c-e-j.scrollWidth-5+"px";j.style.top=d-f-j.scrollHeight-5+"px";j.onclick=function(){switch(h){case "anvsoftPFMTheme":window.open("http://www.photo-flash-maker.com/","_self");break;
case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/","_self");break;case "anvsoftHSMTheme":window.open("http://www.html5-slideshow-maker.com/","_self");break;case "anvsoftSWWTheme":window.open("http://www.slidewow.com/","_self");break;default:window.open("http://www.anvsoft.com/","_self")}}}}})();(function(){aJSsTemplate.Main=function(b){var b=new aJSsTemplate.ExternalInterface(b),a=b.container;new aJSsTemplate.JsBackground(b,a);new aJSsTemplate.JsDecorate(b,a);new aJSsTemplate.JsText(b,a);new aJSsTemplate.JsThumbnail(b,a);new aJSsTemplate.JsMenu(b,a)}})();(function(b){function a(a,c,b){for(var d=a.length,j=c.length,g,l,m,q,n,p,k=0,r=0;r<d;r++){g=a[r];l=a[r<d-1?r+1:0];k=g.y-l.y;g=l.x-g.x;l=Math.sqrt(k*k+g*g);k/=l;g/=l;l=m=a[0].x*k+a[0].y*g;for(var t=1;t<d;t++)p=a[t].x*k+a[t].y*g,p>m?m=p:p<l&&(l=p);q=n=c[0].x*k+c[0].y*g;for(t=1;t<j;t++)p=c[t].x*k+c[t].y*g,p>n?n=p:p<q&&(q=p);l<q?(l=q-m,k=-k,g=-g):l-=n;if(0<=l)return!1;l>b.overlap&&(b.overlap=l,b.normal.x=k,b.normal.y=g)}return b}var c=b.Quark=b.Quark||{version:"1.0.0",global:b},d=function(){};c.inherit=
...
c.createDOM=function(a,c){var b=document.createElement(a),d;for(d in c){var j=c[d];if("style"==d)for(var g in j)b.style[g]=j[g];else b[d]=j}return b};c.use=function(a){for(var a=a.split("."),c=b,d=0;d<a.length;d++)var i=a[d],c=c[i]||(c[i]={});return c};(function(a){var c=a.ua=navigator.userAgent;a.isWebKit=/webkit/i.test(c);a.isMozilla=/mozilla/i.test(c);a.isIE=/msie/i.test(c);a.isFirefox=/firefox/i.test(c);a.isChrome=/chrome/i.test(c);a.isSafari=/safari/i.test(c)&&!this.isChrome;a.isMobile=/mobile/i.test(c);
...
a.offsetLeft,b=a.offsetTop;(a=a.offsetParent)&&a!=document.body&&a!=document;)c+=a.offsetLeft,b+=a.offsetTop;return{left:c,top:b}};c.createDOMDrawable=function(a,b){var d=a.tagName||"div",i=b.image,j=a.width||i&&i.width,g=a.height||i&&i.height,l=c.createDOM(d);a.id&&(l.id=a.id);l.style.position="absolute";l.style.left=(a.left||0)+"px";l.style.top=(a.top||0)+"px";l.style.width=j+"px";l.style.height=g+"px";if("canvas"==d)l.width=j,l.height=g,i&&(d=l.getContext("2d"),j=b.rect||[0,0,j,g],d.drawImage(i,
j[0],j[1],j[2],j[3],a.x||0,a.y||0,a.width||j[2],a.height||j[3]));else if(l.style.opacity=void 0!=a.alpha?a.alpha:1,l.style.overflow="hidden",i&&i.src)l.style.backgroundImage="url("+i.src+")",l.style.backgroundPosition=-(a.rectX||0)+"px "+-(a.rectY||0)+"px";return l};c.DEG_TO_RAD=Math.PI/180;c.RAD_TO_DEG=180/Math.PI;c.hitTestPoint=function(a,c,b,d){var a=a.getBounds(),j=a.length,g=c>=a.x&&c<=a.x+a.width&&b>=a.y&&b<=a.y+a.height;if(g&&d){for(var d=0,g=!1,l,m,q,n,p=0;p<j;p++){var k=a[p],r=a[(p+1)%j];
k.y==r.y&&b==k.y&&(k.x>r.x?(l=r.x,m=k.x):(l=k.x,m=r.x),c>=l&&c<=m)?g=!0:(k.y>r.y?(q=r.y,n=k.y):(q=k.y,n=r.y),b<q||b>n||(k=(b-k.y)*(r.x-k.x)/(r.y-k.y)+k.x,k>c?d++:k==c&&(g=!0)))}return g?0:1==d%2?1:-1}return g?1:-1};c.hitTestObject=function(a,b,d){a=a.getBounds();b=b.getBounds();return(a=a.x<=b.x+b.width&&b.x<=a.x+a.width&&a.y<=b.y+b.height&&b.y<=a.y+a.height)&&d?(a=c.polygonCollision(b,b),!1!==a):a};c.polygonCollision=function(c,b){var d=a(c,b,{overlap:-Infinity,normal:{x:0,y:0}});return d?a(b,c,
...
(function(){var b=Quark.EventManager=function(){this.keyState={};this._evtHandlers={}};b.prototype.registerStage=function(a,c,b,f){this.register(a.context.canvas,c,{host:a,func:a._onEvent},b,f)};b.prototype.unregisterStage=function(a,c){this.unregister(a.context.canvas,c,a.onEvent)};b.prototype.register=function(a,c,b,f,e){if(null==b||"function"==typeof b)b={host:null,func:b};for(var h={prevent:f,stop:e},i=this,f=function(a){i._onEvent(a,h,b)},e=0;e<c.length;e++){for(var j=c[e],g=this._evtHandlers[j]||
(this._evtHandlers[j]=[]),l=0,m=!1;l<g.length;l++){var q=g[l];if(q.target==a&&q.callback.func==b.func){trace("duplicate callback");m=!0;break}}m||(g.push({target:a,callback:b,handler:f}),a.addEventListener(j,f,!1))}};b.prototype.unregister=function(a,c,b){for(var f=0;f<c.length;f++)for(var e=c[f],h=this._evtHandlers[e],i=0;i<h.length;i++){var j=h[i];if(j.target==a&&(j.callback.func==b||null==b)){a.removeEventListener(e,j.handler);h.splice(i,1);break}}};b.prototype._onEvent=function(a,c,d){var f=a,
...
(function(){function b(a,c){for(var d=0;d<a.children.length;d++){var i=a.children[d];if(i.children)b(i,c);else if(null!=c){i=i.getBounds();c.globalAlpha=0.2;c.beginPath();var j=i[0];c.moveTo(j.x-0.5,j.y-0.5);for(var g=1;g<i.length;g++){var l=i[g];c.lineTo(l.x-0.5,l.y-0.5)}c.lineTo(j.x-0.5,j.y-0.5);c.stroke();c.closePath();c.globalAlpha=0.5;c.beginPath();c.rect((i.x>>0)-0.5,(i.y>>0)-0.5,i.width>>0,i.height>>0);c.stroke();c.closePath()}else i.drawable.domDrawable&&(i.drawable.domDrawable.style.border=
...
function(){var a=this.width,b=this.height,d=this.getConcatenatedMatrix(),a=this.polyArea||[{x:0,y:0},{x:a,y:0},{x:a,y:b},{x:0,y:b}],b=[],f=a.length,e,h,i,j,g;e=d.transformPoint(a[0],!0,!0);h=i=e.x;j=g=e.y;b[0]=e;for(var l=1;l<f;l++)e=d.transformPoint(a[l],!0,!0),h>e.x?h=e.x:i<e.x&&(i=e.x),j>e.y?j=e.y:g<e.y&&(g=e.y),b[l]=e;b.x=h;b.y=j;b.width=i-h;b.height=g-j;return b};b.prototype.getCurrentWidth=function(){return Math.abs(this.width*this.scaleX)};b.prototype.getCurrentHeight=function(){return Math.abs(this.height*
...
function(a){null!=this.update&&this.update(a);for(var b=this.children.slice(0),d=0,f=b.length;d<f;d++){var e=b[d];e._depth=d+1;e._update(a)}};b.prototype.render=function(a){b.superClass.render.call(this,a);for(var c=0,d=this.children.length;c<d;c++)this.children[c]._render(a)};b.prototype.getObjectUnderPoint=function(a,b,d,f){if(f)var e=[];for(var h=this.children.length-1;0<=h;h--){var i=this.children[h];if(!(null==i||!i.eventEnabled&&void 0==i.children||!i.visible||0>=i.alpha))if(void 0!=i.children&&
i.eventChildren&&0<i.getNumChildren()){var j=i.getObjectUnderPoint(a,b,d,f);if(j)if(f)0<j.length&&(e=e.concat(j));else return j;else if(0<=i.hitTestPoint(a,b,d))if(f)e.push(i);else return i}else if(0<=i.hitTestPoint(a,b,d))if(f)e.push(i);else return i}return f?e:null}})();
...
(function(){aJSs.Video=function(b,a,c,d,f,e){var a="true"==a?!0:!1,d="true"==d?!0:!1,b=b.substr(0,b.lastIndexOf(".")),h=document.createElement("video");h.width=f;h.height=e;try{h.buffered=c}catch(i){}h.autoplay=a;h.controls=d;h.loop=!1;h.preload="none";c=document.createElement("source");h.appendChild(c);h.canPlayType&&(""!=h.canPlayType("video/mp4")?(c.type="video/mp4",c.src=b+".mp4"):""!=h.canPlayType("video/ogg")?(c.type="video/ogg",c.src=b+".ogg"):""!=h.canPlayType("video/webm")?(c.type="video/webm",
...
(function(){aJSs.MaskEffect=function(b){this.transTotal=68;this.maskerFull=0;var a=this,c,d;this.transition=function(a,b,d,c,j){this.maskerFull=0;if(a<=this.transTotal)this["mask"+a](b,d,c,j);else this.transition(68,b,d,c,j)};this.mask1=function(f,e,h,i){function j(){q=e*k*d;n=h*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.setRect([0,0,e,h]),clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=0,q=0,n=
0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask2=function(f,e,h,i){function j(){q=e*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask3=function(f,e,h,i){function j(){n=h*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=0,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask4=function(f,e,h,i){function j(){l=e*(1-k*d);q=e*k*d;g.x=e*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask5=function(f,e,h,i){function j(){m=
h*(1-k*d);n=h*k*d;g.y=h*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask6=function(f,e,h,i){function j(){n=e*x*d;g.setRect([m,q,n,p]);k=e*(1-x*d);t=e*x*d;l.x=e*(1-x*d);l.setRect([k,r,t,v]);x++;if(x>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),f.removeChild(l),clearInterval(w),w=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,q=0,n=0,p=h,k=e,r=0,t=0,v=h;c=i*b;d=1/(2*c);var w=setInterval(j,1E3/b),x=1;j()};this.mask7=function(f,e,h,i){function j(){p=h*x*d;g.setRect([m,q,n,p]);r=h*(1-x*d);v=h*x*d;l.y=h*(1-x*d);l.setRect([k,r,t,v]);x++;if(x>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,
e,h]),f.removeChild(l),clearInterval(w),w=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,q=0,n=e,p=0,k=0,r=h,t=e,v=0;c=i*b;d=1/(2*c);var w=setInterval(j,1E3/b),x=1;j()};this.mask8=function(f,e,h,i){function j(){l=e/2*(1-k*d);q=e*k*d;g.x=e/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=
f.getChildAt(0),l=e/2,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask9=function(f,e,h,i){function j(){m=h/2*(1-k*d);n=h*k*d;g.y=h/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h/2,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask10=function(f,e,h,i){function j(){for(var b=0;b<m;b++){var i=b*q,j=
q*r*d,l=h;f.getChildById("maskBitmap"+b).setRect([i,0,j,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(k);k=null}}for(var g=f.getChildAt(0),l=g.image,m=16,q=e/m,n=0;n<m;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.x=n*q;f.addChild(p)}c=i*b;d=1/c;var k=setInterval(j,1E3/b),r=1;j()};this.mask11=function(f,e,h,i){function j(){for(var b=
0;b<m;b++){var i=b*q,j=e,l=q*r*d;f.getChildById("maskBitmap"+b).setRect([0,i,j,l])}r++;if(r>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(k);k=null}}for(var g=f.getChildAt(0),l=g.image,m=16,q=h/m,n=0;n<m;n++){var p=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});p.y=n*q;f.addChild(p)}c=i*b;d=1/c;var k=setInterval(j,1E3/b),r=1;j()};this.mask12=
function(f,e,h,i){function j(){for(n=0;n<J;n++)D=k.length,0<D?(I=Math.floor(Math.random()*D),k[I].visible=!0,k.splice(I,1)):n=J;H++;if(H>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(x);x=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/20),q=Math.ceil(h/20),n=0,p=0,k=[],n=0;20>n;n++)for(p=0;20>p;p++){var r=m*n,t=q*p,v=m,w=q;r<e&&t<
h&&(r>e-m&&(v=e-r),t>h-q&&(w=h-t),v=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[r,t,v,w]}),v.x=r,v.y=t,v.visible=!1,f.addChild(v),k.push(v))}c=i*b;d=1/c;var x=setInterval(j,1E3/b),H=1,D=k.length,I,J=Math.round(D/c);1>J&&(J=1);j()};this.mask13=function(f,e,h,i){function j(){l=e/2*(1-k*d);m=h/2*(1-k*d);q=e*k*d;n=h*k*d;g.x=e/2*(1-k*d);g.y=h/2*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),
g.x=0,g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e/2,m=h/2,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask14=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask15=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask16=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask17=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask18=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask19=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask20=function(a,
b,d,c){this.transition(68,a,b,d,c)};this.mask21=function(f,e,h,i){function j(){l=e*(1-k*d);m=h*(1-k*d);q=e*k*d;n=h*k*d;g.x=e*(1-k*d);g.y=h*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,m=h,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask22=function(f,e,h,i){function j(){l=e*(1-k*d);m=0;q=e*k*d;n=h*k*d;g.x=e*(1-k*
d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,m=0,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask23=function(f,e,h,i){function j(){l=0;m=h*(1-k*d);q=e*k*d;n=h*k*d;g.y=h*(1-k*d);g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=
0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=0,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask24=function(f,e,h,i){function j(){r=e/2*u*d;t=h/2*u*d;g.setRect([p,k,r,t]);v=e/2+e/2*(1-u*d);w=0;x=e/2*u*d;H=h/2*u*d;m.x=e/2+e/2*(1-u*d);m.setRect([v,w,x,H]);D=0;I=h/2+h/2*(1-u*d);J=e/2*u*d;M=h/2*u*d;q.y=h/2+h/2*(1-u*d);q.setRect([D,I,J,M]);O=e/2+e/2*(1-u*d);K=h/2+h/2*(1-u*d);B=e/2*u*d;A=h/2*u*d;n.x=e/2+e/2*(1-u*d);n.y=h/2+h/2*(1-u*d);n.setRect([O,K,B,A]);u++;if(u>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(y);y=null}}var g=f.getChildAt(0),l=g.image,m=new Quark.Bitmap({id:"targetBitmap2",image:l,rect:[0,0,0,0]});f.addChild(m);var q=new Quark.Bitmap({id:"targetBitmap3",image:l,rect:[0,0,0,0]});f.addChild(q);var n=new Quark.Bitmap({id:"targetBitmap4",image:l,rect:[0,0,0,0]});f.addChild(n);var p=0,k=0,r=0,t=0,v=e,w=0,x=0,H=0,D=0,I=h,J=0,M=0,O=e,K=h,B=0,A=0;c=i*b;d=1/c;var y=setInterval(j,1E3/b),u=1;j()};this.mask25=
function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask26=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask27=function(f,e,h,i){function j(){for(var b=0;b<m;b++){var i=q*b,j=q;n[b].x>e-q&&(j=e-n[b].x);var l=p[b]+(h-p[b])*x*d*h/(h-p[b]);l<h&&n[b].setRect([i,0,j,l])}x++;if(x>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(w);w=null}}for(var g=
f.getChildAt(0),l=g.image,m=20,q=Math.ceil(e/m),n=[],p=[],k=0;k<m;k++){p[k]=h/2*Math.random();var r=q*k,t=q,v=p[k];r>e-q&&(t=e-r);t=new Quark.Bitmap({id:"maskBitmap"+k,image:l,rect:[r,0,t,v]});t.x=r;f.addChild(t);n.push(t)}c=i*b;d=1/c;var w=setInterval(j,1E3/b),x=1;j()};this.mask28=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask29=function(f,e,h,i){function j(){g.alpha=m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.alpha=
1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.alpha=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask30=function(f,e,h,i){function j(){l=e*(1-k*d);q=e*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=e,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask31=function(f,e,h,i){function j(){g.alpha=
k*d;l=e*(1-k*d);q=e*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0);g.alpha=0;var l=e,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask32=function(f,e,h,i){function j(){q=e*k*d;g.setRect([l,m,q,n]);g.x=e*(1-k*d);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,
0,e,h]),g.x=0,clearInterval(p),p=null}var g=f.getChildAt(0);g.x=e;var l=0,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask33=function(f,e,h,i){function j(){g.alpha=k*d;q=e*k*d;g.setRect([l,m,q,n]);g.x=e*(1-k*d);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0);g.x=e;var l=g.alpha=0,m=0,q=0,n=h;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};
this.mask34=function(f,e,h,i){function j(){m=h*(1-k*d);n=h*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0),l=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask35=function(f,e,h,i){function j(){g.alpha=k*d;m=h*(1-k*d);n=h*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),g.y=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0),l=g.alpha=0,m=h,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask36=function(f,e,h,i){function j(){g.y=h*(1-k*d);n=h*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(p),p=null}var g=f.getChildAt(0);g.y=h;var l=0,m=0,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask37=
function(f,e,h,i){function j(){g.alpha=k*d;g.y=h*(1-k*d);n=h*k*d;g.setRect([l,m,q,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,g.alpha=1,clearInterval(p),p=null}var g=f.getChildAt(0);g.alpha=0;g.y=h;var l=0,m=0,q=e,n=0;c=i*b;d=1/c;var p=setInterval(j,1E3/b),k=1;j()};this.mask38=function(f,e,h,i){function j(){g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.width=e,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask39=function(f,e,h,i){function j(){g.alpha=m*d;g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.alpha=0;g.width=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask40=function(f,e,h,
i){function j(){g.x=e/2*(1-m*d);g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.x=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.x=e/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask41=function(f,e,h,i){function j(){g.alpha=m*d;g.x=e/2*(1-m*d);g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.width=e,g.x=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.alpha=0;g.x=e/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask42=function(f,e,h,i){function j(){g.x=e*(1-m*d);g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.x=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.x=e;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};
this.mask43=function(f,e,h,i){function j(){g.alpha=m*d;g.x=e*(1-m*d);g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.x=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.alpha=0;g.x=e;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask44=function(f,e,h,i){function j(){g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.height=h,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask45=function(f,e,h,i){function j(){g.alpha=m*d;g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.alpha=0;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask46=function(f,
e,h,i){function j(){g.y=h/2*(1-m*d);g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.y=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask47=function(f,e,h,i){function j(){g.alpha=m*d;g.y=h/2*(1-m*d);g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.height=h,g.y=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.alpha=0;g.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask48=function(f,e,h,i){function j(){g.y=h*(1-m*d);g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.y=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.y=h;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;
j()};this.mask49=function(f,e,h,i){function j(){g.alpha=m*d;g.y=h*(1-m*d);g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.height=h,g.y=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.height=0;g.alpha=0;g.y=h;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask50=function(f,e,h,i){function j(){g.x=e/2*(1-m*d);g.y=h/2*(1-m*d);g.width=e*m*d;g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.width=e,g.height=h,g.x=0,g.y=0,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.width=0;g.height=0;g.x=e/2;g.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask51=function(f,e,h,i){function j(){g.alpha=m*d;g.x=e/2*(1-m*d);g.y=h/2*(1-m*d);g.width=e*m*d;g.height=h*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.width=e,g.height=h,g.x=0,g.y=0,g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);
g.setRect([0,0,e,h]);g.width=0;g.height=0;g.alpha=0;g.x=e/2;g.y=h/2;c=i*b;d=1/c;var l=setInterval(j,1E3/b),m=1;j()};this.mask52=function(a,b,d){a.getChildAt(0).setRect([0,0,b,d]);aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER})};this.mask53=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask54=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask55=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask56=function(a,b,d,c){this.transition(68,a,b,d,c)};
...
a,b,d,c)};this.mask66=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask67=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask68=function(f,e,h,i){function j(){for(n=0;n<u;n++)k[n].width=x[n]*y*d,k[n].height=H[n]*y*d,k[n].x=v[n]+(r[n]-v[n])*y*d,k[n].y=w[n]+(t[n]-w[n])*y*d;y++;if(y>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(A);
A=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/12),q=Math.ceil(h/12),n=0,p=0,k=[],r=[],t=[],v=[],w=[],x=[],H=[],n=0;12>n;n++)for(p=0;12>p;p++){var D=m*n,I=q*p,J=m,M=q,O=Math.random()*(e-m),K=Math.random()*(h-q);if(D<e&&I<h){D>e-m&&(J=e-D);I>h-q&&(M=h-I);var B=new Quark.Bitmap({id:"maskBitmap"+n+p,image:l,rect:[D,I,J,M]});B.x=O;B.y=K;B.width=0;B.height=0;f.addChild(B);k.push(B);r.push(D);t.push(I);x.push(J);H.push(M);v.push(O);w.push(K)}}c=i*b;d=1/c;var A=setInterval(j,1E3/b),y=1,u=k.length;
j()}}})();
...
(function(){aJSs.JsCompatibleTheme=function(b,a,c){function d(){p--;0>=p&&(clearInterval(r),k++,k>n-1&&(k=0),v.src=c+e[k])}var f=b.movieBackgroundColor,e=b.photoArray,h=b.photoUrlArray,i=b.photoTimeArray,j=b.transitionTimeArray,g=b.URLTarget,l=b.topPadding,m=b.bottomPadding,q=b.leftPadding,b=b.rightPadding,n=e.length,p=0,k=0,r=null,t=document.getElementById(a);t.style.backgroundColor=f;var a=t.offsetWidth,f=t.offsetHeight,q=a-q-b,l=f-l-m,m=Math.round((a-q)/2),b=Math.round((f-l)/2),v=new Image;t.appendChild(v);
v.style.position="absolute";v.style.width=q+"px";v.style.height=l+"px";v.style.left=m+"px";v.style.top=b+"px";v.src=c+e[k];v.onload=function(){p=parseInt(j[k])+parseInt(i[k]);r=setInterval(d,1E3)};v.onclick=function(){var a;switch(g[k]){case "0":a="_blank";break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(h[k],a)};var w=document.createElement("div");t.appendChild(w);w.style.position="absolute";w.style.width="250px";w.style.padding="8px";
w.style.backgroundColor="#333";w.style.color="#FFF";w.style.textAlign="left";w.style.font="normal normal 12px/16px verdana,tahoma,arial,sans-serif";w.innerHTML="The browser you are using does not support HTML5. Now you are using the simple compatible mode. To get better user experience, please use HTML5 supported browser.";w.style.left=Math.round((a-w.offsetWidth)/2)+"px";w.style.top=Math.round((f-w.offsetHeight)/2)+"px";var x=setTimeout(function(){clearTimeout(x);x=null;t.removeChild(w)},1E4)}})();
(function(){aJSs.JsBackground=function(b,a){var c=b.movieBackgroundColor,d=new Quark.DisplayObjectContainer({id:"backgroundBox"});d.autoSize=!0;a.addChild(d);if(""!=c){var f=Quark.Bitmap,e=a.width,h=a.height,i=document.createElement("canvas");i.width=e;i.height=h;var j=i.getContext("2d");j.fillStyle=c;j.rect(0,0,e,h);j.fill();c=new Image;c.src=i.toDataURL("image/png");c.width=e;c.height=h;f=new f({id:"background",image:c});f.autoSize=!0;d.addChild(f)}}})();
(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});if(""!=x){e();var a=new Image;a.src=c+x;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=t+(M-a.width)/2;a.y=k+(O-a.height)/2;N.addChild(a)}y=A=0;Y&&Y.removeAllChildren();E.swapChildren(W,X);E.getChildIndex(W)>E.getChildIndex(X)?
(Z=W,Y=X):(Z=X,Y=W);var b=new Image;b.onload=function(){e();A=1;b.width=V;b.height=T;var a=new Quark.Bitmap({id:"targetBitmap",image:b,rect:[0,0,0.0010,0.0010]});a.useHandCursor="true"==g&&""!=j[s]?!0:!1;Z.addChild(a);L=0==q[s]?null==n?Math.floor(Math.random()*P.transTotal)+1:n[Math.floor(Math.random()*n.length)]:q[s];P.transition(L,Z,V,T,p[s]);a.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==g&&""!=j[s]){switch(l[s]){case "0":a="_blank";break;case "1":a="_parent";break;
...
index:s});s>=R-1&&"false"==D&&"false"==w&&K.Pause()}function f(){C--;try{Quark.getDOM("debugInfo").value=C}catch(a){}if(0>=C||1==u)clearInterval(z),z=null,0==u?"true"==w?s=Math.floor(Math.random()*R):s<R-1?s++:s=0:u=0,d()}function e(){if(""!=x){var a=N.getChildById("preloader");null!=a&&N.removeChild(a)}}var h=b.frameRate,i=b.photoArray,j=b.photoUrlArray,g=b.enableURL,l=b.URLTarget,m=b.photoTimeArray,q=b.transitionArray,n=b.defineTransitionArray,p=b.transitionTimeArray,k=b.topPadding,r=b.bottomPadding,
t=b.leftPadding,v=b.rightPadding,w=b.randomPlayingPhotos,x=b.loadStyle,H=b.startAutoPlay,D=b.continuum,I=b.videoAutoPlay,J=b.videoArray,M=a.width-t-v,O=a.height-k-r,K=this,B=0,A=1,y=1,u=0,L=0,C=0,s=0,z=null,R=i.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){y=1;if(1==B||1==u)C=m[s]*h,z=setInterval(f,1E3/h);""!=J[s]&&void 0!=J[s]&&0==u&&("true"==I&&(clearInterval(z),z=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,
index:s,width:M,height:O}))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){K.Play()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){K.Pause()});var P=new aJSs.MaskEffect(h),N=new Quark.DisplayObjectContainer({id:"container"});N.autoSize=!0;a.addChild(N);var V=a.width-t-v,T=a.height-k-r,b=t,a=k,r=Quark.Bitmap,v=V,U=T,S="#DDD",G=document.createElement("canvas");G.width=v;G.height=U;var F=G.getContext("2d");F.fillStyle=
S;F.rect(0,0,v,U);F.fill();S=new Image;S.src=G.toDataURL("image/png");S.width=v;S.height=U;r=new r({id:"photoBoxBg",image:S});r.autoSize=!0;r.x=b;r.y=a;N.addChild(r);var E=new Quark.DisplayObjectContainer({id:"photoBox",x:b,y:a,width:V,height:T});E.autoSize=!0;N.addChild(E);var Y,Z,W=new Quark.DisplayObjectContainer({id:"aPhoto"}),X=new Quark.DisplayObjectContainer({id:"bPhoto"});E.addChild(W);E.addChild(X);this.Play=function(){B=1;1==A&&1==y?(clearInterval(z),z=null,s<R-1?s++:s=0,d()):1==A&&0==y?
(u=1,s<R-1?s++:s=0,P.maskerFull=1):(s<R-1?s++:s=0,u=1)};this.Pause=function(){B=0;null!=z&&(clearInterval(z),z=null)};this.Previous=function(a){B=a;0<s?s--:s=R-1;1==A&&1==y?(clearInterval(z),z=null,d()):1==A&&0==y?(u=1,P.maskerFull=1):u=1};this.Next=function(a){B=a;s<R-1?s++:s=0;1==A&&1==y?(clearInterval(z),z=null,d()):1==A&&0==y?(u=1,P.maskerFull=1):u=1};this.Show=function(a,b){B=b;1==A&&1==y?(clearInterval(z),z=null,s=a,d()):1==A&&0==y?(u=1,s=a,P.maskerFull=1):(s=a,u=1)};"true"==H?this.Show(0,1):
this.Show(0,0)}})();
(function(){aJSs.JsMediaConsole=function(b,a,c,d){function f(){void 0!=r&&(b.removeChild(r),void 0!=k&&"videoCallPause"==t&&(k.Play(),t=""),r=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var h=a.topPadding,i=a.leftPadding,c=a.musicPath,j=a.musicAutoPlay,g=a.musicLoop,l=a.musicStream,m=a.videoAutoPlay,q=a.bufferTime,n=a.videoArray,p=a.videoControls;if(""!=c)var k=new aJSs.Music(d+c,l,j,g);var r,t="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,function(a){var c=
a.index,e=a.width,a=a.height;void 0!=k&&k.Playing()&&(k.Pause(),t="videoCallPause");r=new aJSs.Video(d+n[c],m,q,p,e,a);r.style.backgroundColor="#000";r.style.position="absolute";r.style.top=h+"px";r.style.left=i+"px";b.appendChild(r);c=document.getElementById("videoLoadText");null==c&&(c=document.createElement("div"),c.id="videoLoadText",c.style.position="absolute",c.style.top=h+5+"px",c.style.left=i+5+"px",c.style.font="normal normal 11px/13px verdana,tahoma,arial,sans-serif",c.style.color="#FFF",
...
e=136}var i=new Quark.DisplayObjectContainer({id:"menudBox"});i.autoSize=!0;i.x=d;i.y=c;a.addChild(i);var c=Quark.Bitmap,d=e,j="#000",g=document.createElement("canvas");g.width=d;g.height=20;var l=g.getContext("2d");l.fillStyle=j;l.rect(0,0,d,20);l.fill();j=new Image;j.src=g.toDataURL("image/png");j.width=d;j.height=20;c=new c({id:"copyrightBg",image:j});c.autoSize=!0;c.alpha=0.3;i.addChild(c);c=Quark.Bitmap;d=e;j="#FFF";g=h;h=document.createElement("canvas");h.width=d;h.height=20;d=h.getContext("2d");
d.font="11px arial, sans-serif";d.textAlign="start";d.textBaseline="middle";d.fillStyle=j;d.fillText(g,0,10);d=g=d.measureText(g).width;j=new Image;j.src=h.toDataURL("image/png");j.width=d;j.height=20;h=new c({id:"copyrightText",image:j});h.useHandCursor=!0;h.autoSize=!0;h.x=Math.round((e-g)/2);i.addChild(h);h.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type)switch(f){case "anvsoftPFMTheme":window.open("http://www.photo-flash-maker.com/","_self");break;case "anvsoftUSSTheme":window.open("http://www.ultraslideshow.com/",
...
(function(b){var a=aJSs.getParameters.parameters().xml_path,c=aJSs.getParameters.parameters().fs_path,d,f;void 0==a?void 0==c?(d="slides.xml",f=""):(d=c+"/slides.xml",f=c+"/"):(d=a,f=a.substr(0,a.lastIndexOf("/")+1));anvsoftJavaScriptSlideshow.init=function(a){var c,i;if(b.document.createElement("canvas").getContext){var a=Quark.getDOM(a),j=Quark.supportTouch?["touchstart","touchmove","touchend","touchout"]:["mousedown","mousemove","mouseup","mouseout"],g=Quark.getUrlParams();void 0==g.mode&&(g.mode=
1);var l=a.clientWidth||a.offsetWidth,m=a.clientHeight||a.offsetHeight;1==g.mode?(c=Quark.createDOM("canvas",{width:l,height:m}),a.appendChild(c),i=new Quark.CanvasContext({canvas:c})):i=new Quark.DOMContext({canvas:a});c=new Quark.Stage({width:l,height:m,context:i});(new Q.EventManager).registerStage(c,j);i=new aJSs.JsXmlLoad(d);j=new aJSs.JsPhoto(i,c,f);g=new aJSs.JsMediaConsole(a,i,c,f);new aJSs.JsMenu(i,c);l=new Q.Timer(1E3/i.frameRate);l.addListener(c);l.start();i=new aJSs.JsInterface(a,i,j,
g,f);new aJSsTemplate.Main(i)}else c=new aJSs.JsXmlLoad(d),new aJSs.JsCompatibleTheme(c,a,f)}})(window);

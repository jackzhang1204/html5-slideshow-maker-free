...
b.anvsoftMenu;this.frameRate=b.frameRate;var a=b.globalTitleXml;this.showTitle=a.getAttribute("showTitle");this.photoTitleColor=a.getAttribute("photoTitleColor").replace(/0x/g,"#");this.photoTitleBackgroundColor=a.getAttribute("backgroundColor").replace(/0x/g,"#");this.photoTitleAlpha=a.getAttribute("alpha")/100;this.photoTitleAutoHide=a.getAttribute("autoHide");this.titleTextFont=a.getAttribute("titleTextFont");this.titleTextSize=a.getAttribute("titleTextSize");this.titleTextShadowColor=a.getAttribute("titleTextShadowColor").replace(/0x/g,
"#");this.titleTextShadowOffset=Number(a.getAttribute("titleTextShadowOffset"));this.titleTextShadowBlur=Number(a.getAttribute("titleTextShadowBlur"));this.titleTextAlign=a.getAttribute("titleTextAlign");this.musicPath=b.musicPath;this.musicStream=b.musicStream;this.musicLoop=b.musicLoop;this.musicAutoPlay=b.musicAutoPlay;this.topPadding=b.topPadding;this.bottomPadding=b.bottomPadding;this.leftPadding=b.leftPadding;this.rightPadding=b.rightPadding;a=b.globalDescriptionXml;this.enableDes=a.getAttribute("enable");
this.desTextFont=a.getAttribute("defaultTextFont");this.desTextSize=a.getAttribute("defaultTextSize");this.desTextColor=a.getAttribute("defaultTextColor").replace(/0x/g,"#");this.desLineHeight=Number(a.getAttribute("lineHeight"));this.desTextShadowColor=a.getAttribute("desTextShadowColor").replace(/0x/g,"#");this.desTextShadowOffset=Number(a.getAttribute("desTextShadowOffset"));this.desTextShadowBlur=Number(a.getAttribute("desTextShadowBlur"));this.desTextAlign=a.getAttribute("desTextAlign");this.videoAutoPlay=
b.videoAutoPlay;this.bufferTime=b.bufferTime;this.videoControls=b.videoControls;a=b.thumbnailBasicXml;this.thumWidth=Number(a.getAttribute("thumWidth"));this.thumHeight=Number(a.getAttribute("thumHeight"));this.thumborder=Number(a.getAttribute("thumborder"));this.thumSpacing=Number(a.getAttribute("thumSpacing"));this.thumbnailBorderColor=a.getAttribute("borderColor").replace(/0x/g,"#");this.smallBlockWidth=Number(a.getAttribute("smallBlockWidth"));this.smallBlockHeight=Number(a.getAttribute("smallBlockHeight"));
this.smallBlockBorderWidth=Number(a.getAttribute("smallBlockBorderWidth"));this.smallBlockBorderColor=a.getAttribute("smallBlockBorderColor").replace(/0x/g,"#");this.smallBlockColor=a.getAttribute("smallBlockColor").replace(/0x/g,"#");this.smallBlockCurrentColor=a.getAttribute("smallBlockCurrentColor").replace(/0x/g,"#");this.smallBlockTextSize=Number(a.getAttribute("smallBlockTextSize"));this.smallBlockTextColor=a.getAttribute("smallBlockTextColor").replace(/0x/g,"#");this.smallBlockCurrentTextColor=
a.getAttribute("smallBlockCurrentTextColor").replace(/0x/g,"#");this.arrowsWidth=Number(a.getAttribute("arrowsWidth"));this.arrowsHeight=Number(a.getAttribute("arrowsHeight"));this.arrowsBorderWidth=Number(a.getAttribute("arrowsBorderWidth"));this.arrowsBorderColor=a.getAttribute("arrowsBorderColor").replace(/0x/g,"#");this.arrowsColor=a.getAttribute("arrowsColor").replace(/0x/g,"#");this.arrowsCurrentColor=a.getAttribute("arrowsCurrentColor").replace(/0x/g,"#");this.arrowsTextSize=Number(a.getAttribute("arrowsTextSize"));
this.arrowsTextColor=a.getAttribute("arrowsTextColor").replace(/0x/g,"#");this.arrowsCurrentTextColor=a.getAttribute("arrowsCurrentTextColor").replace(/0x/g,"#");this.thumbnailArray=b.thumbnailArray;this.photoArray=b.photoArray;this.photoUrlArray=b.photoUrlArray;this.URLTarget=b.URLTarget;this.videoArray=b.videoArray;this.transitionArray=b.transitionArray;this.photoTimeArray=b.photoTimeArray;this.transitionTimeArray=b.transitionTimeArray;this.defineTransitionArray=b.defineTransitionArray;this.photoTitleArray=
b.photoTitleArray;this.descriptionText=b.descriptionText;this.photoCount=this.photoArray.length;this.Play=function(){b.Play()};this.Pause=function(){b.Pause()};this.Previous=function(){b.Previous()};this.Next=function(){b.Next()};this.Show=function(a,d){b.Show(a,d)};this.MusicPlay=function(){b.MusicPlay()};this.MusicPause=function(){b.MusicPause()}}})();(function(){aJSsTemplate.ColorConverter={hexToRGB:function(b){var a,c,d;if(/rgb/.test(b))b=b.match(/\d+/g),a=parseInt(b[0]),c=parseInt(b[1]),d=parseInt(b[2]);else if(/#/.test(b)){var f=b.length;7===f?(a=parseInt(b.slice(1,3),16),c=parseInt(b.slice(3,5),16),d=parseInt(b.slice(5),16)):4===f&&(a=parseInt(b.charAt(1)+b.charAt(1),16),c=parseInt(b.charAt(2)+b.charAt(2),16),d=parseInt(b.charAt(3)+b.charAt(3),16))}else return b;return{r:a,g:c,b:d}}}})();(function(){aJSsTemplate.Main=function(b){var b=new aJSsTemplate.ExternalInterface(b),a=b.container,c=window;new aJSsTemplate.JsTheme(b);new aJSsTemplate.JsMenu(b,a);c.onload=void 0}})();(function(){aJSsTemplate.JsTheme=function(b){var a=b.globalPath,c=b.container,d=b.movieWidth,f=b.movieHeight,e=b.photoArray,h=b.thumbnailArray,j=b.thumWidth,i=b.thumHeight,g=b.thumbnailBorderColor,l=b.thumborder,m=b.topPadding,p=b.bottomPadding,n=b.leftPadding,q=b.rightPadding,k=b.musicPath,s=b.photoTitleAutoHide,u=b.photoTitleColor,v=b.photoTitleArray,A=b.titleTextSize,C=b.titleTextFont,Z=b.titleTextAlign,x=b.showTitle,T=b.photoTitleAlpha,U=b.desTextFont,N=b.descriptionText,ca=b.desTextColor,ba=
b.desTextSize,O=b.desLineHeight,w=b.enableDes,I=b.desTextAlign,B=b.photoUrlArray,ua=b.titleTextShadowColor,la=b.titleTextShadowOffset,z=b.titleTextShadowBlur,J=aJSsTemplate.ColorConverter.hexToRGB(b.photoTitleBackgroundColor),da=b.desTextShadowColor,ea=b.desTextShadowOffset,fa=b.desTextShadowBlur,ga=b.smallBlockWidth,H=b.smallBlockHeight,ma=b.smallBlockBorderWidth,ka=b.smallBlockBorderColor,W=b.smallBlockColor,Y=b.smallBlockCurrentColor,R=b.smallBlockTextColor,X=b.smallBlockCurrentTextColor,qa=b.smallBlockTextSize,
ha=b.arrowsWidth,$=b.arrowsHeight,na=b.arrowsBorderWidth,xa=b.arrowsBorderColor,va=b.arrowsColor,ya=b.arrowsCurrentColor,wa=b.arrowsTextColor,za=b.arrowsCurrentTextColor,Aa=b.arrowsTextSize,Ba=h.length,aa,P=0,V=document.createElement("div");V.id="bg";c.appendChild(V);V.style.position="absolute";V.style.top="0px";V.style.width=d-n-q+"px";V.style.height=f-p-m+"px";V.style.borderTopWidth=m+"px";V.style.borderBottomWidth=p-30+"px";V.style.borderLeftWidth=n+"px";V.style.borderRightWidth=q+"px";V.style.borderStyle=
"solid";V.style.borderColor="#000000";V.style.borderRadius="5px";var G=document.createElement("div");c.appendChild(G);G.id="container";G.style.position="absolute";G.style.width=d+"px";G.style.top="0";var ia=document.createElement("div");ia.id="number";G.appendChild(ia);ia.style.marginTop=m+"px";ia.style.padding="10px";ia.style.cssFloat="left";m=document.createElement("div");ia.appendChild(m);m.id="number1";m.style.cssFloat="left";for(var L=0;L<Ba;L++)G=document.createElement("a"),m.appendChild(G),
G.style.cursor="pointer",G.style.borderRadius="5px",G.style.borderStyle="solid",G.style.backgroundColor=W,G.style.borderWidth=ma+"px",G.style.borderColor=ka,G.style.width=ga+"px",G.style.height=H+"px",G.style.cssFloat="left",G.style.textAlign="center",G.textContent=L+1,G.style.textDecoration="none",G.style.color=R,G.style.margin="0px 2px 0px 2px",G.style.fontFamily="Tahoma,sans-serif",G.style.fontSize=qa+"px",G.style.fontWeight="700",G.style.lineHeight=H+"px",G.style.opacity="0.8",G.src=e[L],G.index=
L;ia.style.marginLeft=d-n-ia.offsetWidth+"px";var M=document.createElement("div");M.id="thumbnail";m.appendChild(M);M.style.marginTop=H+2*ma+6+"px";M.style.borderStyle="solid";M.style.borderColor=g;M.style.borderWidth=l+"px";M.style.cursor="pointer";M.style.display="none";M.style.overflow="visible";M.style.position="absolute";M.style.borderRadius="5px";M.style.marginLeft=-((j+2*l)/2-ga/2-4)+"px";H=document.createElement("div");M.appendChild(H);H.style.backgroundColor="#0e0e0e";H.style.left="0px";
H.style.overflow="hidden";H.style.position="relative";H.style.width=j+"px";e=document.createElement("span");M.appendChild(e);e.style.backgroundRepeat="no-repeat";e.style.display="block";e.style.width="22px";e.style.height="6px";e.style.position="absolute";e.style.left=j/2-7.5+"px";e.style.top=-(6+l)+"px";g=document.createElement("div");H.appendChild(g);g.style.height=i+"px";g.style.position="relative";g.style.overflow="visible";for(L=0;L<Ba;L++)H=new Image,g.appendChild(H),H.src=a+h[L],H.alt="123",
H.style.display="none",H.style.width=j+"px",H.style.height=i+"px";var y=document.createElement("div");c.appendChild(y);y.style.position="absolute";y.style.top="0";y.style.display="block";y.style.backgroundColor="rgba("+J.r+","+J.g+","+J.b+","+T+")";y.style.backgroundRepeat="repeat";y.style.padding="12px";y.style.marginLeft=n+"px";y.style.marginRight="30px";y.style.borderRadius="0 10px 10px 0";var r=document.createElement("span");y.appendChild(r);r.textContent=v[0];r.style.textDecoration="none";r.style.textAlign=
Z;r.style.color=u;r.style.textShadow=la+"px "+la+"px "+z+"px "+ua;r.style.fontFamily=C;r.style.fontSize=A+"px";r.style.textTransform="uppercase";r.style.fontWeight="bold";r.style.paddingBottom="5px";"true"==x?(y.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";var t=document.createElement("div");y.appendChild(t);t.innerHTML=N[0];t.style.textDecoration="none";t.style.textAlign=I;t.style.fontSize=ba+"px";t.style.color=ca;t.style.textShadow=ea+"px "+ea+"px "+
fa+"px "+da;t.style.fontFamily=U;t.style.lineHeight=O+"px";t.style.textTransform="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):t.style.display="none";if("true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent)y.style.display="none";y.style.marginTop=f-p-80-y.offsetHeight+"px";var E=document.createElement("a");c.appendChild(E);E.style.borderRadius="0 5px 5px 0";E.style.opacity=0.8;E.style.width=
ha+"px";E.style.height=$+"px";E.style.borderStyle="solid";E.style.borderTopWidth=na+"px";E.style.borderRightWidth=na+"px";E.style.borderBottomWidth=na+"px";E.style.borderLeftWidth="1px";E.style.borderColor=xa;E.style.backgroundColor=va;E.textContent="<";E.style.textDecoration="none";E.style.fontSize=Aa+"px";E.style.color=wa;E.style.lineHeight=$-5+"px";E.style.textAlign="center";E.style.cursor="pointer";E.style.marginLeft=n+"px";E.style.marginTop=(f-p)/2-$/2+"px";E.style.display="none";E.style.top=
"0";E.style.position="absolute";var F=document.createElement("a");c.appendChild(F);F.style.borderRadius="5px 0 0 5px";F.style.opacity=0.8;F.style.width=ha+"px";F.style.height=$+"px";F.style.borderStyle="solid";F.style.borderTopWidth=na+"px";F.style.borderLeftWidth=na+"px";F.style.borderBottomWidth=na+"px";F.style.borderRightWidth="1px";F.style.borderColor=xa;F.style.backgroundColor=va;F.textContent=">";F.style.textDecoration="none";F.style.fontSize=Aa+"px";F.style.color=wa;F.style.lineHeight=$-5+
"px";F.style.textAlign="center";F.style.cursor="pointer";F.style.marginLeft=d-ha-na-1-n+"px";F.style.marginTop=(f-p)/2-$/2+"px";F.style.display="none";F.style.position="absolute";F.style.top="0";h=new Image;c.appendChild(h);h.style.position="absolute";h.src=a+"res/bgshade.png";h.style.width=d+"px";h.style.height="40px";h.style.top=f-30+"px";h.style.left="0";h=document.createElement("mainbox");c.appendChild(h);h.id="mainbox";h.style.position="absolute";h.style.left=n+"px";h.style.top=f-p-p+"px";h.style.width=
d-n-q+"px";var K=new Image;h.appendChild(K);K.src=a+"res/playb.png";K.style.width="45px";K.style.height="45px";K.style.display="block";K.style.cssFloat="left";K.style.display="none";var S=document.createElement("music");h.appendChild(S);S.style.width="45px";S.style.height="45px";S.style.backgroundImage="url("+a+"res/musicplay.png)";S.style.cssFloat="left";S.style.display="block";var ra=0,sa=0,ja=0,D=ia.getElementsByTagName("a"),ta=g.getElementsByTagName("img"),oa=0,oa="true"==b.clickToAutoPlay?1:
0;D[0].style.backgroundColor=Y;D[0].style.color=X;b.commandDispatcher.addEventListener("playCurrent",function(a){P=a.index;r.textContent=v[P];t.innerHTML=N[P];"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display="block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):
t.style.display="none";y.style.display="true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent?"none":"block";y.style.marginTop=f-p-80-y.offsetHeight+"px";for(a=0;a<b.photoCount;a++)a!==aa&&(D[a].style.backgroundColor=W,D[a].style.color=R);D[P].style.backgroundColor=Y;D[P].style.color=X;P>=b.photoCount-1&&"false"==b.continuum&&(K.style.display="block")});"true"==s?(r.style.display="none",c.onmouseover=function(){E.style.display="block";
F.style.display="block";r.style.display="block"},c.onmouseout=function(){E.style.display="none";F.style.display="none";r.style.display="none"}):(c.onmouseover=function(){E.style.display="block";F.style.display="block"},c.onmouseout=function(){E.style.display="none";F.style.display="none"});E.onmouseover=function(){this.style.backgroundColor=ya;this.style.color=za};E.onmouseout=function(){this.style.backgroundColor=va;this.style.color=wa};E.onclick=function(){if(0==P){b.Show(b.photoCount-1,oa);r.textContent=
v[b.photoCount-1];t.innerHTML=N[b.photoCount-1];"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display="block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):t.style.display="none";if("true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||
"true"!==w&&""==r.textContent)y.style.display="none";D[L].style.backgroundColor=W;D[L].style.color=R;D[b.photoCount-1].style.backgroundColor=Y;D[b.photoCount-1].style.color=X}else{D[P].style.backgroundColor=W;D[P].style.color=R;P=ra=P-1;b.Show(ra,oa);r.textContent=v[ra];t.innerHTML=N[ra];"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display="block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display=
"none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):t.style.display="none";if("true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent)y.style.display="none";D[ra].style.backgroundColor=Y;D[ra].style.color=X}K.style.display="true"!==b.clickToAutoPlay?"block":"none";y.style.marginTop=f-p-80-y.offsetHeight+"px"};F.onmouseover=function(){this.style.backgroundColor=ya;this.style.color=
za};F.onmouseout=function(){this.style.backgroundColor=va;this.style.color=wa};F.onclick=function(){if(P==b.photoCount-1){b.Show(0,oa);r.textContent=v[0];t.innerHTML=N[0];"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display="block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":
"block"):t.style.display="none";if("true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent)y.style.display="none";D[b.photoCount-1].style.backgroundColor=W;D[b.photoCount-1].style.color=R;D[0].style.backgroundColor=Y;D[0].style.color=X}else{D[P].style.backgroundColor=W;D[P].style.color=R;P=sa=P+1;b.Show(sa,oa);r.textContent=v[sa];t.innerHTML=N[sa];"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display=
"block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):t.style.display="none";if("true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent)y.style.display="none";D[sa].style.backgroundColor=Y;D[sa].style.color=X}K.style.display="true"!==b.clickToAutoPlay?"block":
"none";y.style.marginTop=f-p-80-y.offsetHeight+"px"};for(L=0;L<D.length;L++)D[L].onmouseover=function(){this.style.backgroundColor=Y;this.style.color=X;ja=this.index;M.style.display="block";ta[ja].style.display="block";M.style.marginLeft=(ga+2*ma+4)*ja-((j+2*l)/2-ga/2-4)+"px";aa=this.index},D[L].onclick=function(){for(var a=0;a<D.length;a++)D[a].style.backgroundColor=W,D[a].style.color=R;this.style.backgroundColor=Y;this.style.color=X;aa=this.index;b.Show(aa,oa);r.textContent=v[aa];t.innerHTML=N[aa];
"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display="block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):t.style.display="none";if("true"!==x&&"true"!==w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent)y.style.display=
"none";y.style.marginTop=f-p-80-y.offsetHeight+"px";K.style.display="true"!==b.clickToAutoPlay?"block":"none"},D[L].onmouseout=function(){P!==aa&&(this.style.backgroundColor=W,this.style.color=R);aa="abc";ta[ja].style.display="none";M.style.display="none"},e.onmouseover=function(){M.style.display="block";ta[ja].style.display="block"},ta[L].onmouseout=function(){M.style.display="none";ta[ja].style.display="none"},ta[L].onclick=function(){for(var a=0;a<D.length;a++)D[a].style.backgroundColor=W,D[a].style.color=
R;aa=D[ja].index;b.Show(aa,oa);r.textContent=v[aa];t.innerHTML=N[aa];y.style.marginTop=f-p-80-y.offsetHeight+"px";"true"==x?(y.style.display="block","true"==s?(r.style.display="none",c.onmouseover=function(){r.style.display="block"},c.onmouseout=function(){r.style.display="none"}):r.style.display="block",""==r.textContent&&(r.style.display="none")):r.style.display="none";"true"==w?(t.style.display="block",t.style.display=""==t.innerHTML?"none":"block"):t.style.display="none";if("true"!==x&&"true"!==
w||""==t.innerHTML&&""==r.textContent||"true"!==x&&""==t.innerHTML||"true"!==w&&""==r.textContent)y.style.display="none";D[ja].style.backgroundColor=Y;D[ja].style.color=X};V.style.cursor="pointer";V.onclick=function(){location.href=B[P]};K.style.display="true"==b.startAutoPlay?"none":"block";K.style.cursor="pointer";K.onmouseover=function(){K.src=a+"res/playw.png"};K.onmouseout=function(){K.src=a+"res/playb.png"};K.onclick=function(){b.Play();K.style.display="none"};var pa=0;""==k?S.style.display=
"none":(S.style.cursor="pointer","true"==b.musicAutoPlay?(S.style.backgroundImage="url("+a+"res/musicplay.png)",S.onclick=function(){0==pa?(S.style.backgroundImage="url("+a+"res/musicstop.png)",b.MusicPause(),pa=1):(S.style.backgroundImage="url("+a+"res/musicplay.png)",b.MusicPlay(),pa=0)}):(S.style.backgroundImage="url("+a+"res/musicstop.png)",S.onclick=function(){0==pa?(S.style.backgroundImage="url("+a+"res/musicplay.png)",b.MusicPlay(),pa=1):(S.style.backgroundImage="url("+a+"res/musicstop.png)",
b.MusicPause(),pa=0)}));b.commandDispatcher.addEventListener("soundPlayComplete",function(){S.style.backgroundImage="url("+a+"res/musicstop.png)";pa=1});b.commandDispatcher.addEventListener("videoPlayEnded",function(){K.style.display="none"})}})();(function(){aJSsTemplate.JsMenu=function(b,a){var c=b.movieWidth,d=b.movieHeight,f=b.bottomPadding,e=b.rightPadding,h=b.copyright;if(null==b.anvsoftMenu||"anvsoftPFMTheme"!=h&&"anvsoftUSSTheme"!=h&&"anvsoftHSMTheme"!=h){var j;switch(h){case "anvsoftPFMTheme":j="Photo Slideshow Maker";break;case "anvsoftUSSTheme":j="Ultra Slideshow";break;case "anvsoftHSMTheme":j="HTML5 Slideshow Maker";break;case "anvsoftSWWTheme":j="SlideWow";break;default:j="Anvsoft Photo Slideshow"}var i=document.createElement("div");
...
h=0,j=c.length;h<j&&c[h]!==b;h++);c.splice(h,1)}}};var c=new a;b.CommandDispatcher={getInstance:function(){return c}}})();(function(){aJSs.getParameters={parameters:function(){var b=document.getElementsByTagName("script");try{for(var a=b[b.length-1].src.split("?")[1].split("&"),b={},c,d,f,e=0,h=a.length;e<h;e++)c=a[e].split("="),d=c[0],f=c[1],"undefined"==typeof b[d]?b[d]=f:("string"==typeof b[d]&&(b[d]=[b[d]]),b[d].push(f));return b}catch(j){return[]}}}})();
...
(function(){aJSs.MaskEffect=function(b){this.transTotal=68;this.maskerFull=0;var a=this,c,d;this.transition=function(a,b,d,c,i){this.maskerFull=0;if(a<=this.transTotal)this["mask"+a](b,d,c,i);else this.transition(68,b,d,c,i)};this.mask1=function(f,e,h,j){function i(){p=e*k*d;n=h*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),g.setRect([0,0,e,h]),clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=0,p=0,n=
0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask2=function(f,e,h,j){function i(){p=e*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask3=function(f,e,h,j){function i(){n=h*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=0,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask4=function(f,e,h,j){function i(){l=e*(1-k*d);p=e*k*d;g.x=e*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=e,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask5=function(f,e,h,j){function i(){m=
h*(1-k*d);n=h*k*d;g.y=h*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=h,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask6=function(f,e,h,j){function i(){n=e*C*d;g.setRect([m,p,n,q]);k=e*(1-C*d);u=e*C*d;l.x=e*(1-C*d);l.setRect([k,s,u,v]);C++;if(C>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),f.removeChild(l),clearInterval(A),A=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,p=0,n=0,q=h,k=e,s=0,u=0,v=h;c=j*b;d=1/(2*c);var A=setInterval(i,1E3/b),C=1;i()};this.mask7=function(f,e,h,j){function i(){q=h*C*d;g.setRect([m,p,n,q]);s=h*(1-C*d);v=h*C*d;l.y=h*(1-C*d);l.setRect([k,s,u,v]);C++;if(C>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,
e,h]),f.removeChild(l),clearInterval(A),A=null}var g=f.getChildAt(0),l=new Quark.Bitmap({id:"targetBitmap2",image:g.image,rect:[0,0,0,0]});f.addChild(l);var m=0,p=0,n=e,q=0,k=0,s=h,u=e,v=0;c=j*b;d=1/(2*c);var A=setInterval(i,1E3/b),C=1;i()};this.mask8=function(f,e,h,j){function i(){l=e/2*(1-k*d);p=e*k*d;g.x=e/2*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(q),q=null}var g=
f.getChildAt(0),l=e/2,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask9=function(f,e,h,j){function i(){m=h/2*(1-k*d);n=h*k*d;g.y=h/2*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=h/2,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask10=function(f,e,h,j){function i(){for(var b=0;b<m;b++){var j=b*p,i=
p*s*d,l=h;f.getChildById("maskBitmap"+b).setRect([j,0,i,l])}s++;if(s>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(k);k=null}}for(var g=f.getChildAt(0),l=g.image,m=16,p=e/m,n=0;n<m;n++){var q=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});q.x=n*p;f.addChild(q)}c=j*b;d=1/c;var k=setInterval(i,1E3/b),s=1;i()};this.mask11=function(f,e,h,j){function i(){for(var b=
0;b<m;b++){var j=b*p,i=e,l=p*s*d;f.getChildById("maskBitmap"+b).setRect([0,j,i,l])}s++;if(s>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(k);k=null}}for(var g=f.getChildAt(0),l=g.image,m=16,p=h/m,n=0;n<m;n++){var q=new Quark.Bitmap({id:"maskBitmap"+n,image:l,rect:[0,0,0,0]});q.y=n*p;f.addChild(q)}c=j*b;d=1/c;var k=setInterval(i,1E3/b),s=1;i()};this.mask12=
function(f,e,h,j){function i(){for(n=0;n<U;n++)x=k.length,0<x?(T=Math.floor(Math.random()*x),k[T].visible=!0,k.splice(T,1)):n=U;Z++;if(Z>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(C);C=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/20),p=Math.ceil(h/20),n=0,q=0,k=[],n=0;20>n;n++)for(q=0;20>q;q++){var s=m*n,u=p*q,v=m,A=p;s<e&&u<
h&&(s>e-m&&(v=e-s),u>h-p&&(A=h-u),v=new Quark.Bitmap({id:"maskBitmap"+n+q,image:l,rect:[s,u,v,A]}),v.x=s,v.y=u,v.visible=!1,f.addChild(v),k.push(v))}c=j*b;d=1/c;var C=setInterval(i,1E3/b),Z=1,x=k.length,T,U=Math.round(x/c);1>U&&(U=1);i()};this.mask13=function(f,e,h,j){function i(){l=e/2*(1-k*d);m=h/2*(1-k*d);p=e*k*d;n=h*k*d;g.x=e/2*(1-k*d);g.y=h/2*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),
g.x=0,g.y=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=e/2,m=h/2,p=0,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask14=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask15=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask16=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask17=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask18=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask19=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask20=function(a,
b,d,c){this.transition(68,a,b,d,c)};this.mask21=function(f,e,h,j){function i(){l=e*(1-k*d);m=h*(1-k*d);p=e*k*d;n=h*k*d;g.x=e*(1-k*d);g.y=h*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.y=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=e,m=h,p=0,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask22=function(f,e,h,j){function i(){l=e*(1-k*d);m=0;p=e*k*d;n=h*k*d;g.x=e*(1-k*
d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=e,m=0,p=0,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask23=function(f,e,h,j){function i(){l=0;m=h*(1-k*d);p=e*k*d;n=h*k*d;g.y=h*(1-k*d);g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=
0,clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=h,p=0,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask24=function(f,e,h,j){function i(){s=e/2*B*d;u=h/2*B*d;g.setRect([q,k,s,u]);v=e/2+e/2*(1-B*d);A=0;C=e/2*B*d;Z=h/2*B*d;m.x=e/2+e/2*(1-B*d);m.setRect([v,A,C,Z]);x=0;T=h/2+h/2*(1-B*d);U=e/2*B*d;N=h/2*B*d;p.y=h/2+h/2*(1-B*d);p.setRect([x,T,U,N]);ca=e/2+e/2*(1-B*d);ba=h/2+h/2*(1-B*d);O=e/2*B*d;w=h/2*B*d;n.x=e/2+e/2*(1-B*d);n.y=h/2+h/2*(1-B*d);n.setRect([ca,ba,O,w]);B++;if(B>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});
for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(I);I=null}}var g=f.getChildAt(0),l=g.image,m=new Quark.Bitmap({id:"targetBitmap2",image:l,rect:[0,0,0,0]});f.addChild(m);var p=new Quark.Bitmap({id:"targetBitmap3",image:l,rect:[0,0,0,0]});f.addChild(p);var n=new Quark.Bitmap({id:"targetBitmap4",image:l,rect:[0,0,0,0]});f.addChild(n);var q=0,k=0,s=0,u=0,v=e,A=0,C=0,Z=0,x=0,T=h,U=0,N=0,ca=e,ba=h,O=0,w=0;c=j*b;d=1/c;var I=setInterval(i,1E3/b),B=1;i()};
this.mask25=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask26=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask27=function(f,e,h,j){function i(){for(var b=0;b<m;b++){var j=p*b,i=p;n[b].x>e-p&&(i=e-n[b].x);var l=q[b]+(h-q[b])*C*d*h/(h-q[b]);l<h&&n[b].setRect([j,0,i,l])}C++;if(C>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(A);
A=null}}for(var g=f.getChildAt(0),l=g.image,m=20,p=Math.ceil(e/m),n=[],q=[],k=0;k<m;k++){q[k]=h/2*Math.random();var s=p*k,u=p,v=q[k];s>e-p&&(u=e-s);u=new Quark.Bitmap({id:"maskBitmap"+k,image:l,rect:[s,0,u,v]});u.x=s;f.addChild(u);n.push(u)}c=j*b;d=1/c;var A=setInterval(i,1E3/b),C=1;i()};this.mask28=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask29=function(f,e,h,j){function i(){g.alpha=m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
g.alpha=1,clearInterval(l),l=null}var g=f.getChildAt(0);g.setRect([0,0,e,h]);g.alpha=0;c=j*b;d=1/c;var l=setInterval(i,1E3/b),m=1;i()};this.mask30=function(f,e,h,j){function i(){l=e*(1-k*d);p=e*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=e,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask31=function(f,e,h,j){function i(){g.alpha=
k*d;l=e*(1-k*d);p=e*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.alpha=1,clearInterval(q),q=null}var g=f.getChildAt(0);g.alpha=0;var l=e,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask32=function(f,e,h,j){function i(){p=e*k*d;g.setRect([l,m,p,n]);g.x=e*(1-k*d);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,
0,e,h]),g.x=0,clearInterval(q),q=null}var g=f.getChildAt(0);g.x=e;var l=0,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask33=function(f,e,h,j){function i(){g.alpha=k*d;p=e*k*d;g.setRect([l,m,p,n]);g.x=e*(1-k*d);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.x=0,g.alpha=1,clearInterval(q),q=null}var g=f.getChildAt(0);g.x=e;var l=g.alpha=0,m=0,p=0,n=h;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};
this.mask34=function(f,e,h,j){function i(){m=h*(1-k*d);n=h*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(q),q=null}var g=f.getChildAt(0),l=0,m=h,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask35=function(f,e,h,j){function i(){g.alpha=k*d;m=h*(1-k*d);n=h*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),
g.setRect([0,0,e,h]),g.y=0,g.alpha=1,clearInterval(q),q=null}var g=f.getChildAt(0),l=g.alpha=0,m=h,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask36=function(f,e,h,j){function i(){g.y=h*(1-k*d);n=h*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,clearInterval(q),q=null}var g=f.getChildAt(0);g.y=h;var l=0,m=0,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask37=
function(f,e,h,j){function i(){g.alpha=k*d;g.y=h*(1-k*d);n=h*k*d;g.setRect([l,m,p,n]);k++;if(k>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:"transitionOver"}),g.setRect([0,0,e,h]),g.y=0,g.alpha=1,clearInterval(q),q=null}var g=f.getChildAt(0);g.alpha=0;g.y=h;var l=0,m=0,p=e,n=0;c=j*b;d=1/c;var q=setInterval(i,1E3/b),k=1;i()};this.mask38=function(f,e,h,j){function i(){g.width=e*m*d;m++;if(m>c||1==a.maskerFull)aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER}),
...
a,b,d,c)};this.mask66=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask67=function(a,b,d,c){this.transition(68,a,b,d,c)};this.mask68=function(f,e,h,j){function i(){for(n=0;n<B;n++)k[n].width=C[n]*I*d,k[n].height=Z[n]*I*d,k[n].x=v[n]+(s[n]-v[n])*I*d,k[n].y=A[n]+(u[n]-A[n])*I*d;I++;if(I>c||1==a.maskerFull){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.TRANSITION_OVER});for(g.setRect([0,0,e,h]);1<f.getNumChildren();)f.removeChildAt(f.getNumChildren()-1);clearInterval(w);
w=null}}for(var g=f.getChildAt(0),l=g.image,m=Math.ceil(e/12),p=Math.ceil(h/12),n=0,q=0,k=[],s=[],u=[],v=[],A=[],C=[],Z=[],n=0;12>n;n++)for(q=0;12>q;q++){var x=m*n,T=p*q,U=m,N=p,ca=Math.random()*(e-m),ba=Math.random()*(h-p);if(x<e&&T<h){x>e-m&&(U=e-x);T>h-p&&(N=h-T);var O=new Quark.Bitmap({id:"maskBitmap"+n+q,image:l,rect:[x,T,U,N]});O.x=ca;O.y=ba;O.width=0;O.height=0;f.addChild(O);k.push(O);s.push(x);u.push(T);C.push(U);Z.push(N);v.push(ca);A.push(ba)}}c=j*b;d=1/c;var w=setInterval(i,1E3/b),I=1,
B=k.length;i()}}})();
...
(function(){aJSs.JsCompatibleTheme=function(b,a,c){function d(){q--;0>=q&&(clearInterval(s),k++,k>n-1&&(k=0),v.src=c+e[k])}var f=b.movieBackgroundColor,e=b.photoArray,h=b.photoUrlArray,j=b.photoTimeArray,i=b.transitionTimeArray,g=b.URLTarget,l=b.topPadding,m=b.bottomPadding,p=b.leftPadding,b=b.rightPadding,n=e.length,q=0,k=0,s=null,u=document.getElementById(a);u.style.backgroundColor=f;var a=u.offsetWidth,f=u.offsetHeight,p=a-p-b,l=f-l-m,m=Math.round((a-p)/2),b=Math.round((f-l)/2),v=new Image;u.appendChild(v);
v.style.position="absolute";v.style.width=p+"px";v.style.height=l+"px";v.style.left=m+"px";v.style.top=b+"px";v.src=c+e[k];v.onload=function(){q=parseInt(i[k])+parseInt(j[k]);s=setInterval(d,1E3)};v.onclick=function(){var a;switch(g[k]){case "0":a="_blank";break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(h[k],a)};var A=document.createElement("div");u.appendChild(A);A.style.position="absolute";A.style.width="250px";A.style.padding="8px";
A.style.backgroundColor="#333";A.style.color="#FFF";A.style.textAlign="left";A.style.font="normal normal 12px/16px verdana,tahoma,arial,sans-serif";A.innerHTML="The browser you are using does not support HTML5. Now you are using the simple compatible mode. To get better user experience, please use HTML5 supported browser.";A.style.left=Math.round((a-A.offsetWidth)/2)+"px";A.style.top=Math.round((f-A.offsetHeight)/2)+"px";var C=setTimeout(function(){clearTimeout(C);C=null;u.removeChild(A)},1E4)}})();
...
(function(){aJSs.JsPhoto=function(b,a,c){function d(){aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.VIDEO_CLEAR});if(""!=C){e();var a=new Image;a.src=c+C;a=new Quark.MovieClip({image:a,id:"preloader",interval:100});a.addFrame([{rect:[0,0,25,25]},{rect:[25,0,25,25]},{rect:[50,0,25,25]},{rect:[75,0,25,25]},{rect:[100,0,25,25]},{rect:[125,0,25,25]}]);a.x=u+(N-a.width)/2;a.y=k+(ca-a.height)/2;fa.addChild(a)}I=w=0;X&&X.removeAllChildren();R.swapChildren(ha,$);R.getChildIndex(ha)>
R.getChildIndex($)?(qa=ha,X=$):(qa=$,X=ha);var b=new Image;b.onload=function(){e();w=1;b.width=ga;b.height=H;var a=new Quark.Bitmap({id:"targetBitmap",image:b,rect:[0,0,0.0010,0.0010]});a.useHandCursor="true"==g&&""!=i[z]?!0:!1;qa.addChild(a);ua=0==p[z]?null==n?Math.floor(Math.random()*ea.transTotal)+1:n[Math.floor(Math.random()*n.length)]:p[z];ea.transition(ua,qa,ga,H,q[z]);a.onEvent=function(a){if("mousedown"==a.type||"touchend"==a.type){if("true"==g&&""!=i[z]){switch(l[z]){case "0":a="_blank";
break;case "1":a="_parent";break;case "2":a="_self";break;case "3":a="_top";break;default:a="_blank"}window.open(i[z],a)}}else"mousemove"==a.type||"touchmove"==a.type?aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OVER}):("mouseout"==a.type||"touchout"==a.type)&&aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_MOUSE_OUT})};aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PHOTO_LOAD_COMPLETE,index:z})};b.src=c+j[z];aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_CURRENT,
index:z});z>=da-1&&"false"==x&&"false"==A&&ba.Pause()}function f(){la--;try{Quark.getDOM("debugInfo").value=la}catch(a){}if(0>=la||1==B)clearInterval(J),J=null,0==B?"true"==A?z=Math.floor(Math.random()*da):z<da-1?z++:z=0:B=0,d()}function e(){if(""!=C){var a=fa.getChildById("preloader");null!=a&&fa.removeChild(a)}}var h=b.frameRate,j=b.photoArray,i=b.photoUrlArray,g=b.enableURL,l=b.URLTarget,m=b.photoTimeArray,p=b.transitionArray,n=b.defineTransitionArray,q=b.transitionTimeArray,k=b.topPadding,s=b.bottomPadding,
u=b.leftPadding,v=b.rightPadding,A=b.randomPlayingPhotos,C=b.loadStyle,Z=b.startAutoPlay,x=b.continuum,T=b.videoAutoPlay,U=b.videoArray,N=a.width-u-v,ca=a.height-k-s,ba=this,O=0,w=1,I=1,B=0,ua=0,la=0,z=0,J=null,da=j.length;aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.TRANSITION_OVER,function(){I=1;if(1==O||1==B)la=m[z]*h,J=setInterval(f,1E3/h);""!=U[z]&&void 0!=U[z]&&0==B&&("true"==T&&(clearInterval(J),J=null),aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_VIDEO,
index:z,width:N,height:ca}))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_NEXT,function(){ba.Play()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){ba.Pause()});var ea=new aJSs.MaskEffect(h),fa=new Quark.DisplayObjectContainer({id:"container"});fa.autoSize=!0;a.addChild(fa);var ga=a.width-u-v,H=a.height-k-s,b=u,a=k,s=Quark.Bitmap,v=ga,ma=H,ka="#DDD",W=document.createElement("canvas");W.width=v;W.height=ma;var Y=W.getContext("2d");
Y.fillStyle=ka;Y.rect(0,0,v,ma);Y.fill();ka=new Image;ka.src=W.toDataURL("image/png");ka.width=v;ka.height=ma;s=new s({id:"photoBoxBg",image:ka});s.autoSize=!0;s.x=b;s.y=a;fa.addChild(s);var R=new Quark.DisplayObjectContainer({id:"photoBox",x:b,y:a,width:ga,height:H});R.autoSize=!0;fa.addChild(R);var X,qa,ha=new Quark.DisplayObjectContainer({id:"aPhoto"}),$=new Quark.DisplayObjectContainer({id:"bPhoto"});R.addChild(ha);R.addChild($);this.Play=function(){O=1;1==w&&1==I?(clearInterval(J),J=null,z<da-
1?z++:z=0,d()):1==w&&0==I?(B=1,z<da-1?z++:z=0,ea.maskerFull=1):(z<da-1?z++:z=0,B=1)};this.Pause=function(){O=0;null!=J&&(clearInterval(J),J=null)};this.Previous=function(a){O=a;0<z?z--:z=da-1;1==w&&1==I?(clearInterval(J),J=null,d()):1==w&&0==I?(B=1,ea.maskerFull=1):B=1};this.Next=function(a){O=a;z<da-1?z++:z=0;1==w&&1==I?(clearInterval(J),J=null,d()):1==w&&0==I?(B=1,ea.maskerFull=1):B=1};this.Show=function(a,b){O=b;1==w&&1==I?(clearInterval(J),J=null,z=a,d()):1==w&&0==I?(B=1,z=a,ea.maskerFull=1):
(z=a,B=1)};"true"==Z?this.Show(0,1):this.Show(0,0)}})();
(function(){aJSs.JsMediaConsole=function(b,a,c,d){function f(){void 0!=s&&(b.removeChild(s),void 0!=k&&"videoCallPause"==u&&(k.Play(),u=""),s=void 0,e())}function e(){var a=document.getElementById("videoLoadText");a&&b.removeChild(a)}var h=a.topPadding,j=a.leftPadding,c=a.musicPath,i=a.musicAutoPlay,g=a.musicLoop,l=a.musicStream,m=a.videoAutoPlay,p=a.bufferTime,n=a.videoArray,q=a.videoControls;if(""!=c)var k=new aJSs.Music(d+c,l,i,g);var s,u="";aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.PLAY_VIDEO,
function(a){var c=a.index,e=a.width,a=a.height;void 0!=k&&k.Playing()&&(k.Pause(),u="videoCallPause");s=new aJSs.Video(d+n[c],m,p,q,e,a);s.style.backgroundColor="#000";s.style.position="absolute";s.style.top=h+"px";s.style.left=j+"px";b.appendChild(s);c=document.getElementById("videoLoadText");null==c&&(c=document.createElement("div"),c.id="videoLoadText",c.style.position="absolute",c.style.top=h+5+"px",c.style.left=j+5+"px",c.style.font="normal normal 11px/13px verdana,tahoma,arial,sans-serif",c.style.color=
"#FFF",c.textContent="Waiting...",b.appendChild(c))});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_PLAY_ENDED,function(){f();aJSs.CommandDispatcher.getInstance().dispatchEvent({type:aJSs.Events.PLAY_NEXT})});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_CLEAR,function(){f()});aJSs.CommandDispatcher.getInstance().addEventListener(aJSs.Events.VIDEO_START_PLAY,function(){e()});this.MusicPlay=function(){k.Play()};this.MusicPause=function(){k.Pause()}}})();
